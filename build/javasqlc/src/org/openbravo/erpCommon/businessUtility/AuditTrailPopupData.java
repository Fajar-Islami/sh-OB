 ...
 */
  public static AuditTrailPopupData[] parentsColumnName(ConnectionProvider connectionProvider, String parentTab, String tab)    throws ServletException {
...
Name of the columns parent of the tab
 */
  public static AuditTrailPopupData[] parentsColumnName(ConnectionProvider connectionProvider, String parentTab, String tab, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Name of the columns parent of the tab
 */
  public static AuditTrailPopupData[] parentsColumnReal(ConnectionProvider connectionProvider, String parentTab, String tab)    throws ServletException {
...
Name of the columns parent of the tab
 */
  public static AuditTrailPopupData[] parentsColumnReal(ConnectionProvider connectionProvider, String parentTab, String tab, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT AD_FIELD.AD_FIELD_ID, ColumnName AS NAME, AD_REFERENCE_id AS reference, ad_reference_value_id AS referencevalue," +
      "        (SELECT tableNAME FROM AD_TABLE, AD_TAB WHERE AD_TABLE.ad_table_id = AD_TAB.ad_table_id" +
 ...
 */
  public static AuditTrailPopupData[] selectSubtabs(ConnectionProvider connectionProvider, String parentId)    throws ServletException {
...
Subtabs of the tab of the parameter
 */
  public static AuditTrailPopupData[] selectSubtabs(ConnectionProvider connectionProvider, String parentId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
