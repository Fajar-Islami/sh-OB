...
class ReportSalesOrderProvidedData implements FieldProvider {
static Logger log4j = Logger.getLogger(ReportSalesOrderProvidedData.class);
  ...
  public static ReportSalesOrderProvidedData[] select(ConnectionProvider connectionProvider, String cCurrencyConv, String adUserClient, String adUserOrg, String dateFrom, String dateTo, String cBPartnerId, String mWarehouseId, String cProjectId, String cProductCategoryId, String cProjectKind, String cRegionId, String cProjectPublic, String productId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "      CASE WHEN C_ORDERLINE.C_AUM IS NULL THEN NULL ELSE (SELECT u.NAME FROM C_UOM u WHERE u.C_UOM_ID = C_ORDERLINE.C_AUM) END AS AUM," +
      "      SUM(C_ORDERLINE.AUMQTY) AS AUMQTY," +
    ...
    strSql = strSql + 
      "      GROUP BY C_BPARTNER.NAME, C_PROJECT.VALUE, C_PROJECT.NAME, M_PRODUCT.NAME, C_UOM.NAME, C_ORDERLINE.C_AUM, C_ORDERLINE.AUMQTY, C_ORDERLINE.PRICEACTUAL," +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        countRecord++;
        ReportSalesOrderProvidedData objectReportSalesOrderProvidedData = new ReportSalesOrderProvidedData();
        objectReportSalesOrderProvidedData.bpartnername = UtilSql.getValue(result, "bpartnername");
        objectReportSalesOrderProvidedData.projectname = UtilSql.getValue(result, "projectname");
        objectReportSalesOrderProvidedData.productname = UtilSql.getValue(result, "productname");
        objectReportSalesOrderProvidedData.qtydelivered = UtilSql.getValue(result, "qtydelivered");
        objectReportSalesOrderProvidedData.linenetamt = UtilSql.getValue(result, "linenetamt");
        objectReportSalesOrderProvidedData.linenetamtsym = UtilSql.getValue(result, "linenetamtsym");
        objectReportSalesOrderProvidedData.convlinenetamt = UtilSql.getValue(result, "convlinenetamt");
        objectReportSalesOrderProvidedData.uomname = UtilSql.getValue(result, "uomname");
        objectReportSalesOrderProvidedData.priceactual = UtilSql.getValue(result, "priceactual");
        objectReportSalesOrderProvidedData.aum = UtilSql.getValue(result, "aum");
        objectReportSalesOrderProvidedData.aumqty = UtilSql.getValue(result, "aumqty");
        objectReportSalesOrderProvidedData.priceactualsym = UtilSql.getValue(result, "priceactualsym");
        objectReportSalesOrderProvidedData.convpriceactual = UtilSql.getValue(result, "convpriceactual");
        objectReportSalesOrderProvidedData.convsym = UtilSql.getValue(result, "convsym");
        objectReportSalesOrderProvidedData.convisosym = UtilSql.getValue(result, "convisosym");
        objectReportSalesOrderProvidedData.transdate = UtilSql.getDateValue(result, "transdate", "dd-MM-yyyy");
        objectReportSalesOrderProvidedData.transcurrencyid = UtilSql.getValue(result, "transcurrencyid");
        objectReportSalesOrderProvidedData.transclientid = UtilSql.getValue(result, "transclientid");
        objectReportSalesOrderProvidedData.transorgid = UtilSql.getValue(result, "transorgid");
        objectReportSalesOrderProvidedData.name = UtilSql.getValue(result, "name");
        objectReportSalesOrderProvidedData.InitRecordNumber = Integer.toString(firstRegister);
        vector.addElement(objectReportSalesOrderProvidedData);
    ...
    ReportSalesOrderProvidedData objectReportSalesOrderProvidedData[] = new ReportSalesOrderProvidedData[vector.size()];
    vector.copyInto(objectReportSalesOrderProvidedData);
    return(objectReportSalesOrderProvidedData);
  }
  ...
  public static ReportSalesOrderProvidedData[] set()    throws ServletException {
    ReportSalesOrderProvidedData objectReportSalesOrderProvidedData[] = new ReportSalesOrderProvidedData[1];
    objectReportSalesOrderProvidedData[0] = new ReportSalesOrderProvidedData();
    objectReportSalesOrderProvidedData[0].name = "";
    return objectReportSalesOrderProvidedData;
  }
