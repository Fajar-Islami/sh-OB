...
static Logger log4j = Logger.getLogger(ReportValuationStockData.class);
  ...
  public static ReportValuationStockData[] select(ConnectionProvider connectionProvider, String adLanguage, String cCurrencyConv, String legalEntity, String datePlus, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String costOrg, String costClient, String costType, String categoryProduct)    throws ServletException {
    return select(connectionProvider, adLanguage, cCurrencyConv, legalEntity, datePlus, maxaggDate, processTime, dateTimeFormat, organization, warehouse, costOrg, costClient, costType, categoryProduct, 0, 0);
  }
  ...
  public static ReportValuationStockData[] select(ConnectionProvider connectionProvider, String adLanguage, String cCurrencyConv, String legalEntity, String datePlus, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String costOrg, String costClient, String costType, String categoryProduct, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "                   trx.C_UOM_ID, trx.AD_CLIENT_ID, trx.iscostcalculated, tc.c_currency_id, tc.movementdate, WH.NAME AS WAREHOUSE" +
    ...
    strSql = strSql + 
      ")" +
      "                    AND 0=0";
    strSql = strSql + ((warehouse==null || warehouse.equals(""))?"":"  AND l.M_WAREHOUSE_ID = ?  ");
    strSql = strSql + 
      "                    GROUP BY trx.M_PRODUCT_ID, trx.C_UOM_ID, trx.AD_CLIENT_ID, trx.iscostcalculated, tc.c_currency_id, tc.movementdate,WH.NAME" +
      "                    UNION ALL" +
    ...
    strSql = strSql + 
      "                    ) A," +
      "                    C_UOM," +
      "                    M_PRODUCT LEFT JOIN (SELECT mc.COST as COST, mc.DATEFROM, mc.M_PRODUCT_ID, mc.c_currency_id" +
      "                                        FROM M_COSTING mc" +
    ...
    strSql = strSql + 
      ")" +
      "                                                GROUP BY mc2.M_PRODUCT_ID) dc ON (mc.DATEFROM = dc.DATEFROM AND mc.M_PRODUCT_ID = dc.M_PRODUCT_ID)" +
  ...
  public static ReportValuationStockData[] selectClusteredByWarehouse(ConnectionProvider connectionProvider, String adLanguage, String datePlus, String legalEntity, String cCurrencyConv, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String categoryProduct, String costOrg, String costClient, String costType)    throws ServletException {
    return selectClusteredByWarehouse(connectionProvider, adLanguage, datePlus, legalEntity, cCurrencyConv, maxaggDate, processTime, dateTimeFormat, organization, warehouse, categoryProduct, costOrg, costClient, costType, 0, 0);
  }
  ...
  public static ReportValuationStockData[] selectClusteredByWarehouse(ConnectionProvider connectionProvider, String adLanguage, String datePlus, String legalEntity, String cCurrencyConv, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String categoryProduct, String costOrg, String costClient, String costType, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "    JOIN M_COSTING c ON  c.datefrom = (SELECT max(c2.datefrom) FROM m_costing c2 WHERE ZZ.m_product_id = c2.m_product_id AND c2.DATEFROM < to_date(?) AND 4 = 4";
    ...
    strSql = strSql + 
      ")" +
      "                    AND c.dateto > c.datefrom" +
      "                    AND c.m_product_id = ZZ.m_product_id" +
      ...
      "      null AS TOTAL_COST," +
      "      C_CURRENCY_CONVERT_PRECISION(c.COST, c.c_currency_id, c_currency.c_currency_id, to_date(?), NULL, c.AD_CLIENT_ID, ?, 'C') as COST_TYPE," +
      "      ROUND(stock.QTY * C_CURRENCY_CONVERT_PRECISION(c.COST, c.c_currency_id, c_currency.c_currency_id, to_date(?), NULL, c.AD_CLIENT_ID, ?, 'C'), c_currency.stdprecision) as VALUATION_TYPE," +
      "      'ALL Warehouses' as WAREHOUSE," +
      "      '' as ID, '' as PADRE , '' AS NAME" +
      "  FROM m_product_category pc" +
      "    JOIN (" +
    ...
    strSql = strSql + 
      ...
      "    JOIN c_currency ON c_currency.c_currency_id = ?" +
      "    JOIN m_costing c ON c.datefrom = (SELECT max(datefrom) FROM m_costing c2 WHERE stock.m_product_id = c2.m_product_id AND c2.DATEFROM < to_date(?) AND 6 = 6";
    strSql = strSql + ((costOrg==null || costOrg.equals(""))?"":"  AND c2.AD_ORG_ID IN (?,'0')  ");
    strSql = strSql + ((costClient==null || costClient.equals(""))?"":"  AND c2.ad_client_id = ?  ");
    strSql = strSql + 
      " AND  c2.costtype IN (";
    ...
    strSql = strSql + 
      ")" +
      "                      AND c.dateto > c.datefrom" +
      "                      AND c.m_product_id = stock.m_product_id" +
      "  WHERE 3 = 3";
    strSql = strSql + ((categoryProduct==null || categoryProduct.equals(""))?"":"  AND pc.M_PRODUCT_CATEGORY_ID= ?  ");
    strSql = strSql + 
  ...
  public static ReportValuationStockData[] selectWithoutCost(ConnectionProvider connectionProvider, String adLanguage, String cCurrencyConv, String legalEntity, String datePlus, String maxaggDate, String processTime, String dateTimeFormat, String organization, String warehouse, String categoryProduct, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "              FROM M_PRODUCT_CATEGORY," +
      "                   (SELECT trx.M_PRODUCT_ID, sum(trx.MOVEMENTQTY) AS QTY, sum(CASE WHEN trx.MOVEMENTQTY < 0 THEN- tc.trxcost ELSE tc.trxcost END) AS Suma, " +
      "                   trx.C_UOM_ID, trx.AD_CLIENT_ID, trx.iscostcalculated, tc.c_currency_id, tc.movementdate as movementdate, WH.NAME AS WAREHOUSE" +
      "                    FROM M_TRANSACTION trx " +
      "                      JOIN M_LOCATOR l ON trx.M_LOCATOR_ID = l.M_LOCATOR_ID" +
      "                      INNER JOIN M_WAREHOUSE WH ON l.M_WAREHOUSE_ID = WH.M_WAREHOUSE_ID" +
      "                      LEFT JOIN (SELECT sum(cost) AS trxcost, m_transaction_id, c_currency_id, COALESCE(dateacct, costdate) as movementdate" +
