...
static Logger log4j = Logger.getLogger(ReportGeneralLedgerJournalData.class);
  ...
  public static ReportGeneralLedgerJournalData[] select(ConnectionProvider connectionProvider, String descriptionGrouping, String adUserClient, String adUserOrg, String parDateFrom, String parDateTo, String docbasetype, String documentNo, String acctschema, String orgFamily, String checks, String allaccounts, String accountFrom, String accountTo, String paramLanguage)    throws ServletException {
    return select(connectionProvider, descriptionGrouping, adUserClient, adUserOrg, parDateFrom, parDateTo, docbasetype, documentNo, acctschema, orgFamily, checks, allaccounts, accountFrom, accountTo, paramLanguage, 0, 0);
  }

  public static ReportGeneralLedgerJournalData[] select(ConnectionProvider connectionProvider, String descriptionGrouping, String adUserClient, String adUserOrg, String parDateFrom, String parDateTo, String docbasetype, String documentNo, String acctschema, String orgFamily, String checks, String allaccounts, String accountFrom, String accountTo, String paramLanguage, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static ReportGeneralLedgerJournalData[] selectCountGroupedLines(ConnectionProvider connectionProvider, String adUserClient, String adUserOrg, String parDateFrom, String parDateTo, String docbasetype, String documentNo, String acctschema, String orgFamily, String checks, String allaccounts, String accountFrom, String accountTo)    throws ServletException {
    return selectCountGroupedLines(connectionProvider, adUserClient, adUserOrg, parDateFrom, parDateTo, docbasetype, documentNo, acctschema, orgFamily, checks, allaccounts, accountFrom, accountTo, 0, 0);
  }

  public static ReportGeneralLedgerJournalData[] selectCountGroupedLines(ConnectionProvider connectionProvider, String adUserClient, String adUserOrg, String parDateFrom, String parDateTo, String docbasetype, String documentNo, String acctschema, String orgFamily, String checks, String allaccounts, String accountFrom, String accountTo, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static ReportGeneralLedgerJournalData[] selectDirect(ConnectionProvider connectionProvider, String descriptionGrouping, String adUserClient, String adUserOrg, String table, String record, String cAcctshemaId, String paramLanguage)    throws ServletException {
    return selectDirect(connectionProvider, descriptionGrouping, adUserClient, adUserOrg, table, record, cAcctshemaId, paramLanguage, 0, 0);
  }

  public static ReportGeneralLedgerJournalData[] selectDirect(ConnectionProvider connectionProvider, String descriptionGrouping, String adUserClient, String adUserOrg, String table, String record, String cAcctshemaId, String paramLanguage, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT SCHEMA_ID, SCHEMA_NAME, IDENTIFIER, DATEACCT, AA.VALUE, AA.NAME, ID, AD_TABLE_ID, DOCBASETYPE,AR.NAME as DOCNAME, SEQNO, '' AS TOTAL, DESCRIPTION," +
      "      (CASE FACTACCTTYPE WHEN 'O' THEN 1 WHEN 'N' THEN 2 WHEN 'R' THEN 3 WHEN 'D' THEN 4 ELSE 5 END) AS FACTACCTTYPE2," +
