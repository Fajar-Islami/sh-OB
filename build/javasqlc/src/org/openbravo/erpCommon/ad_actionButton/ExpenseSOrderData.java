...
static Logger log4j = Logger.getLogger(ExpenseSOrderData.class);
  ...
  public static String selectisPriceIncludingTaxes(ConnectionProvider connectionProvider, String mPricelistId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
