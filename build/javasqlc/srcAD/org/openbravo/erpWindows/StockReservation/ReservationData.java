...
static Logger log4j = Logger.getLogger(ReservationData.class);
  ...
  public String reservedgoodmntPe;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("reservedgoodmnt_pe") || fieldName.equals("reservedgoodmntPe"))
      return reservedgoodmntPe;
 ...
 */
  public static ReservationData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "M_Reservation.Reservedgoodmnt_Pe, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectReservationData.reservedgoodmntPe = UtilSql.getValue(result, "reservedgoodmnt_pe");
 ...
 */
  public static ReservationData[] set(String reservedgoodmntPe, String mReservationId, String adClientId, String adOrgId, String isactive, String updatedby, String updatedbyr, String mProductId, String mProductIdr, String quantity, String cUomId, String cOrderlineId, String cOrderlineIdr, String mWarehouseId, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String mLocatorId, String mLocatorIdr, String createdby, String createdbyr, String reservedqty, String releasedqty, String resStatus, String resProcess, String resProcessBtn, String managereservationPe)    throws ServletException {
    ...
    objectReservationData[0].reservedgoodmntPe = reservedgoodmntPe;
 ...
 */
  public static String selectAux51A01FEBD73F45189B342865ACE44FAC(ConnectionProvider connectionProvider, String M_Product_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET RES_Process = (?) , AD_Org_ID = (?) , M_Product_ID = (?) , Quantity = TO_NUMBER(?) , C_Uom_ID = (?) , C_Orderline_ID = (?) , M_Warehouse_ID = (?) , M_Locator_ID = (?) , M_Attributesetinstance_ID = (?) , Reservedgoodmnt_Pe = (?) , Managereservation_Pe = (?) , Isactive = (?) , RES_Status = (?) , AD_Client_ID = (?) , M_Reservation_ID = (?) , ReleasedQty = TO_NUMBER(?) , Reservedqty = TO_NUMBER(?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, reservedgoodmntPe);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (RES_Process, AD_Org_ID, M_Product_ID, Quantity, C_Uom_ID, C_Orderline_ID, M_Warehouse_ID, M_Locator_ID, M_Attributesetinstance_ID, Reservedgoodmnt_Pe, Managereservation_Pe, Isactive, RES_Status, AD_Client_ID, M_Reservation_ID, ReleasedQty, Reservedqty, created, createdby, updated, updatedBy)" +
