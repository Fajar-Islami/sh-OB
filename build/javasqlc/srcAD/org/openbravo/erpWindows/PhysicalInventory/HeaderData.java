...
static Logger log4j = Logger.getLogger(HeaderData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return postedBtn;
    else if (fieldName.equalsIgnoreCase("inventory_type") || fieldName.equals("inventoryType"))
      return inventoryType;
    else if (fieldName.equalsIgnoreCase("inventory_typer") || fieldName.equals("inventoryTyper"))
      return inventoryTyper;
  ...
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectHeaderData.inventoryType = UtilSql.getValue(result, "inventory_type");
        objectHeaderData.inventoryTyper = UtilSql.getValue(result, "inventory_typer");
...
Create a registry
 */
  public static HeaderData[] set(String inventoryType, String mInventoryId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String name, String description, String movementdate, String processed, String processing, String mWarehouseId, String updateqty, String generatelist, String posted, String postedBtn, String user2Id, String user1Id, String cActivityId, String cCampaignId, String adOrgtrxId, String cProjectId, String cProjectIdr, String aAssetId, String cCostcenterId)    throws ServletException {
    ...
    objectHeaderData[0].inventoryType = inventoryType;
    objectHeaderData[0].inventoryTyper = "";
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_Inventory" +
      "        SET AD_Org_ID = (?) , MovementDate = TO_DATE(?) , Name = (?) , M_Warehouse_ID = (?) , Description = (?) , GenerateList = (?) , UpdateQty = (?) , Processing = (?) , Posted = (?) , Inventory_Type = (?) , C_Project_ID = (?) , C_Costcenter_ID = (?) , A_Asset_ID = (?) , C_Activity_ID = (?) , User1_ID = (?) , C_Campaign_ID = (?) , AD_OrgTrx_ID = (?) , User2_ID = (?) , IsActive = (?) , M_Inventory_ID = (?) , Processed = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, inventoryType);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, MovementDate, Name, M_Warehouse_ID, Description, GenerateList, UpdateQty, Processing, Posted, Inventory_Type, C_Project_ID, C_Costcenter_ID, A_Asset_ID, C_Activity_ID, User1_ID, C_Campaign_ID, AD_OrgTrx_ID, User2_ID, IsActive, M_Inventory_ID, Processed, AD_Client_ID, created, createdby, updated, updatedBy)" +
