 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET C_AcctSchema_ID = (?) , A_Accumdepreciation_Acct = (?) , A_Depreciation_Acct = (?) , Processing = (?) , IsActive = (?) , A_Disposal_Gain = (?) , A_Disposal_Loss = (?) , AD_Org_ID = (?) , AD_Client_ID = (?) , A_Asset_Group_Acct_ID = (?) , A_Asset_Group_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE A_Asset_Group_Acct.A_Asset_Group_Acct_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (C_AcctSchema_ID, A_Accumdepreciation_Acct, A_Depreciation_Acct, Processing, IsActive, A_Disposal_Gain, A_Disposal_Loss, AD_Org_ID, AD_Client_ID, A_Asset_Group_Acct_ID, A_Asset_Group_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), (?), (?), (?), (?), (?), (?), (?), (?), now(), ?, now(), ?)";
