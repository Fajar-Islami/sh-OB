...
static Logger log4j = Logger.getLogger(LinesData.class);
  ...
  public String canceledInoutlineId;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("canceled_inoutline_id") || fieldName.equals("canceledInoutlineId"))
      return canceledInoutlineId;
...
Select for edit
 */
  public static LinesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mInoutId, String key, String adUserClient, String adOrgClient)    throws ServletException {
...
Select for edit
 */
  public static LinesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String mInoutId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "M_InOutLine.Aumqty, " +
      "M_InOutLine.C_Aum, " +
      "(CASE WHEN M_InOutLine.C_Aum IS NULL THEN '' ELSE  ( COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL4.Name IS NULL THEN TO_CHAR(table4.Name) ELSE TO_CHAR(tableTRL4.Name) END)), ''))),'') ) END) AS C_AumR, " +
      "M_InOutLine.MovementQty, " +
      "M_InOutLine.C_UOM_ID, " +
      "(CASE WHEN M_InOutLine.C_UOM_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR((CASE WHEN tableTRL6.Name IS NULL THEN TO_CHAR(table6.Name) ELSE TO_CHAR(tableTRL6.Name) END)), ''))),'') ) END) AS C_UOM_IDR, " +
      "M_InOutLine.M_Locator_ID, " +
      "M_InOutLine.Description, " +
      "M_InOutLine.C_OrderLine_ID, " +
      "(CASE WHEN M_InOutLine.C_OrderLine_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.DocumentNo), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(table9.DateOrdered, 'DD-MM-YYYY')),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table9.GrandTotal), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.Line), ''))),'')  || ' - ' || COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table8.LineNetAmt), ''))),'') ) END) AS C_OrderLine_IDR, " +
      ...
      "(CASE WHEN M_InOutLine.C_Bpartner_ID IS NULL THEN '' ELSE  (COALESCE(TO_CHAR(TO_CHAR(COALESCE(TO_CHAR(table11.Name), ''))),'') ) END) AS C_Bpartner_IDR, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectLinesData.canceledInoutlineId = UtilSql.getValue(result, "canceled_inoutline_id");
...
Create a registry
 */
  public static LinesData[] set(String mInoutId, String aAssetId, String mInoutlineId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String mLocatorId, String mProductId, String mProductIdr, String movementqty, String description, String mConditionGoodsId, String line, String cOrderlineId, String cOrderlineIdr, String cUomId, String user1Id, String isinvoiced, String cCostcenterId, String aumqty, String cAum, String explode, String mProductUomId, String quantityorder, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String isdescription, String user2Id, String canceledInoutlineId, String cBpartnerId, String cBpartnerIdr, String managePrereservation, String bomParentId, String cProjectId, String cProjectIdr)    throws ServletException {
    ...
    objectLinesData[0].canceledInoutlineId = canceledInoutlineId;
 ...
 */
  public static String selectAux800005(ConnectionProvider connectionProvider, String M_Product_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux0AD5488DC1E74A3997B8D9D6C5E16841(ConnectionProvider connectionProvider, String M_PRODUCT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux24824516BC4A40CB8E81F52301EF5F8E(ConnectionProvider connectionProvider, String M_PRODUCT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux44C89F429E0E42F7961A634D61F34E0A(ConnectionProvider connectionProvider, String M_INOUT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux52BCE83D589C498B9803D32847553A8D(ConnectionProvider connectionProvider, String M_Product_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux56653DE396CD4C2DBF54D7FA526656D3(ConnectionProvider connectionProvider, String M_INOUT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux6DDE5291DEB245BAB84FFD042AE66D4C(ConnectionProvider connectionProvider, String M_INOUT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux8CE0EE9876AB46108C71DC94FE330EA4(ConnectionProvider connectionProvider, String M_INOUT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAuxA39F6F19458F478B9B5A87209655A784(ConnectionProvider connectionProvider, String m_inout_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAuxB1CA1E7F4D9547F7B0317146C1742F88(ConnectionProvider connectionProvider, String M_Product_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAuxF1B30F5F741C4709B745AB64E249F6F9(ConnectionProvider connectionProvider, String M_INOUT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "         SELECT AD_ORG_ID" +
      "FROM M_INOUT" +
...
Select for auxiliar field
 */
  public static String selectDef3534_0(ConnectionProvider connectionProvider, String CreatedByR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef3539_2(ConnectionProvider connectionProvider, String paramLanguage, String M_Product_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef3811_3(ConnectionProvider connectionProvider, String C_OrderLine_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef8772_4(ConnectionProvider connectionProvider, String M_AttributeSetInstance_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDefBD1602011B5E4AD1B5DD85E8E9017B11_5(ConnectionProvider connectionProvider, String C_Bpartner_IDR)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_InOutLine" +
      "        SET Line = TO_NUMBER(?) , M_Product_ID = (?) , M_Condition_Goods_ID = (?) , M_AttributeSetInstance_ID = (?) , Aumqty = TO_NUMBER(?) , C_Aum = (?) , MovementQty = TO_NUMBER(?) , C_UOM_ID = (?) , M_Locator_ID = (?) , Description = (?) , C_OrderLine_ID = (?) , M_Product_Uom_Id = (?) , QuantityOrder = TO_NUMBER(?) , Canceled_Inoutline_ID = (?) , Manage_Prereservation = (?) , AD_Org_ID = (?) , C_Bpartner_ID = (?) , C_Project_ID = (?) , C_Costcenter_ID = (?) , A_Asset_ID = (?) , User1_ID = (?) , User2_ID = (?) , Explode = (?) , BOM_Parent_ID = (?) , IsInvoiced = (?) , IsDescription = (?) , M_InOutLine_ID = (?) , M_InOut_ID = (?) , IsActive = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_InOutLine.M_InOutLine_ID = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, canceledInoutlineId);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Line, M_Product_ID, M_Condition_Goods_ID, M_AttributeSetInstance_ID, Aumqty, C_Aum, MovementQty, C_UOM_ID, M_Locator_ID, Description, C_OrderLine_ID, M_Product_Uom_Id, QuantityOrder, Canceled_Inoutline_ID, Manage_Prereservation, AD_Org_ID, C_Bpartner_ID, C_Project_ID, C_Costcenter_ID, A_Asset_ID, User1_ID, User2_ID, Explode, BOM_Parent_ID, IsInvoiced, IsDescription, M_InOutLine_ID, M_InOut_ID, IsActive, AD_Client_ID, created, createdby, updated, updatedBy)" +
