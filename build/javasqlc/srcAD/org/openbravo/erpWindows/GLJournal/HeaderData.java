...
Select for auxiliar field
 */
  public static String selectAux9F7DE5D4045A4391A93E1444C6D921C7(ConnectionProvider connectionProvider, String c_acctschema_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE GL_Journal" +
      "        SET AD_Org_ID = (?) , C_AcctSchema_ID = (?) , DocumentNo = (?) , Description = (?) , C_DocType_ID = (?) , DateDoc = TO_DATE(?) , DateAcct = TO_DATE(?) , C_Period_ID = (?) , C_Currency_ID = (?) , CurrencyRateType = (?) , CurrencyRate = TO_NUMBER(?) , IsOpening = (?) , ControlAmt = TO_NUMBER(?) , TotalDr = TO_NUMBER(?) , TotalCr = TO_NUMBER(?) , DocAction = (?) , Posted = (?) , DocStatus = (?) , IsActive = (?) , IsPrinted = (?) , GL_Category_ID = (?) , IsApproved = (?) , C_Bpartner_ID = (?) , M_Product_ID = (?) , C_Project_ID = (?) , C_Costcenter_ID = (?) , A_Asset_ID = (?) , C_Campaign_ID = (?) , User1_ID = (?) , User2_ID = (?) , GL_Journal_ID = (?) , GL_JournalBatch_ID = (?) , Processing = (?) , PostingType = (?) , AD_Client_ID = (?) , Processed = (?) , updated = now(), updatedby = ? " +
      "        WHERE GL_Journal.GL_Journal_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, C_AcctSchema_ID, DocumentNo, Description, C_DocType_ID, DateDoc, DateAcct, C_Period_ID, C_Currency_ID, CurrencyRateType, CurrencyRate, IsOpening, ControlAmt, TotalDr, TotalCr, DocAction, Posted, DocStatus, IsActive, IsPrinted, GL_Category_ID, IsApproved, C_Bpartner_ID, M_Product_ID, C_Project_ID, C_Costcenter_ID, A_Asset_ID, C_Campaign_ID, User1_ID, User2_ID, GL_Journal_ID, GL_JournalBatch_ID, Processing, PostingType, AD_Client_ID, Processed, created, createdby, updated, updatedBy)" +
