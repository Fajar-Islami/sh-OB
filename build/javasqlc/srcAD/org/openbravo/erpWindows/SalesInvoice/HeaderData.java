  ...
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectHeaderData.prepaymentamt = UtilSql.getValue(result, "prepaymentamt");
 ...
 */
  public static HeaderData[] set(String lastcalculatedondate, String cWithholdingId, String withholdingamount, String taxdate, String daystilldue, String cInvoiceId, String adClientId, String adOrgId, String isactive, String created, String createdby, String createdbyr, String updatedby, String updatedbyr, String documentno, String cDoctypeId, String docstatus, String docaction, String docactionBtn, String processing, String processed, String cBpartnerId, String cBpartnerIdr, String cPaymenttermId, String cBpartnerLocationId, String cCurrencyId, String totallines, String grandtotal, String dateacct, String cCampaignId, String cProjectId, String cProjectIdr, String cActivityId, String salesrepId, String adUserId, String issotrx, String cDoctypetargetId, String description, String dateinvoiced, String dateprinted, String poreference, String cChargeId, String chargeamt, String mPricelistId, String paymentrule, String cOrderId, String cOrderIdr, String dateordered, String isdiscountprinted, String isprinted, String prepaymentamt, String istaxincluded, String posted, String postedBtn, String generateto, String createfrom, String emAprmAddpayment, String finPaymentmethodId, String copyfrom, String isselfservice, String emAprmProcessinvoice, String emAprmProcessinvoiceBtn, String cCostcenterId, String adOrgtrxId, String user1Id, String user2Id, String finalsettlement, String daysoutstanding, String percentageoverdue, String totalpaid, String outstandingamt, String dueamt, String ispaid, String updatepaymentmonitor, String aAssetId, String calculatePromotions)    throws ServletException {
    ...
    objectHeaderData[0].prepaymentamt = prepaymentamt;
 ...
 */
  public static String selectAux1459AA66723E4905BE05C09DC757DA6E(ConnectionProvider connectionProvider, String AD_Client_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux34E27119A7B74205B025002E9CD5074F(ConnectionProvider connectionProvider, String C_INVOICE_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select 'Y' from dual where exists (select 1 from c_invoiceline where c_invoice_id = ?) ";
...
Select for auxiliar field
 */
  public static String selectAux7A6DD0A1AF304BE288BBFBE305EA1227(ConnectionProvider connectionProvider, String c_doctypetarget_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select coalesce(max(docbasetype), 'ARI') from c_doctype where c_doctype_id = ? ";
...
Select for auxiliar field
 */
  public static String selectAuxB54EEEFACAD4427ABE5F88D0C27524B5(ConnectionProvider connectionProvider, String C_INVOICE_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAuxFFA925AAC4BB49D5A67C05DAD16EFA32(ConnectionProvider connectionProvider, String c_invoice_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE C_Invoice" +
      "        SET AD_Org_ID = (?) , C_DocTypeTarget_ID = (?) , DocumentNo = (?) , DateInvoiced = TO_DATE(?) , C_BPartner_ID = (?) , C_BPartner_Location_ID = (?) , Description = (?) , C_PaymentTerm_ID = (?) , FIN_Paymentmethod_ID = (?) , DocStatus = (?) , GrandTotal = TO_NUMBER(?) , TotalLines = TO_NUMBER(?) , C_Currency_ID = (?) , Ispaid = (?) , AD_User_ID = (?) , Totalpaid = TO_NUMBER(?) , EM_APRM_Addpayment = (?) , Posted = (?) , EM_APRM_Processinvoice = (?) , DocAction = (?) , CreateFrom = (?) , CopyFrom = (?) , OutstandingAmt = TO_NUMBER(?) , DueAmt = TO_NUMBER(?) , DaysTillDue = TO_NUMBER(?) , Percentageoverdue = TO_NUMBER(?) , AD_OrgTrx_ID = (?) , Finalsettlement = TO_DATE(?) , Daysoutstanding = TO_NUMBER(?) , M_PriceList_ID = (?) , SalesRep_ID = (?) , C_Order_ID = (?) , POReference = (?) , DateAcct = TO_DATE(?) , UpdatePaymentMonitor = (?) , Taxdate = TO_DATE(?) , C_Activity_ID = (?) , C_Charge_ID = (?) , ChargeAmt = TO_NUMBER(?) , DateOrdered = TO_DATE(?) , C_DocType_ID = (?) , Calculate_Promotions = (?) , C_Project_ID = (?) , C_Costcenter_ID = (?) , A_Asset_ID = (?) , C_Campaign_ID = (?) , User1_ID = (?) , User2_ID = (?) , Prepaymentamt = TO_NUMBER(?) , AD_Client_ID = (?) , LastCalculatedOnDate = TO_DATE(?) , Withholdingamount = TO_NUMBER(?) , C_Withholding_ID = (?) , IsSelfService = (?) , GenerateTo = (?) , IsTaxIncluded = (?) , IsPrinted = (?) , IsDiscountPrinted = (?) , PaymentRule = (?) , IsSOTrx = (?) , DatePrinted = TO_DATE(?) , Processing = (?) , Processed = (?) , IsActive = (?) , C_Invoice_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE C_Invoice.C_Invoice_ID = ? " +
      "        AND C_Invoice.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, C_DocTypeTarget_ID, DocumentNo, DateInvoiced, C_BPartner_ID, C_BPartner_Location_ID, Description, C_PaymentTerm_ID, FIN_Paymentmethod_ID, DocStatus, GrandTotal, TotalLines, C_Currency_ID, Ispaid, AD_User_ID, Totalpaid, EM_APRM_Addpayment, Posted, EM_APRM_Processinvoice, DocAction, CreateFrom, CopyFrom, OutstandingAmt, DueAmt, DaysTillDue, Percentageoverdue, Finalsettlement, AD_OrgTrx_ID, Daysoutstanding, M_PriceList_ID, SalesRep_ID, C_Order_ID, POReference, DateAcct, UpdatePaymentMonitor, Taxdate, C_Activity_ID, C_Charge_ID, ChargeAmt, DateOrdered, C_DocType_ID, Calculate_Promotions, C_Project_ID, C_Costcenter_ID, A_Asset_ID, C_Campaign_ID, User1_ID, User2_ID, Prepaymentamt, AD_Client_ID, LastCalculatedOnDate, Withholdingamount, C_Withholding_ID, IsSelfService, GenerateTo, IsTaxIncluded, IsPrinted, IsDiscountPrinted, PaymentRule, IsSOTrx, DatePrinted, Processing, Processed, IsActive, C_Invoice_ID, created, createdby, updated, updatedBy)" +
      "        VALUES ((?), (?), (?), TO_DATE(?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), (?), (?), (?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_DATE(?), (?), TO_NUMBER(?), (?), (?), (?), (?), TO_DATE(?), (?), TO_DATE(?), (?), (?), TO_NUMBER(?), TO_DATE(?), (?), (?), (?), (?), (?), (?), (?), (?), TO_NUMBER(?), (?), TO_DATE(?), TO_NUMBER(?), (?), (?), (?), (?), (?), (?), (?), (?), TO_DATE(?), (?), (?), (?), (?), now(), ?, now(), ?)";
