  ...
  public static ProductData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectProductData.islinkedtoproduct = UtilSql.getValue(result, "islinkedtoproduct");
        objectProductData.prodCatSelection = UtilSql.getValue(result, "prod_cat_selection");
        objectProductData.prodCatSelectionr = UtilSql.getValue(result, "prod_cat_selectionr");
        objectProductData.productSelection = UtilSql.getValue(result, "product_selection");
        objectProductData.productSelectionr = UtilSql.getValue(result, "product_selectionr");
        objectProductData.returnable = UtilSql.getValue(result, "returnable");
        objectProductData.overdueReturnDays = UtilSql.getValue(result, "overdue_return_days");
        objectProductData.ispricerulebased = UtilSql.getValue(result, "ispricerulebased");
        objectProductData.quantityRule = UtilSql.getValue(result, "quantity_rule");
        objectProductData.quantityRuler = UtilSql.getValue(result, "quantity_ruler");
        objectProductData.uniquePerDocument = UtilSql.getValue(result, "unique_per_document");
        objectProductData.printDescription = UtilSql.getValue(result, "print_description");
        objectProductData.relateprodcattoservice = UtilSql.getValue(result, "relateprodcattoservice");
        objectProductData.relateprodtoservice = UtilSql.getValue(result, "relateprodtoservice");
        objectProductData.allowDeferredSell = UtilSql.getValue(result, "allow_deferred_sell");
        objectProductData.deferredSellMaxDays = UtilSql.getValue(result, "deferred_sell_max_days");
 ...
 */
  public static ProductData[] set(String mProductId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String name, String description, String issummary, String cUomId, String isstocked, String ispurchased, String issold, String volume, String weight, String revplantype, String quantityRule, String value, String mProductCategoryId, String cTaxcategoryId, String upc, String sku, String shelfwidth, String shelfheight, String shelfdepth, String unitsperpallet, String discontinued, String discontinuedby, String defaultperiod, String allowDeferredSell, String relateprodtoservice, String documentnote, String help, String classification, String salesrepId, String bookusingpoprice, String isbom, String isinvoiceprintdetails, String ispicklistprintdetails, String isverified, String processing, String islinkedtoproduct, String capacity, String delaymin, String mrpPlannerId, String mrpPlanningmethodId, String qtymax, String qtymin, String qtystd, String qtytype, String stockmin, String productSelection, String uniquePerDocument, String overdueReturnDays, String relateprodcattoservice, String sExpensetypeId, String sResourceId, String ispricerulebased, String producttype, String imageurl, String descriptionurl, String versionno, String guaranteedays, String deferredSellMaxDays, String attrsetvaluetype, String adImageId, String cBpartnerId, String ispriceprinted, String name2, String costtype, String coststd, String stockMin, String enforceAttribute, String calculated, String maProcessplanId, String production, String isdeferredrevenue, String mAttributesetId, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String downloadurl, String mFreightcategoryId, String mLocatorId, String isdeferredexpense, String printDescription, String prodCatSelection, String defaultperiodExp, String expplantype, String periodnumberExp, String updateinvariants, String returnable, String mBrandId, String isgeneric, String genericProductId, String createvariants, String characteristicDesc, String managevariants, String cUomWeightId, String isquantityvariable, String periodnumber)    throws ServletException {
    ...
    objectProductData[0].islinkedtoproduct = islinkedtoproduct;
    objectProductData[0].prodCatSelection = prodCatSelection;
    objectProductData[0].prodCatSelectionr = "";
    objectProductData[0].productSelection = productSelection;
    objectProductData[0].productSelectionr = "";
    objectProductData[0].returnable = returnable;
    objectProductData[0].overdueReturnDays = overdueReturnDays;
    objectProductData[0].ispricerulebased = ispricerulebased;
    objectProductData[0].quantityRule = quantityRule;
    objectProductData[0].quantityRuler = "";
    objectProductData[0].uniquePerDocument = uniquePerDocument;
    objectProductData[0].printDescription = printDescription;
    objectProductData[0].relateprodcattoservice = relateprodcattoservice;
    objectProductData[0].relateprodtoservice = relateprodtoservice;
    objectProductData[0].allowDeferredSell = allowDeferredSell;
    objectProductData[0].deferredSellMaxDays = deferredSellMaxDays;
