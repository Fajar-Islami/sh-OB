...
Select for auxiliar field
 */
  public static String selectDef4765(ConnectionProvider connectionProvider, String AD_Org_ID, String AD_Client_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (M_Production_ID, Productionplandate, Line, MA_Wrphase_ID, Starttime, Endtime, MA_Costcenter_Version_ID, Calccost, Neededquantity, ProductionQty, Secondaryunit, Conversionrate, Secondaryqty, Rejectedquantity, MA_Costcenteruse, Usedmaterial, Outsourced, Processed, Estimatedtime, Runtime, Closephase, Validating, AD_Org_ID, M_ProductionPlan_ID, Description, M_Product_ID, IsActive, AD_Client_ID, M_Locator_ID, created, createdby, updated, updatedBy)" +
