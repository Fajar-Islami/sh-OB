 ...
 */
  public static String selectAux800009(ConnectionProvider connectionProvider, String M_Product_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux1FC6075EA994422F8CF3B041621F374D(ConnectionProvider connectionProvider, String M_PRODUCT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux3BC05D242CF749FBAC016CAF3071EAB0(ConnectionProvider connectionProvider, String M_INOUT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux3C85410D6A9549C99BC60258CBD809BD(ConnectionProvider connectionProvider, String m_inout_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux4E3EE7A38AF3414FB89B496F9F4E8263(ConnectionProvider connectionProvider, String M_INOUT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux8EE1AE595E1E462BBFE568C0C27BEAC0(ConnectionProvider connectionProvider, String M_Product_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAuxA9B8EA3C15E14EFB901131BF4DFFF687(ConnectionProvider connectionProvider, String M_INOUT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAuxAA79289FD0CB4B69BFB31FC8A8C076EB(ConnectionProvider connectionProvider, String M_PRODUCT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAuxB4A64414F61A4901A24A5B968FEE309A(ConnectionProvider connectionProvider, String M_INOUT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAuxDE561A006F4247DFA68E13C955437EF5(ConnectionProvider connectionProvider, String M_Product_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAuxE5295F791A5840A2B28868ED6A7634D3(ConnectionProvider connectionProvider, String M_INOUT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "         SELECT AD_ORG_ID" +
      "FROM M_INOUT" +
