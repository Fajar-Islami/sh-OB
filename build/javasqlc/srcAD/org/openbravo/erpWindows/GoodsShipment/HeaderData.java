...
static Logger log4j = Logger.getLogger(HeaderData.class);
  ...
  public String isnettingshipment;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return poreference;
    else if (fieldName.equalsIgnoreCase("isnettingshipment"))
      return isnettingshipment;
 ...
 */
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "M_InOut.POReference, " +
      "COALESCE(M_InOut.Isnettingshipment, 'N') AS Isnettingshipment, " +
      "M_InOut.DateOrdered, " +
      "M_InOut.SalesRep_ID, " +
      "M_InOut.CreateFrom, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectHeaderData.isnettingshipment = UtilSql.getValue(result, "isnettingshipment");
 ...
 */
  public static HeaderData[] set(String freightCurrencyId, String processGoodsJava, String processGoodsJavaBtn, String description, String movementtype, String movementdate, String processed, String processing, String mInoutId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String issotrx, String documentno, String cDoctypeId, String isprinted, String dateacct, String cBpartnerId, String cBpartnerIdr, String cBpartnerLocationId, String adUserId, String mWarehouseId, String poreference, String deliveryrule, String freightcostrule, String freightamt, String deliveryviarule, String mShipperId, String cChargeId, String chargeamt, String priorityrule, String dateprinted, String cOrderId, String cOrderIdr, String mConditionGoodsId, String dateordered, String docstatus, String docaction, String createfrom, String generateto, String cInvoiceId, String posted, String postedBtn, String updatelines, String islogistic, String generatelines, String deliveryLocationId, String mFreightcategoryId, String calculateFreight, String salesrepId, String cCostcenterId, String isnettingshipment, String pickdate, String trackingno, String nopackages, String shipdate, String user2Id, String user1Id, String cActivityId, String cCampaignId, String cProjectId, String cProjectIdr, String adOrgtrxId, String rmReceiptPickedit, String rmShipmentPickedit, String aAssetId)    throws ServletException {
    ...
    objectHeaderData[0].isnettingshipment = isnettingshipment;
 ...
 */
  public static String selectAux3E769128EA274A8480EBB341E05468AF(ConnectionProvider connectionProvider, String c_doctype_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux97AB64E23F264957BA14C2DAA29DBD80(ConnectionProvider connectionProvider, String M_INOUT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select 'Y' from dual where exists (select 1 from m_inoutline where m_inout_id = ?) ";
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        UPDATE M_InOut" +
      "        SET AD_Org_ID = (?) , C_DocType_ID = (?) , DocumentNo = (?) , M_Condition_Goods_ID = (?) , M_Warehouse_ID = (?) , C_BPartner_ID = (?) , C_BPartner_Location_ID = (?) , Description = (?) , MovementDate = TO_DATE(?) , Delivery_Location_ID = (?) , DocStatus = (?) , AD_User_ID = (?) , DateAcct = TO_DATE(?) , C_Order_ID = (?) , POReference = (?) , Isnettingshipment = (?) , DateOrdered = TO_DATE(?) , SalesRep_ID = (?) , CreateFrom = (?) , Process_Goods_Java = (?) , DocAction = (?) , Posted = (?) , DeliveryRule = (?) , DeliveryViaRule = (?) , FreightAmt = TO_NUMBER(?) , FreightCostRule = (?) , M_Shipper_ID = (?) , PriorityRule = (?) , PickDate = TO_TIMESTAMP(?, ?) , TrackingNo = (?) , NoPackages = TO_NUMBER(?) , MovementType = (?) , C_Charge_ID = (?) , ChargeAmt = TO_NUMBER(?) , ShipDate = TO_TIMESTAMP(?, ?) , C_Activity_ID = (?) , C_Campaign_ID = (?) , AD_OrgTrx_ID = (?) , M_FreightCategory_ID = (?) , Calculate_Freight = (?) , Freight_Currency_ID = (?) , C_Project_ID = (?) , C_Costcenter_ID = (?) , A_Asset_ID = (?) , User1_ID = (?) , User2_ID = (?) , AD_Client_ID = (?) , UpdateLines = (?) , C_Invoice_ID = (?) , GenerateTo = (?) , Islogistic = (?) , GenerateLines = (?) , RM_Receipt_PickEdit = (?) , IsPrinted = (?) , IsSOTrx = (?) , RM_Shipment_Pickedit = (?) , DatePrinted = TO_DATE(?) , Processing = (?) , Processed = (?) , M_InOut_ID = (?) , IsActive = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, isnettingshipment);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      "        INSERT INTO M_InOut " +
      "        (AD_Org_ID, C_DocType_ID, DocumentNo, M_Condition_Goods_ID, M_Warehouse_ID, C_BPartner_ID, C_BPartner_Location_ID, Description, MovementDate, Delivery_Location_ID, DocStatus, AD_User_ID, DateAcct, C_Order_ID, POReference, Isnettingshipment, DateOrdered, SalesRep_ID, CreateFrom, Process_Goods_Java, DocAction, Posted, DeliveryRule, DeliveryViaRule, FreightAmt, FreightCostRule, M_Shipper_ID, PriorityRule, PickDate, TrackingNo, NoPackages, MovementType, C_Charge_ID, ChargeAmt, ShipDate, C_Activity_ID, C_Campaign_ID, AD_OrgTrx_ID, M_FreightCategory_ID, Calculate_Freight, Freight_Currency_ID, C_Project_ID, C_Costcenter_ID, A_Asset_ID, User1_ID, User2_ID, AD_Client_ID, UpdateLines, C_Invoice_ID, GenerateTo, Islogistic, GenerateLines, RM_Receipt_PickEdit, IsPrinted, IsSOTrx, RM_Shipment_Pickedit, DatePrinted, Processing, Processed, M_InOut_ID, IsActive, created, createdby, updated, updatedBy)" +
