  ...
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectHeaderData.multiGl = UtilSql.getValue(result, "multi_gl");
...
Create a registry
 */
  public static HeaderData[] set(String user2Id, String glJournalId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String cDoctypeId, String documentno, String docstatus, String isprinted, String posted, String postedBtn, String description, String postingtype, String cAcctschemaId, String glCategoryId, String datedoc, String dateacct, String cPeriodId, String cCurrencyId, String glJournalbatchId, String totaldr, String totalcr, String docaction, String docactionBtn, String isapproved, String currencyratetype, String currencyrate, String cProjectId, String cCostcenterId, String isopening, String controlamt, String processed, String processing, String mProductId, String mProductIdr, String aAssetId, String cCampaignId, String cBpartnerId, String cBpartnerIdr, String user1Id, String multiGl)    throws ServletException {
    ...
    objectHeaderData[0].multiGl = multiGl;
 ...
 */
  public static String selectAux64361E0DD8C74E448A0C3C3F1987B8C1(ConnectionProvider connectionProvider, String c_acctschema_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectDef1634(ConnectionProvider connectionProvider, String C_PERIOD_ID, String HeaderDateDoc)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, HeaderDateDoc);
...
Select for auxiliar field
 */
  public static String selectDef1635(ConnectionProvider connectionProvider, String C_PERIOD_ID, String HeaderDateAcct)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT COALESCE((SELECT ENDDATE FROM C_PERIOD WHERE C_PERIOD_ID = ? and periodtype = 'A'),to_date(?)) FROM DUAL ";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      QueryTimeOutUtil.getInstance().setQueryTimeOut(st, SessionInfo.getQueryProfile());
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, C_PERIOD_ID);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, HeaderDateAcct);
...
Select for auxiliar field
 */
  public static String selectDef1636(ConnectionProvider connectionProvider, String C_Period_ID, String AD_Client_ID, String AD_Org_ID, String DateAcct, String Date)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, multiGl);
