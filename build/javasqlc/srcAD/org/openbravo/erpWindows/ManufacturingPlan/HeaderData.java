 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , DateDoc = TO_DATE(?) , Name = (?) , Timehorizon = TO_NUMBER(?) , Securitymargin = TO_NUMBER(?) , MRP_Planner_ID = (?) , C_BPartner_ID = (?) , C_BP_Group_ID = (?) , M_Product_ID = (?) , M_Product_Category_ID = (?) , Launchwr = (?) , Launchmr = (?) , Simulate = (?) , Recalculatestock = (?) , IsActive = (?) , Description = (?) , AD_Client_ID = (?) , MRP_Run_Production_ID = (?) , updated = now(), updatedby = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, DateDoc, Name, Timehorizon, Securitymargin, MRP_Planner_ID, C_BPartner_ID, C_BP_Group_ID, M_Product_ID, M_Product_Category_ID, Launchwr, Launchmr, Simulate, Recalculatestock, IsActive, Description, AD_Client_ID, MRP_Run_Production_ID, created, createdby, updated, updatedBy)" +
