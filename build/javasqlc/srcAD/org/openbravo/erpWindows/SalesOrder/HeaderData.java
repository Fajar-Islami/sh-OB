...
static Logger log4j = Logger.getLogger(HeaderData.class);
  ...
  public String cancelledorderId;
  public String cancelledorderIdr;
  public String replacedorderId;
  public String replacedorderIdr;
  public String replacementorderId;
  public String replacementorderIdr;
  ...
  public String cancelandreplace;
  public String confirmcancelandreplace;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return validuntil;
    else if (fieldName.equalsIgnoreCase("cancelledorder_id") || fieldName.equals("cancelledorderId"))
      return cancelledorderId;
    else if (fieldName.equalsIgnoreCase("cancelledorder_idr") || fieldName.equals("cancelledorderIdr"))
      return cancelledorderIdr;
    else if (fieldName.equalsIgnoreCase("replacedorder_id") || fieldName.equals("replacedorderId"))
      return replacedorderId;
    else if (fieldName.equalsIgnoreCase("replacedorder_idr") || fieldName.equals("replacedorderIdr"))
      return replacedorderIdr;
    else if (fieldName.equalsIgnoreCase("replacementorder_id") || fieldName.equals("replacementorderId"))
      return replacementorderId;
    else if (fieldName.equalsIgnoreCase("replacementorder_idr") || fieldName.equals("replacementorderIdr"))
      return replacementorderIdr;
    else if (fieldName.equalsIgnoreCase("iscancelled"))
      return iscancelled;
      ...
      return user2Id;
    else if (fieldName.equalsIgnoreCase("cancelandreplace"))
      return cancelandreplace;
    else if (fieldName.equalsIgnoreCase("confirmcancelandreplace"))
      return confirmcancelandreplace;
  ...
  public static HeaderData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectHeaderData.cancelledorderId = UtilSql.getValue(result, "cancelledorder_id");
        objectHeaderData.cancelledorderIdr = UtilSql.getValue(result, "cancelledorder_idr");
        objectHeaderData.replacedorderId = UtilSql.getValue(result, "replacedorder_id");
        objectHeaderData.replacedorderIdr = UtilSql.getValue(result, "replacedorder_idr");
        objectHeaderData.replacementorderId = UtilSql.getValue(result, "replacementorder_id");
        objectHeaderData.replacementorderIdr = UtilSql.getValue(result, "replacementorder_idr");
        objectHeaderData.iscancelled = UtilSql.getValue(result, "iscancelled");
        ...
        objectHeaderData.cancelandreplace = UtilSql.getValue(result, "cancelandreplace");
        objectHeaderData.confirmcancelandreplace = UtilSql.getValue(result, "confirmcancelandreplace");
...
Create a registry
 */
  public static HeaderData[] set(String cancelledorderId, String convertquotation, String validuntil, String aAssetId, String cOrderId, String adClientId, String adOrgId, String isactive, String createdby, String createdbyr, String updatedby, String updatedbyr, String documentno, String docstatus, String docaction, String docactionBtn, String cDoctypeId, String cDoctypetargetId, String description, String isdelivered, String isinvoiced, String isprinted, String dateordered, String datepromised, String dateacct, String salesrepId, String cPaymenttermId, String billtoId, String cCurrencyId, String invoicerule, String freightamt, String deliveryviarule, String mShipperId, String priorityrule, String totallines, String grandtotal, String mWarehouseId, String mPricelistId, String processing, String cCampaignId, String cBpartnerId, String cBpartnerIdr, String adUserId, String poreference, String cChargeId, String chargeamt, String processed, String cBpartnerLocationId, String cProjectId, String cProjectIdr, String cActivityId, String quotationId, String quotationIdr, String issotrx, String dateprinted, String deliveryrule, String freightcostrule, String paymentrule, String isdiscountprinted, String posted, String istaxincluded, String isselected, String confirmcancelandreplace, String cCostcenterId, String deliverynotes, String cIncotermsId, String incotermsdescription, String generatetemplate, String deliveryLocationId, String copyfrompo, String finPaymentmethodId, String dropshipUserId, String dropshipBpartnerId, String copyfrom, String dropshipLocationId, String isselfservice, String adOrgtrxId, String user2Id, String user1Id, String calculatePromotions, String cancelandreplace, String rmPickfromshipment, String rmReceivematerials, String rmCreateinvoice, String cReturnReasonId, String replacedorderId, String rmAddorphanline, String soResStatus, String cRejectReasonId, String replacementorderId, String iscancelled, String emAprmAddpayment)    throws ServletException {
    ...
    objectHeaderData[0].cancelledorderId = cancelledorderId;
    objectHeaderData[0].cancelledorderIdr = "";
    objectHeaderData[0].replacedorderId = replacedorderId;
    objectHeaderData[0].replacedorderIdr = "";
    objectHeaderData[0].replacementorderId = replacementorderId;
    objectHeaderData[0].replacementorderIdr = "";
    objectHeaderData[0].iscancelled = iscancelled;
    ...
    objectHeaderData[0].cancelandreplace = cancelandreplace;
    objectHeaderData[0].confirmcancelandreplace = confirmcancelandreplace;
...
Select for auxiliar field
 */
  public static String selectAux9FF4321DE0E5487B8A649A444F3F64BC(ConnectionProvider connectionProvider, String c_order_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cancelledorderId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, replacedorderId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, replacementorderId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, iscancelled);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cProjectId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cCostcenterId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, aAssetId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, user1Id);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, user2Id);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, cancelandreplace);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, confirmcancelandreplace);
