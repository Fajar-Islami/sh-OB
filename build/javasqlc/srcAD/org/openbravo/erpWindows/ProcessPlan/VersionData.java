 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET DocumentNo = (?) , DateFrom = TO_DATE(?) , DateTo = TO_DATE(?) , IsActive = (?) , Estimatedtime = TO_NUMBER(?) , MA_Processplan_Version_ID = (?) , MA_Processplan_ID = (?) , AD_Org_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE MA_ProcessPlan_Version.MA_Processplan_Version_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (DocumentNo, DateFrom, DateTo, IsActive, Estimatedtime, MA_Processplan_Version_ID, MA_Processplan_ID, AD_Org_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
