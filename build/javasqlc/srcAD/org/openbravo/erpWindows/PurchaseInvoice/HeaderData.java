 ...
 */
  public static String selectAux68CD2AFDCEAB45ADB0690B33067B7940(ConnectionProvider connectionProvider, String c_doctypetarget_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select coalesce(max(docbasetype), 'API') from c_doctype where c_doctype_id = ? ";
...
Select for auxiliar field
 */
  public static String selectAuxAF1F32AFD6794C6C9C3C2EC82DC2F92A(ConnectionProvider connectionProvider, String C_INVOICE_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
