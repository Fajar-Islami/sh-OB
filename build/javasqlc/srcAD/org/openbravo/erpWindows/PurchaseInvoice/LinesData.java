...
static Logger log4j = Logger.getLogger(LinesData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
      ...
      return bomParentId;
    else if (fieldName.equalsIgnoreCase("match_lccosts") || fieldName.equals("matchLccosts"))
      return matchLccosts;
  ...
  public static LinesData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String cInvoiceId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectLinesData.matchLccosts = UtilSql.getValue(result, "match_lccosts");
 ...
 */
  public static LinesData[] set(String cInvoiceId, String matchLccosts, String excludeforwithholding, String cBpartnerId, String cBpartnerIdr, String cPeriodId, String financialInvoiceLine, String defplantype, String aumqty, String cInvoicelineId, String adClientId, String adOrgId, String isactive, String created, String createdby, String createdbyr, String updatedby, String updatedbyr, String cOrderlineId, String cOrderlineIdr, String line, String description, String mProductId, String qtyinvoiced, String pricelist, String priceactual, String linenetamt, String cChargeId, String chargeamt, String cUomId, String cTaxId, String user1Id, String mInoutlineId, String mInoutlineIdr, String pricelimit, String grosspricelist, String periodnumber, String user2Id, String cAum, String sResourceassignmentId, String grossUnitPrice, String iseditlinenetamt, String taxbaseamt, String quantityorder, String mProductUomId, String cInvoiceDiscountId, String cProjectlineId, String mOfferId, String pricestd, String taxamt, String mAttributesetinstanceId, String mAttributesetinstanceIdr, String aAssetId, String grosspricestd, String isdescription, String isdeferred, String lineGrossAmount, String explode, String bomParentId, String cProjectId, String cProjectIdr, String cCostcenterId, String accountId)    throws ServletException {
    ...
    objectLinesData[0].matchLccosts = matchLccosts;
...
Select for auxiliar field
 */
  public static String selectAux162BEBF77E8D419ABDAD4E87A5C17430(ConnectionProvider connectionProvider, String M_PRODUCT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux494740D6BFAF41F5B3F8863473924301(ConnectionProvider connectionProvider, String M_Product_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux7545008A9CB045EAAF5B21BA319BF307(ConnectionProvider connectionProvider, String C_InvoiceLine_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux861880FCEE6846A1B6BF4E129EDAF3DD(ConnectionProvider connectionProvider, String c_invoice_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux9D4E828236844F559BA70E02BD07DED0(ConnectionProvider connectionProvider, String C_TAX_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAuxA30BE76CF53B4365A97DA2B13D23EB5D(ConnectionProvider connectionProvider, String M_PRICELIST_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAuxCDD35787A8094C5180971D4F8EB83DDC(ConnectionProvider connectionProvider, String M_PRODUCT_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAuxE0A2BB772E284F459DCE5CCE23A7149B(ConnectionProvider connectionProvider, String C_INVOICE_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "         SELECT AD_ORG_ID" +
      "FROM C_INVOICE" +
...
Select for auxiliar field
 */
  public static String selectAuxF9684776014A4118AE4EE0596CA2B2A2(ConnectionProvider connectionProvider, String M_Product_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAuxFDD08C93EDE54CD88C52DDFE14FCC157(ConnectionProvider connectionProvider, String C_INVOICE_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, matchLccosts);
