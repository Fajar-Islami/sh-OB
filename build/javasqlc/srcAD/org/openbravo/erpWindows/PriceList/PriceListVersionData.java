 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET Name = (?) , ValidFrom = TO_DATE(?) , M_DiscountSchema_ID = (?) , M_Pricelist_Version_Base_ID = (?) , Description = (?) , IsActive = (?) , ProcCreate = (?) , M_Pricelist_Version_Generate = (?) , AD_Client_ID = (?) , M_PriceList_Version_ID = (?) , M_PriceList_ID = (?) , AD_Org_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE M_PriceList_Version.M_PriceList_Version_ID = ? " +
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (Name, ValidFrom, M_DiscountSchema_ID, M_Pricelist_Version_Base_ID, Description, IsActive, ProcCreate, M_Pricelist_Version_Generate, AD_Client_ID, M_PriceList_Version_ID, M_PriceList_ID, AD_Org_ID, created, createdby, updated, updatedBy)" +
