 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET DocumentNo = (?) , C_Doctype_ID = (?) , Name = (?) , Isactive = (?) , Importdate = TO_DATE(?) , Statementdate = TO_DATE(?) , Filename = (?) , FIN_Reconciliation_ID = (?) , Notes = (?) , Posted = (?) , EM_APRM_Process_BS = (?) , EM_APRM_Process_BS_Force = (?) , FIN_Financial_Account_ID = (?) , FIN_Bankstatement_ID = (?) , Processed = (?) , Processing = (?) , AD_Org_ID = (?) , AD_Client_ID = (?) , updated = now(), updatedby = ? " +
      "        WHERE FIN_BankStatement.FIN_Bankstatement_ID = ? " +
      "                 AND FIN_BankStatement.FIN_Financial_Account_ID = ? " +
      "        AND FIN_BankStatement.AD_Client_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (DocumentNo, C_Doctype_ID, Name, Isactive, Importdate, Statementdate, Filename, FIN_Reconciliation_ID, Notes, Posted, EM_APRM_Process_BS, EM_APRM_Process_BS_Force, FIN_Financial_Account_ID, FIN_Bankstatement_ID, Processed, Processing, AD_Org_ID, AD_Client_ID, created, createdby, updated, updatedBy)" +
