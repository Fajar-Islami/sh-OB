...
static Logger log4j = Logger.getLogger(ReconciliationsFF8080813320657F0133209DE21B0042Data.class);
  ...
  public String emAprmProcessRecForce;
  public String emAprmProcessRecForceBtn;
  ...
  public String getField(String fieldName) {
    ...
    else if (fieldName.equalsIgnoreCase("em_aprm_process_rec_force") || fieldName.equals("emAprmProcessRecForce"))
      return emAprmProcessRecForce;
    else if (fieldName.equalsIgnoreCase("em_aprm_process_rec_force_btn") || fieldName.equals("emAprmProcessRecForceBtn"))
      return emAprmProcessRecForceBtn;
  ...
  public static ReconciliationsFF8080813320657F0133209DE21B0042Data[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String finFinancialAccountId, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectReconciliationsFF8080813320657F0133209DE21B0042Data.emAprmProcessRecForce = UtilSql.getValue(result, "em_aprm_process_rec_force");
        objectReconciliationsFF8080813320657F0133209DE21B0042Data.emAprmProcessRecForceBtn = UtilSql.getValue(result, "em_aprm_process_rec_force_btn");
...
Create a registry
 */
  public static ReconciliationsFF8080813320657F0133209DE21B0042Data[] set(String finFinancialAccountId, String emAprmProcessRecForce, String emAprmProcessRecForceBtn, String emAprmPrintdetailed, String finReconciliationId, String adClientId, String adOrgId, String createdby, String createdbyr, String updatedby, String updatedbyr, String isactive, String documentno, String cDoctypeId, String dateto, String statementdate, String endingbalance, String startingbalance, String docstatus, String processing, String processed, String posted, String postedBtn, String printdetailed, String printsummary, String emAprmPrintsummary, String emAprmProcessRec, String emAprmProcessRecBtn, String emAprmProcessReconciliation)    throws ServletException {
    ...
    objectReconciliationsFF8080813320657F0133209DE21B0042Data[0].emAprmProcessRecForce = emAprmProcessRecForce;
    objectReconciliationsFF8080813320657F0133209DE21B0042Data[0].emAprmProcessRecForceBtn = emAprmProcessRecForceBtn;
 ...
 */
  public static String selectAux1570DEA796EC4EE0A9AB562BC2E14C66(ConnectionProvider connectionProvider, String FIN_RECONCILIATION_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      QueryTimeOutUtil.getInstance().setQueryTimeOut(st, SessionInfo.getQueryProfile());
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, FIN_RECONCILIATION_ID);
...
Select for auxiliar field
 */
  public static String selectAux29B80A89DBA84293A75434979C655101(ConnectionProvider connectionProvider, String FIN_Financial_Account_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emAprmProcessRecForce);
