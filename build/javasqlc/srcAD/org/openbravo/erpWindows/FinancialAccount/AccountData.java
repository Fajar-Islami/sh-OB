...
static Logger log4j = Logger.getLogger(AccountData.class);
  ...
  public String emAprmAddmultiplepayments;
  ...
  public String emAprmAddtransactionpd;
  public String emAprmFindtransactionspd;
  public String emAprmFundsTrans;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("created"))
    ...
    else if (fieldName.equalsIgnoreCase("em_aprm_addmultiplepayments") || fieldName.equals("emAprmAddmultiplepayments"))
      return emAprmAddmultiplepayments;
      ...
      return accountno;
    else if (fieldName.equalsIgnoreCase("em_aprm_addtransactionpd") || fieldName.equals("emAprmAddtransactionpd"))
      return emAprmAddtransactionpd;
    else if (fieldName.equalsIgnoreCase("em_aprm_findtransactionspd") || fieldName.equals("emAprmFindtransactionspd"))
      return emAprmFindtransactionspd;
    else if (fieldName.equalsIgnoreCase("em_aprm_funds_trans") || fieldName.equals("emAprmFundsTrans"))
      return emAprmFundsTrans;
 ...
 */
  public static AccountData[] selectEdit(ConnectionProvider connectionProvider, String dateTimeFormat, String paramLanguage, String key, String adUserClient, String adOrgClient, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "FIN_Financial_Account.EM_Aprm_Funds_Trans, " +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectAccountData.emAprmAddmultiplepayments = UtilSql.getValue(result, "em_aprm_addmultiplepayments");
        ...
        objectAccountData.emAprmAddtransactionpd = UtilSql.getValue(result, "em_aprm_addtransactionpd");
        objectAccountData.emAprmFindtransactionspd = UtilSql.getValue(result, "em_aprm_findtransactionspd");
        objectAccountData.emAprmFundsTrans = UtilSql.getValue(result, "em_aprm_funds_trans");
 ...
 */
  public static AccountData[] set(String emAprmAddtransactionpd, String bankformat, String emAprmFindtransactionspd, String writeofflimit, String typewriteoff, String initialbalance, String cCountryId, String finFinancialAccountId, String adClientId, String adOrgId, String createdby, String createdbyr, String updatedby, String updatedbyr, String isactive, String cCurrencyId, String name, String description, String type, String cBpartnerId, String cLocationId, String cLocationIdr, String routingno, String swiftcode, String codebank, String codebranch, String bankDigitcontrol, String ineNumber, String accountDigitcontrol, String codeaccount, String accountno, String currentbalance, String creditlimit, String iban, String isdefault, String emAprmMatchtransForce, String genericaccountno, String emAprmImportbankfile, String emAprmMatchtransactions, String emAprmReconcile, String emAprmAddtransactions, String emAprmFundsTrans, String emAprmAddmultiplepayments, String finMatchingAlgorithmId)    throws ServletException {
    ...
    objectAccountData[0].emAprmAddmultiplepayments = emAprmAddmultiplepayments;
    ...
    objectAccountData[0].emAprmAddtransactionpd = emAprmAddtransactionpd;
    objectAccountData[0].emAprmFindtransactionspd = emAprmFindtransactionspd;
    objectAccountData[0].emAprmFundsTrans = emAprmFundsTrans;
 ...
 */
  public static String selectAux0389829094184BC4A99B307868F278EE(ConnectionProvider connectionProvider, String ad_org_id, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux07608CACCACF4A398D8FB4869CE70571(ConnectionProvider connectionProvider, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
...
Select for auxiliar field
 */
  public static String selectAux1022B3987A6B481C85968D79658DA6C6(ConnectionProvider connectionProvider, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select COALESCE((select show_in_header " +
      "			from AD_Client_AcctDimension " +
...
Select for auxiliar field
 */
  public static String selectAux1453726EFC4B4E2898296BB44A7172ED(ConnectionProvider connectionProvider, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select COALESCE((select show_in_header " +
      "			from AD_Client_AcctDimension " +
...
Select for auxiliar field
 */
  public static String selectAux154056E8BD07443E9760F8C76FA9533F(ConnectionProvider connectionProvider, String ad_org_id, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select case when query.elementtype is not null then 'Y' else 'N' end from" +
      "(select elementtype, min(ad_isorgincluded (?, ad_org_id ,ad_client_id)) as orglevel" +
...
Select for auxiliar field
 */
  public static String selectAux311BE34CB1684926877B28AFE1939C26(ConnectionProvider connectionProvider, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select COALESCE((select show_in_header " +
      "			from AD_Client_AcctDimension " +
...
Select for auxiliar field
 */
  public static String selectAux4A555D695EE84BD08225721AF0DB4660(ConnectionProvider connectionProvider, String ad_org_id, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select case when query.elementtype is not null then 'Y' else 'N' end from" +
      "(select elementtype, min(ad_isorgincluded (?, ad_org_id ,ad_client_id)) as orglevel" +
...
Select for auxiliar field
 */
  public static String selectAux58585C6A8EFE4E0EBD3DFF8746206EAF(ConnectionProvider connectionProvider, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select COALESCE((select show_in_header " +
      "			from AD_Client_AcctDimension " +
...
Select for auxiliar field
 */
  public static String selectAux5AA02067B7A046B39F6C1D0D5072CC9F(ConnectionProvider connectionProvider, String ad_org_id, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select case when query.elementtype is not null then 'Y' else 'N' end from" +
      "(select elementtype, min(ad_isorgincluded (?, ad_org_id ,ad_client_id)) as orglevel" +
...
Select for auxiliar field
 */
  public static String selectAux5BB2952CE3234414A146E35032539257(ConnectionProvider connectionProvider, String ad_org_id, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select case when query.elementtype is not null then 'Y' else 'N' end from" +
      "(select elementtype, min(ad_isorgincluded (?, ad_org_id ,ad_client_id)) as orglevel" +
...
Select for auxiliar field
 */
  public static String selectAux5BF658979C8C4F29949B1542FD065423(ConnectionProvider connectionProvider, String ad_org_id, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select case when query.elementtype is not null then 'Y' else 'N' end from" +
      "(select elementtype, min(ad_isorgincluded (?, ad_org_id ,ad_client_id)) as orglevel" +
...
Select for auxiliar field
 */
  public static String selectAux7B711DEB519143C4A8C97E6C05300E07(ConnectionProvider connectionProvider, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select COALESCE((select show_in_header " +
      "			from AD_Client_AcctDimension " +
...
Select for auxiliar field
 */
  public static String selectAux7B7890725A7C4C06BBD98CBBFB325D39(ConnectionProvider connectionProvider, String ad_org_id, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select case when query.elementtype is not null then 'Y' else 'N' end from" +
      "(select elementtype, min(ad_isorgincluded (?, ad_org_id ,ad_client_id)) as orglevel" +
...
Select for auxiliar field
 */
  public static String selectAuxAA110F79CC9C4DD8B51EBBB234E3AD1B(ConnectionProvider connectionProvider, String ad_org_id, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select case when query.elementtype is not null then 'Y' else 'N' end from" +
      "(select elementtype, min(ad_isorgincluded (?, ad_org_id ,ad_client_id)) as orglevel" +
...
Select for auxiliar field
 */
  public static String selectAuxD453894F70014B078F7DE07DFD7A112F(ConnectionProvider connectionProvider, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select COALESCE((select show_in_header " +
      "			from AD_Client_AcctDimension " +
...
Select for auxiliar field
 */
  public static String selectAuxDA4CDAF77BAF42118049D8DA9A6FF05B(ConnectionProvider connectionProvider, String AD_Client_ID)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      result = st.executeQuery();
      if(result.next()) {
        strReturn = UtilSql.getValue(result, "acctdim_centrally_maintained");
      }
      result.close();
    } catch(SQLException e){
      log4j.error("SQL error in query: " + strSql + "Exception:"+ e);
...
Select for auxiliar field
 */
  public static String selectAuxE396BAA4096A4AA0ABA0CEC0A52BF983(ConnectionProvider connectionProvider, String ad_org_id, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select case when query.elementtype is not null then 'Y' else 'N' end from" +
      "(select elementtype, min(ad_isorgincluded (?, ad_org_id ,ad_client_id)) as orglevel" +
...
Select for auxiliar field
 */
  public static String selectAuxEBFF532722F5438BAACA625CE5E69A41(ConnectionProvider connectionProvider, String ad_org_id, String ad_client_id)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select case when query.elementtype is not null then 'Y' else 'N' end from" +
      "(select elementtype, min(ad_isorgincluded (?, ad_org_id ,ad_client_id)) as orglevel" +
 ...
 */
  ...
  public int update(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        SET AD_Org_ID = (?) , Name = (?) , C_Currency_ID = (?) , Type = (?) , Description = (?) , C_Location_ID = (?) , C_Bpartner_ID = (?) , Isactive = (?) , Isdefault = (?) , Currentbalance = TO_NUMBER(?) , Creditlimit = TO_NUMBER(?) , InitialBalance = TO_NUMBER(?) , FIN_Matching_Algorithm_ID = (?) , GenericAccountNo = (?) , Iban = (?) , Swiftcode = (?) , INE_Number = (?) , C_Country_ID = (?) , BankFormat = (?) , Typewriteoff = (?) , Writeofflimit = TO_NUMBER(?) , EM_APRM_ImportBankFile = (?) , EM_APRM_MatchTransactions = (?) , EM_APRM_MatchTrans_Force = (?) , EM_APRM_Reconcile = (?) , EM_APRM_AddTransactions = (?) , EM_Aprm_AddMultiplePayments = (?) , Codebank = (?) , Codebranch = (?) , Bank_Digitcontrol = (?) , Account_Digitcontrol = (?) , Codeaccount = (?) , Accountno = (?) , EM_Aprm_Addtransactionpd = (?) , EM_Aprm_Findtransactionspd = (?) , EM_Aprm_Funds_Trans = (?) , AD_Client_ID = (?) , Fin_Financial_Account_ID = (?) , Routingno = (?) , updated = now(), updatedby = ? " +
    ...
    st = connectionProvider.getPreparedStatement(conn, strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emAprmAddmultiplepayments);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emAprmAddtransactionpd);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emAprmFindtransactionspd);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, emAprmFundsTrans);
  ...
  public int insert(Connection conn, ConnectionProvider connectionProvider)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "        (AD_Org_ID, Name, C_Currency_ID, Type, Description, C_Location_ID, C_Bpartner_ID, Isactive, Isdefault, Currentbalance, Creditlimit, InitialBalance, FIN_Matching_Algorithm_ID, GenericAccountNo, Iban, Swiftcode, INE_Number, C_Country_ID, BankFormat, Typewriteoff, Writeofflimit, EM_APRM_ImportBankFile, EM_APRM_MatchTransactions, EM_APRM_MatchTrans_Force, EM_APRM_Reconcile, EM_APRM_AddTransactions, EM_Aprm_AddMultiplePayments, Codebank, Codebranch, Bank_Digitcontrol, Account_Digitcontrol, Codeaccount, Accountno, EM_Aprm_Addtransactionpd, EM_Aprm_Findtransactionspd, EM_Aprm_Funds_Trans, Fin_Financial_Account_ID, Routingno, AD_Client_ID, created, createdby, updated, updatedBy)" +
