  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("800134")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("800134");
        SessionInfo.setModuleId("0");
        if (securedProcess || explicitAccess.contains("800134")) {
          classInfo.type = "P";
          classInfo.id = "800134";
        }
      }
...
vars.getRequestGlobalVariable("inpParamEndDate_f", tabId + "|paramEndDate_f");
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = HeaderData.delete(this, strA_Amortization_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
  ...
  private HeaderData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      HeaderData[] data = HeaderData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getStringParameter("inpaAmortizationId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamEndDate_f = vars.getSessionValue(tabId + "|paramEndDate_f");
    ...
    hasSearchCondition = (tableSQL.hasInternalFilter() && ("").equals(strParamAD_Org_ID) && ("").equals(strParamName) && ("").equals(strParamDateAcct) && ("").equals(strParamStartDate) && ("").equals(strParamEndDate) && ("").equals(strParamDateAcct_f) && ("").equals(strParamStartDate_f) && ("").equals(strParamEndDate_f)) || !(("").equals(strParamAD_Org_ID) || ("%").equals(strParamAD_Org_ID))  || !(("").equals(strParamName) || ("%").equals(strParamName))  || !(("").equals(strParamDateAcct) || ("%").equals(strParamDateAcct))  || !(("").equals(strParamStartDate) || ("%").equals(strParamStartDate))  || !(("").equals(strParamEndDate) || ("%").equals(strParamEndDate))  || !(("").equals(strParamDateAcct_f) || ("%").equals(strParamDateAcct_f))  || !(("").equals(strParamStartDate_f) || ("%").equals(strParamStartDate_f))  || !(("").equals(strParamEndDate_f) || ("%").equals(strParamEndDate_f)) ;
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Amortization/Header_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header", false, "document.frmMain.inpaAmortizationId", "grid", "..", "".equals("Y"), "Amortization", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "Amortization", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _A_Amortization_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strA_Amortization_ID = _A_Amortization_ID;
...
String strParamEndDate_f = vars.getSessionValue(tabId + "|paramEndDate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = HeaderData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strA_Amortization_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set("", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800026", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800026", "", dataField), "Y", Utility.getDefault(this, vars, "Createdby", "", "800026", "", dataField), HeaderData.selectDef801074_0(this, Utility.getDefault(this, vars, "Createdby", "", "800026", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "800026", "", dataField), HeaderData.selectDef801076_1(this, Utility.getDefault(this, vars, "Updatedby", "", "800026", "", dataField)), Utility.getDefault(this, vars, "Name", "", "800026", "", dataField), Utility.getDefault(this, vars, "Description", "", "800026", "", dataField), Utility.getDefault(this, vars, "DateAcct", "", "800026", "", dataField), Utility.getDefault(this, vars, "StartDate", "", "800026", "", dataField), Utility.getDefault(this, vars, "EndDate", "", "800026", "", dataField), Utility.getDefault(this, vars, "Processing", "", "800026", "N", dataField), Utility.getDefault(this, vars, "Processed", "N", "800026", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "800024", Utility.getDefault(this, vars, "Processed", "N", "800026", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "800024", Utility.getDefault(this, vars, "Processed", "N", "800026", "N", dataField))), Utility.getDefault(this, vars, "Posted", "N", "800026", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "N", "800026", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "N", "800026", "N", dataField))), Utility.getDefault(this, vars, "C_Project_ID", "", "800026", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "800026", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "800026", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "800026", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "800026", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "800026", "", dataField), Utility.getDefault(this, vars, "Totalamortization", "", "800026", "", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Amortization/Header_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Amortization/Header_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpaAmortizationId", "", "..", "".equals("Y"), "Amortization", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strA_Amortization_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
      ...
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      // if (!strA_Amortization_ID.equals("")) xmlDocument.setParameter("childTabContainer", tabs.childTabs(false));
	  // else xmlDocument.setParameter("childTabContainer", tabs.childTabs(true));
	  xmlDocument.setParameter("childTabContainer", tabs.childTabs(false));
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "Amortization", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Header_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("buttonTotalamortization", Utility.messageBD(this, "Calc", vars.getLanguage()));
...
comboTableData = null;
xmlDocument.setParameter("Processed_BTNname", Utility.getButtonName(this, vars, "800024", (dataField==null?data[0].getField("processed"):dataField.getField("processed")), "Processed_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalProcessed = org.openbravo.erpCommon.utility.Utility.isModalProcess("800134"); 
...
xmlDocument.setParameter("EndDate_Format", vars.getSessionValue("#AD_SqlDateFormat"));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private void printPageButtonProcessed800134(HttpServletResponse response, VariablesSecureApp vars, String strA_Amortization_ID, String strprocessed, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 800134");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/Processed800134", discard).createXmlDocument();
      xmlDocument.setParameter("key", strA_Amortization_ID);
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "800134");
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (HeaderData.getCurrentDBTimestamp(this, data.aAmortizationId).equals(
