...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _A_Asset_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strA_Asset_ID = _A_Asset_ID;
...
String strParamAmortizationcalctype = vars.getSessionValue(tabId + "|paramAmortizationcalctype");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("aAssetId") == null || dataField.getField("aAssetId").equals("")) {
        ...
        String strATTRIBUTESET = AssetsData.selectAux0C9EAE5805B14C159CE74DAF015A12C9(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|ATTRIBUTESET", strATTRIBUTESET);
        String strATTRSETVALUETYPE = AssetsData.selectAux42236E76CCB2491B8B2E5BCDA4E83624(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|ATTRSETVALUETYPE", strATTRSETVALUETYPE);
        String strexistAmortizationLines = AssetsData.selectAuxAD306651FEC841DF9D01E831482C6A09(this, ((dataField!=null)?dataField.getField("aAssetId"):((data==null || data.length==0)?"":data[0].getField("aAssetId"))));
