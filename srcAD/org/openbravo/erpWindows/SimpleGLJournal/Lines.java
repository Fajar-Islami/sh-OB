...
public class Lines extends HttpSecureAppServlet {
  ...
  private static final String tabId = "7797C73348324DCBB7F17666F31C87A5";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      vars.setSessionValue(windowId + "|GL_Journal_ID", strPGL_Journal_ID);
      vars.setSessionValue("5A6F0ED7230C462BA4010653BA3F816A|Header.view", "EDIT");
...
vars.getGlobalVariable("inpglJournalId", windowId + "|GL_Journal_ID");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPGL_Journal_ID) throws IOException,ServletException {
      ...
      HeaderData[] data = HeaderData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPGL_Journal_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|C_AcctSchema_ID", data[0].cAcctschemaId);    vars.setSessionValue(windowId + "|C_DocType_ID", data[0].cDoctypeId);    vars.setSessionValue(windowId + "|DateDoc", data[0].datedoc);    vars.setSessionValue(windowId + "|DateAcct", data[0].dateacct);    vars.setSessionValue(windowId + "|C_Period_ID", data[0].cPeriodId);    vars.setSessionValue(windowId + "|C_Currency_ID", data[0].cCurrencyId);    vars.setSessionValue(windowId + "|CurrencyRateType", data[0].currencyratetype);    vars.setSessionValue(windowId + "|CurrencyRate", data[0].currencyrate);    vars.setSessionValue(windowId + "|Multi_Gl", data[0].multiGl);    vars.setSessionValue(windowId + "|Posted", data[0].posted);    vars.setSessionValue(windowId + "|GL_Category_ID", data[0].glCategoryId);    vars.setSessionValue(windowId + "|Processed", data[0].processed);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|GL_Journal_ID", data[0].glJournalId);    vars.setSessionValue(windowId + "|GL_JournalBatch_ID", data[0].glJournalbatchId);
      vars.setSessionValue(windowId + "|GL_Journal_ID", strPGL_Journal_ID); //to ensure key parent is set for EM_* cols

      FieldProvider dataField = null; // Define this so that auxiliar inputs using SQL will work
      
      vars.setSessionValue(windowId + "|HeaderDateDoc", DateTimeData.today(this));
      
      vars.setSessionValue(windowId + "|Journal_Org", ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId"))));
      
      vars.setSessionValue(windowId + "|generalLedgerCurrency", HeaderData.selectAux64361E0DD8C74E448A0C3C3F1987B8C1(this, Utility.getContext(this, vars, "c_acctschema_id", "B917E8A7B0864ACEA9D941E3B7494E53")));
      
      vars.setSessionValue(windowId + "|HeaderDateAcct", DateTimeData.today(this));
      
      vars.setSessionValue(windowId + "|Parent_AD_Org", Utility.getContext(this, vars, "#AD_Org_ID", windowId));
...
String strParamLine_f = vars.getSessionValue(tabId + "|paramLine_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/SimpleGLJournal/Lines_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Lines", false, "document.frmMain.inpglJournallineId", "grid", "..", "".equals("Y"), "SimpleGLJournal", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
    ...
    xmlDocument.setParameter("parentFieldName", Utility.getFieldName("7014E7A3C8734A4A9B7FE869D155DEDC", vars.getLanguage()));
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines_Relation.html", "SimpleGLJournal", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _GL_JournalLine_ID, String strPGL_Journal_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strGL_JournalLine_ID = _GL_JournalLine_ID;
...
String strParamLine_f = vars.getSessionValue(tabId + "|paramLine_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("glJournallineId") == null || dataField.getField("glJournallineId").equals("")) {
        ...
        String strDESCRIPTION1 = LinesData.selectAux4903D39504D74135B86501E36BEB8EC1(this, strPGL_Journal_ID);
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPGL_Journal_ID, "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), LinesData.selectDef1664_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), LinesData.selectDef1666_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField)), LinesData.selectDef1675(this, strPGL_Journal_ID), Utility.getDefault(this, vars, "Description", "@DESCRIPTION1@", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "AmtSourceDr", "", "B917E8A7B0864ACEA9D941E3B7494E53", "0", dataField), Utility.getDefault(this, vars, "AmtSourceCr", "", "B917E8A7B0864ACEA9D941E3B7494E53", "0", dataField), Utility.getDefault(this, vars, "AmtAcctDr", "", "B917E8A7B0864ACEA9D941E3B7494E53", "0", dataField), Utility.getDefault(this, vars, "AmtAcctCr", "", "B917E8A7B0864ACEA9D941E3B7494E53", "0", dataField), Utility.getDefault(this, vars, "IsGenerated", "", "B917E8A7B0864ACEA9D941E3B7494E53", "N", dataField), Utility.getDefault(this, vars, "C_Withholding_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "C_Tax_ID", "\" \"", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "CurrencyRate", "1", "B917E8A7B0864ACEA9D941E3B7494E53", "0", dataField), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "CurrencyRateType", "S", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "DateAcct", "@DateAcct@", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "C_UOM_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "Qty", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "C_Debt_Payment_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "C_ValidCombination_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "Open_Items", "N", "B917E8A7B0864ACEA9D941E3B7494E53", "N", dataField), Utility.getDefault(this, vars, "C_Glitem_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), LinesData.selectDefA7E134B04D5ED632E040007F010037B3_2(this, Utility.getDefault(this, vars, "C_Project_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField)), Utility.getDefault(this, vars, "C_Activity_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "C_Salesregion_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), LinesData.selectDefA7F1531510454244E040007F010064A6_3(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField)), Utility.getDefault(this, vars, "FIN_Payment_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "Paymentdate", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "EM_Aprm_Addpayment", "Y", "B917E8A7B0864ACEA9D941E3B7494E53", "N", dataField), Utility.getDefault(this, vars, "Account_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "FIN_Financial_Account_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField), Utility.getDefault(this, vars, "FIN_Paymentmethod_ID", "", "B917E8A7B0864ACEA9D941E3B7494E53", "", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/SimpleGLJournal/Lines_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/SimpleGLJournal/Lines_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Lines", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpglJournallineId", "", "..", "".equals("Y"), "SimpleGLJournal", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strGL_JournalLine_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines_Relation.html", "SimpleGLJournal", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Lines_Relation.html", strReplaceWith);
...
comboTableData = new ComboTableData(vars, this, "19", "AD_Org_ID", "", "99659ACE4B8F404589A69F3FF1E8959B", userOrgList, Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("adOrgId"):dataField.getField("adOrgId")));
xmlDocument.setData("reportAD_Org_ID","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "18", "Account_ID", "2F57E5B5EBF44E0A9D45492DECBD3CC1", "147E6690EF6C42C7A937B0EE98516761", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
...
comboTableData = new ComboTableData(vars, this, "19", "FIN_Financial_Account_ID", "", "D244F181F37C4CC69DEACA12CA8F0DD4", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
...
xmlDocument.setParameter("DateAcct_Format", vars.getSessionValue("#AD_SqlDateFormat"));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private String getReadOnlyLogicContext(VariablesSecureApp vars) throws IOException, ServletException {
      ...
      String result = "var strProcessed=\"" + Utility.getContext(this, vars, "Processed", windowId) + "\";\nvar strMulti_Gl=\"" + Utility.getContext(this, vars, "Multi_Gl", windowId) + "\";\nvar strPosted=\"" + Utility.getContext(this, vars, "Posted", windowId) + "\";\n";
      return result;
    }
