...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "10", "action", straction, vars.getClient(), vars.getOrg(), vars.getUser());
  ...
  private HeaderData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      HeaderData[] data = HeaderData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getStringParameter("inpmInternalConsumptionId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strM_Internal_Consumption_ID, TableSQLData tableSQL)
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/InternalConsumption/Header_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header", false, "document.frmMain.inpmInternalConsumptionId", "grid", "..", "".equals("Y"), "InternalConsumption", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "InternalConsumption", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _M_Internal_Consumption_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strM_Internal_Consumption_ID = _M_Internal_Consumption_ID;
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = HeaderData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strM_Internal_Consumption_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "C_Costcenter_ID", "", "800076", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "800076", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "800076", "", dataField), HeaderData.selectDef3C32DB97D29C46678D24E0A0706B35B8_0(this, Utility.getDefault(this, vars, "C_Project_ID", "", "800076", "", dataField)), Utility.getDefault(this, vars, "User2_ID", "", "800076", "", dataField), Utility.getDefault(this, vars, "AD_Orgtrx_ID", "", "800076", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "800076", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800076", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800076", "", dataField), "Y", Utility.getDefault(this, vars, "Createdby", "", "800076", "", dataField), HeaderData.selectDef802753_1(this, Utility.getDefault(this, vars, "Createdby", "", "800076", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "800076", "", dataField), HeaderData.selectDef802755_2(this, Utility.getDefault(this, vars, "Updatedby", "", "800076", "", dataField)), Utility.getDefault(this, vars, "Name", "", "800076", "", dataField), Utility.getDefault(this, vars, "Description", "", "800076", "", dataField), Utility.getDefault(this, vars, "MovementDate", "", "800076", "", dataField), Utility.getDefault(this, vars, "Posted", "N", "800076", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "N", "800076", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "N", "800076", "N", dataField))), Utility.getDefault(this, vars, "Processed", "N", "800076", "N", dataField), Utility.getDefault(this, vars, "Processing", "", "800076", "N", dataField), Utility.getDefault(this, vars, "Status", "DR", "800076", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "800076", "", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/InternalConsumption/Header_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/InternalConsumption/Header_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmInternalConsumptionId", "", "..", "".equals("Y"), "InternalConsumption", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_Internal_Consumption_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
      ...
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      // if (!strM_Internal_Consumption_ID.equals("")) xmlDocument.setParameter("childTabContainer", tabs.childTabs(false));
	  // else xmlDocument.setParameter("childTabContainer", tabs.childTabs(true));
	  xmlDocument.setParameter("childTabContainer", tabs.childTabs(false));
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "InternalConsumption", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Header_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("Processing_BTNname", Utility.getButtonName(this, vars, "803071", "Processing_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalProcessing = org.openbravo.erpCommon.utility.Utility.isModalProcess("800131"); 
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (HeaderData.getCurrentDBTimestamp(this, data.mInternalConsumptionId).equals(
