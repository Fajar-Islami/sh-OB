...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _M_ProductionPlan_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strM_ProductionPlan_ID = _M_ProductionPlan_ID;
...
String strParamLine_f = vars.getSessionValue(tabId + "|paramLine_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("mProductionplanId") == null || dataField.getField("mProductionplanId").equals("")) {
        ...
        String strAD_Org_Forced = ProductionRunData.selectAuxFF808181323F83E801323F959F07002C(this, ((dataField!=null)?dataField.getField("mProductionId"):((data==null || data.length==0)?"":data[0].getField("mProductionId"))));
    vars.setSessionValue(windowId + "|AD_Org_Forced", strAD_Org_Forced);
        String strWorkEffortValidated = ProductionRunData.selectAuxFF80818132916D6E013291C49E7E00E6(this, ((dataField!=null)?dataField.getField("mProductionId"):((data==null || data.length==0)?"":data[0].getField("mProductionId"))));
...
comboTableData = null;
xmlDocument.setParameter("Starttime_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Starttime_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
xmlDocument.setParameter("Endtime_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Endtime_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
...
xmlDocument.setParameter("buttonRejectedquantity", Utility.messageBD(this, "Calc", vars.getLanguage()));
