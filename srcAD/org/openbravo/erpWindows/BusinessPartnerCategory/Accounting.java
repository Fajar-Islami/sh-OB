  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("112")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("112");
        SessionInfo.setModuleId("0");
        if (securedProcess || explicitAccess.contains("112")) {
          classInfo.type = "P";
          classInfo.id = "112";
        }
      }
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "20", "C_AcctSchema_ID", strcAcctschemaId, vars.getClient(), vars.getOrg(), vars.getUser());
      ...
      try {
        int total = saveRecord(vars, myError, saveType, strPC_BP_Group_ID);
        if (myError.isEmpty()) {
          myError = Utility.translateError(this, vars, vars.getLanguage(), "@CODE=RowsUpdated");
          myError.setMessage(total + " " + myError.getMessage());
  ...
  private AccountingData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_BP_Group_ID) throws IOException,ServletException {
    ...
    try {
    data.cAcctschemaId = vars.getRequiredStringParameter("inpcAcctschemaId");     data.cAcctschemaIdr = vars.getStringParameter("inpcAcctschemaId_R");     data.cReceivableAcct = vars.getRequiredStringParameter("inpcReceivableAcct");     data.cPrepaymentAcct = vars.getStringParameter("inpcPrepaymentAcct");     data.writeoffAcct = vars.getRequiredStringParameter("inpwriteoffAcct");     data.writeoffRevAcct = vars.getStringParameter("inpwriteoffRevAcct");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.vLiabilityAcct = vars.getRequiredStringParameter("inpvLiabilityAcct");     data.vPrepaymentAcct = vars.getStringParameter("inpvPrepaymentAcct");     data.notinvoicedreceiptsAcct = vars.getStringParameter("inpnotinvoicedreceiptsAcct");     data.processing = vars.getStringParameter("inpprocessing");     data.status = vars.getStringParameter("inpstatus");     data.notinvoicedreceivablesAcct = vars.getStringParameter("inpnotinvoicedreceivablesAcct");     data.notinvoicedrevenueAcct = vars.getStringParameter("inpnotinvoicedrevenueAcct");     data.paydiscountExpAcct = vars.getStringParameter("inppaydiscountExpAcct");     data.paydiscountRevAcct = vars.getStringParameter("inppaydiscountRevAcct");     data.realizedgainAcct = vars.getStringParameter("inprealizedgainAcct");     data.realizedlossAcct = vars.getStringParameter("inprealizedlossAcct");     data.unearnedrevenueAcct = vars.getStringParameter("inpunearnedrevenueAcct");     data.unrealizedgainAcct = vars.getStringParameter("inpunrealizedgainAcct");     data.unrealizedlossAcct = vars.getStringParameter("inpunrealizedlossAcct");     data.vLiabilityServicesAcct = vars.getStringParameter("inpvLiabilityServicesAcct");     data.doubtfuldebtAcct = vars.getStringParameter("inpdoubtfuldebtAcct");     data.baddebtexpenseAcct = vars.getStringParameter("inpbaddebtexpenseAcct");     data.baddebtrevenueAcct = vars.getStringParameter("inpbaddebtrevenueAcct");     data.allowancefordoubtfulAcct = vars.getStringParameter("inpallowancefordoubtfulAcct");     data.cBpGroupAcctId = vars.getRequestGlobalVariable("inpcBpGroupAcctId", windowId + "|C_Bp_Group_Acct_ID");     data.cBpGroupId = vars.getRequiredGlobalVariable("inpcBpGroupId", windowId + "|C_BP_Group_ID");     data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID"); 
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPC_BP_Group_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|C_BP_Group_ID", data[0].cBpGroupId);    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);
  ...
  private String getParentID(VariablesSecureApp vars, String strC_Bp_Group_Acct_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|C_Bp_Group_Acct_ID", data[0].getField("cBpGroupAcctId"));    vars.setSessionValue(windowId + "|C_BP_Group_ID", data[0].getField("cBpGroupId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPC_BP_Group_ID, String strC_Bp_Group_Acct_ID, TableSQLData tableSQL)
    ...
    hasSearchCondition = (tableSQL.hasInternalFilter() && ("").equals(strParamC_BP_Group_ID)) || !(("").equals(strParamC_BP_Group_ID) || ("%").equals(strParamC_BP_Group_ID)) ;
    ...
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Accounting", false, "document.frmMain.inpcBpGroupAcctId", "grid", "..", "".equals("Y"), "BusinessPartnerCategory", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
    ...
    xmlDocument.setParameter("parentFieldName", Utility.getFieldName("3914", vars.getLanguage()));
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Accounting_Relation.html", "BusinessPartnerCategory", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _C_Bp_Group_Acct_ID, String strPC_BP_Group_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strC_Bp_Group_Acct_ID = _C_Bp_Group_Acct_ID;
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = AccountingData.set(strPC_BP_Group_ID, Utility.getDefault(this, vars, "BadDebtExpense_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "Baddebtrevenue_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "C_AcctSchema_ID", "", "192", "", dataField), Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "192", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "192", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "192", "", dataField), AccountingData.selectDef4979_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "192", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "192", "", dataField), AccountingData.selectDef4981_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "192", "", dataField)), Utility.getDefault(this, vars, "C_Receivable_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "C_Prepayment_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "V_Liability_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "V_Liability_Services_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "V_Prepayment_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "PayDiscount_Exp_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "PayDiscount_Rev_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "WriteOff_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "UnrealizedGain_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "UnrealizedLoss_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "RealizedGain_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "RealizedLoss_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "NotInvoicedReceipts_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "UnEarnedRevenue_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "NotInvoicedRevenue_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "NotInvoicedReceivables_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "Doubtfuldebt_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "Processing", "", "192", "N", dataField), Utility.getDefault(this, vars, "AllowanceForDoubtful_Acct", "", "192", "", dataField), Utility.getDefault(this, vars, "Status", "", "192", "", dataField), "", Utility.getDefault(this, vars, "Writeoff_Rev_Acct", "", "192", "", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/BusinessPartnerCategory/Accounting_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/BusinessPartnerCategory/Accounting_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Accounting", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcBpGroupAcctId", "", "..", "".equals("Y"), "BusinessPartnerCategory", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Bp_Group_Acct_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
      ...
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      // if (!strC_Bp_Group_Acct_ID.equals("")) xmlDocument.setParameter("childTabContainer", tabs.childTabs(false));
	  // else xmlDocument.setParameter("childTabContainer", tabs.childTabs(true));
	  xmlDocument.setParameter("childTabContainer", tabs.childTabs(false));
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Accounting_Relation.html", "BusinessPartnerCategory", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Accounting_Relation.html", strReplaceWith);
...
comboTableData = null;
xmlDocument.setParameter("Processing_BTNname", Utility.getButtonName(this, vars, "3924", "Processing_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalProcessing = org.openbravo.erpCommon.utility.Utility.isModalProcess("112"); 
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private void printPageButtonProcessing112(HttpServletResponse response, VariablesSecureApp vars, String strC_Bp_Group_Acct_ID, String strprocessing, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 112");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/Processing112", discard).createXmlDocument();
      xmlDocument.setParameter("key", strC_Bp_Group_Acct_ID);
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "112");
      ...
      
      {
        ...
        if (myMessage!=null) {
          ...
          try {
    ComboTableData comboTableData = null;
    xmlDocument.setParameter("C_BP_Group_ID", Utility.getContext(this, vars, "C_BP_Group_ID", "192"));
    comboTableData = new ComboTableData(vars, this, "19", "C_BP_Group_ID", "", "", Utility.getContext(this, vars, "#AccessibleOrgTree", ""), Utility.getContext(this, vars, "#User_Client", ""), 0);
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("button112.originalParams"), comboTableData, windowId, Utility.getContext(this, vars, "C_BP_Group_ID", "192"));
    xmlDocument.setData("reportC_BP_Group_ID", "liststructure", comboTableData.select(false));
comboTableData = null;
    xmlDocument.setParameter("C_AcctSchema_ID", Utility.getContext(this, vars, "C_AcctSchema_ID", "192"));
    ...
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("button112.originalParams"), comboTableData, windowId, Utility.getContext(this, vars, "C_AcctSchema_ID", "192"));
