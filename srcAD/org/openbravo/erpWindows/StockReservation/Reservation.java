...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _M_Reservation_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strM_Reservation_ID = _M_Reservation_ID;
...
String strParamQuantity_f = vars.getSessionValue(tabId + "|paramQuantity_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("mReservationId") == null || dataField.getField("mReservationId").equals("")) {
        ...
        String strisQuantityVariable = ReservationData.selectAux51A01FEBD73F45189B342865ACE44FAC(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
...
comboTableData = null;
xmlDocument.setParameter("Reservedgoodmnt_Pe_BTNname", Utility.getButtonName(this, vars, "B9FD6ABD7AE746CA976CB8B73E046D62", "Reservedgoodmnt_Pe_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalReservedgoodmnt_Pe = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("Reservedgoodmnt_Pe_Modal", modalReservedgoodmnt_Pe?"true":"false");
xmlDocument.setParameter("Managereservation_Pe_BTNname", Utility.getButtonName(this, vars, "244ECD2DC27B4939BF9B89F44732E3DE", "Managereservation_Pe_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalManagereservation_Pe = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
