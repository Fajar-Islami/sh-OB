...
vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPC_Order_ID) throws IOException,ServletException {
      ...
      vars.setSessionValue(windowId + "|APRM_OrderIsPaid", HeaderData.selectAux874CCFB2FE7B40D79D2B0AE27951853F(this, strPC_Order_ID));
...
String strParamLineNetAmt_f = vars.getSessionValue(tabId + "|paramLineNetAmt_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("cOrderlineId") == null || dataField.getField("cOrderlineId").equals("")) {
        ...
        String strHASSECONDUOM = LinesData.selectAux800000(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|HASSECONDUOM", strHASSECONDUOM);
        String strATTRSETVALUETYPE = LinesData.selectAux10444AA4DB1D49D7A621F1EF47787122(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    vars.setSessionValue(windowId + "|Processed", strProcessed);
        String strATTRIBUTESET = LinesData.selectAux2B0D9093C42A41E3AB05FEF0A64DBEA5(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|ATTRIBUTESET", strATTRIBUTESET);
        String strUsesAlternate = LinesData.selectAux3648B8ACFDE44EF4A649B7933D9DBD97(this, ((dataField!=null)?dataField.getField("cTaxId"):((data==null || data.length==0)?"":data[0].getField("cTaxId"))));
    vars.setSessionValue(windowId + "|UsesAlternate", strUsesAlternate);
        String strATTRIBUTESETINSTANCIABLE = LinesData.selectAux44F99FD664A64A9683694FE63672BD55(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|ATTRIBUTESETINSTANCIABLE", strATTRIBUTESETINSTANCIABLE);
        String strisBOM = LinesData.selectAux54B597A45774438696EC38DB00010B67(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|isBOM", strisBOM);
        String strIsStocked = LinesData.selectAux9039E3F1B99F4D76855A89FA73B4F05F(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    vars.setSessionValue(windowId + "|Posted", strPosted);
        String strisQuantityVariable = LinesData.selectAuxF12E4458B64640EC9200B936D58337ED(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPC_Order_ID, Utility.getDefault(this, vars, "Line_Gross_Amount", "0", "181", "", dataField), Utility.getDefault(this, vars, "CANCELPRICEAD", "N", "181", "N", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "181", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "181", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "181", "", dataField), LinesData.selectDef2210_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "181", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "181", "", dataField), LinesData.selectDef2212_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "181", "", dataField)), LinesData.selectDef2214(this, strPC_Order_ID), Utility.getDefault(this, vars, "DateOrdered", "@DateOrdered@", "181", "", dataField), Utility.getDefault(this, vars, "DatePromised", "@DatePromised@", "181", "", dataField), Utility.getDefault(this, vars, "DateDelivered", "", "181", "", dataField), Utility.getDefault(this, vars, "DateInvoiced", "", "181", "", dataField), Utility.getDefault(this, vars, "Description", "", "181", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "181", "", dataField), LinesData.selectDef2221_2(this,  vars.getLanguage(), Utility.getDefault(this, vars, "M_Product_ID", "", "181", "", dataField)), Utility.getDefault(this, vars, "C_UOM_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "@M_Warehouse_ID@", "181", "", dataField), Utility.getDefault(this, vars, "QtyOrdered", "1", "181", "0", dataField), Utility.getDefault(this, vars, "QtyReserved", "", "181", "0", dataField), Utility.getDefault(this, vars, "QtyDelivered", "", "181", "0", dataField), Utility.getDefault(this, vars, "QtyInvoiced", "", "181", "0", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "@M_Shipper_ID@", "181", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "181", "", dataField), Utility.getDefault(this, vars, "PriceList", "", "181", "0", dataField), Utility.getDefault(this, vars, "PriceActual", "", "181", "0", dataField), Utility.getDefault(this, vars, "C_Tax_ID", "", "181", "", dataField), LinesData.selectDef2764(this, strPC_Order_ID), Utility.getDefault(this, vars, "DirectShip", "", "181", "N", dataField), Utility.getDefault(this, vars, "FreightAmt", "", "181", "0", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "181", "", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "@C_BPartner_Location_ID@", "181", "", dataField), Utility.getDefault(this, vars, "LineNetAmt", "", "181", "0", dataField), Utility.getDefault(this, vars, "PriceLimit", "", "181", "0", dataField), Utility.getDefault(this, vars, "Discount", "0", "181", "", dataField), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "C_Return_Reason_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "S_ResourceAssignment_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "C_Order_Discount_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "Ref_OrderLine_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "Iseditlinenetamt", "N", "181", "N", dataField), Utility.getDefault(this, vars, "Taxbaseamt", "", "181", "", dataField), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "181", "", dataField), Utility.getDefault(this, vars, "QuantityOrder", "", "181", "", dataField), Utility.getDefault(this, vars, "M_Offer_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "PriceStd", "0", "181", "0", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "181", "", dataField), LinesData.selectDef8767_3(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "181", "", dataField)), Utility.getDefault(this, vars, "User1_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "C_Aum", "", "181", "", dataField), Utility.getDefault(this, vars, "IsDescription", "N", "181", "N", dataField), Utility.getDefault(this, vars, "BOM_Parent_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "grosspricestd", "0", "181", "0", dataField), Utility.getDefault(this, vars, "Explode", "", "181", "N", dataField), Utility.getDefault(this, vars, "M_Inoutline_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "181", "", dataField), LinesData.selectDefB2023461A08649D58E5D144D4FC2C507_4(this, Utility.getDefault(this, vars, "C_Project_ID", "", "181", "", dataField)), Utility.getDefault(this, vars, "Aumqty", "", "181", "", dataField), Utility.getDefault(this, vars, "GrossPriceList", "", "181", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_Rule_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "Create_Reservation", "", "181", "", dataField), Utility.getDefault(this, vars, "SO_Res_Status", "", "181", "", dataField), Utility.getDefault(this, vars, "Manage_Reservation", "", "181", "N", dataField), Utility.getDefault(this, vars, "Manage_Prereservation", "", "181", "N", dataField), Utility.getDefault(this, vars, "Quotationline_ID", "", "181", "", dataField), LinesData.selectDefE9612846B6F5472A8F64CF729E0B25AE_5(this, Utility.getDefault(this, vars, "Quotationline_ID", "", "181", "", dataField)), Utility.getDefault(this, vars, "Gross_Unit_Price", "0", "181", "", dataField));
...
xmlDocument.setParameter("buttonPriceLimit", Utility.messageBD(this, "Calc", vars.getLanguage()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private String getReadOnlyLogicContext(VariablesSecureApp vars) throws IOException, ServletException {
      ...
      String result = "var strIsSOTrx=\"" + Utility.getContext(this, vars, "IsSOTrx", windowId) + "\";\nvar strISLINKEDTOPRODUCT=\"" + Utility.getContext(this, vars, "ISLINKEDTOPRODUCT", windowId) + "\";\nvar strPRODUCTTYPE=\"" + Utility.getContext(this, vars, "PRODUCTTYPE", windowId) + "\";\nvar strUomManagement=\"" + Utility.getContext(this, vars, "UomManagement", windowId) + "\";\n";
      return result;
    }
