...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header", false, "document.frmMain.inpcOrderId", "grid", "../orders/print.html", "N".equals("Y"), "PurchaseOrder", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("cOrderId") == null || dataField.getField("cOrderId").equals("")) {
        ...
        String strORDERTYPE = HeaderData.selectAux8(this, ((dataField!=null)?dataField.getField("cOrderId"):((data==null || data.length==0)?"":data[0].getField("cOrderId"))));
    vars.setSessionValue(windowId + "|ORDERTYPE", strORDERTYPE);
        String strDOCBASETYPE = HeaderData.selectAux17F5DEA4A5254BDDA77560A7D67667B6(this, ((dataField!=null)?dataField.getField("cDoctypetargetId"):((data==null || data.length==0)?"":data[0].getField("cDoctypetargetId"))));
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strAPRM_OrderIsPaid = HeaderData.selectAux874CCFB2FE7B40D79D2B0AE27951853F(this, ((dataField!=null)?dataField.getField("cOrderId"):((data==null || data.length==0)?"":data[0].getField("cOrderId"))));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "Convertquotation", "", "181", "N", dataField), Utility.getDefault(this, vars, "validuntil", "", "181", "", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "181", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "181", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "181", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "181", "", dataField), HeaderData.selectDef2166_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "181", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "181", "", dataField), HeaderData.selectDef2168_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "181", "", dataField)), Utility.getDefault(this, vars, "DocumentNo", "", "181", "", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "181", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "181", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "FF80818130217A35013021A672400035", Utility.getDefault(this, vars, "DocAction", "CO", "181", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "FF80818130217A35013021A672400035", Utility.getDefault(this, vars, "DocAction", "CO", "181", "N", dataField))), Utility.getDefault(this, vars, "C_DocType_ID", "0", "181", "", dataField), Utility.getDefault(this, vars, "C_DocTypeTarget_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "Description", "", "181", "", dataField), Utility.getDefault(this, vars, "IsDelivered", "", "181", "N", dataField), Utility.getDefault(this, vars, "IsInvoiced", "", "181", "N", dataField), Utility.getDefault(this, vars, "IsPrinted", "", "181", "N", dataField), Utility.getDefault(this, vars, "DateOrdered", "@#Date@", "181", "", dataField), Utility.getDefault(this, vars, "DatePromised", "@#Date@", "181", "", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "181", "", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "C_PaymentTerm_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "BillTo_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "181", "", dataField), Utility.getDefault(this, vars, "InvoiceRule", "D", "181", "", dataField), Utility.getDefault(this, vars, "FreightAmt", "", "181", "0", dataField), Utility.getDefault(this, vars, "DeliveryViaRule", "P", "181", "", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "PriorityRule", "5", "181", "", dataField), Utility.getDefault(this, vars, "TotalLines", "", "181", "0", dataField), Utility.getDefault(this, vars, "GrandTotal", "", "181", "0", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "Processing", "", "181", "N", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "181", "", dataField), HeaderData.selectDef2762_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "181", "", dataField)), Utility.getDefault(this, vars, "AD_User_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "POReference", "", "181", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "181", "", dataField), Utility.getDefault(this, vars, "Processed", "", "181", "N", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "181", "", dataField), HeaderData.selectDef3402_3(this, Utility.getDefault(this, vars, "C_Project_ID", "", "181", "", dataField)), Utility.getDefault(this, vars, "C_Activity_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "Quotation_ID", "", "181", "", dataField), HeaderData.selectDef367DCAA9CF4442ADB9A76F6539102217_4(this, Utility.getDefault(this, vars, "Quotation_ID", "", "181", "", dataField)), Utility.getDefault(this, vars, "IsSOTrx", "@IsSOTrx@", "181", "N", dataField), Utility.getDefault(this, vars, "DatePrinted", "", "181", "", dataField), Utility.getDefault(this, vars, "DeliveryRule", "A", "181", "", dataField), Utility.getDefault(this, vars, "FreightCostRule", "I", "181", "", dataField), Utility.getDefault(this, vars, "PaymentRule", "B", "181", "", dataField), Utility.getDefault(this, vars, "IsDiscountPrinted", "", "181", "N", dataField), Utility.getDefault(this, vars, "Posted", "N", "181", "N", dataField), Utility.getDefault(this, vars, "IsTaxIncluded", "", "181", "N", dataField), Utility.getDefault(this, vars, "IsSelected", "", "181", "N", dataField), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "Deliverynotes", "", "181", "", dataField), Utility.getDefault(this, vars, "C_Incoterms_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "Incotermsdescription", "", "181", "", dataField), Utility.getDefault(this, vars, "Generatetemplate", "", "181", "N", dataField), Utility.getDefault(this, vars, "Delivery_Location_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "CopyFromPO", "", "181", "N", dataField), Utility.getDefault(this, vars, "FIN_Paymentmethod_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "DropShip_User_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "DropShip_BPartner_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "CopyFrom", "", "181", "N", dataField), Utility.getDefault(this, vars, "DropShip_Location_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "IsSelfService", "", "181", "N", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "Calculate_Promotions", "", "181", "N", dataField), Utility.getDefault(this, vars, "RM_PickFromShipment", "", "181", "N", dataField), Utility.getDefault(this, vars, "RM_ReceiveMaterials", "", "181", "N", dataField), Utility.getDefault(this, vars, "RM_CreateInvoice", "", "181", "N", dataField), Utility.getDefault(this, vars, "C_Return_Reason_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "RM_AddOrphanLine", "", "181", "N", dataField), Utility.getDefault(this, vars, "SO_Res_Status", "", "181", "", dataField), Utility.getDefault(this, vars, "Create_POLines", "N", "181", "N", dataField), Utility.getDefault(this, vars, "C_Reject_Reason_ID", "", "181", "", dataField), Utility.getDefault(this, vars, "EM_APRM_AddPayment", "", "181", "N", dataField));
...
xmlDocument.setParameter("EM_APRM_AddPayment_BTNname", Utility.getButtonName(this, vars, "F4A594CF81DA4C0DB3A81BBFF0305C12", "EM_APRM_AddPayment_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_APRM_AddPayment = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
...
xmlDocument.setParameter("Create_POLines_BTNname", Utility.getButtonName(this, vars, "E07502C4A5285ECCE040007F0100280F", "Create_POLines_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalCreate_POLines = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
