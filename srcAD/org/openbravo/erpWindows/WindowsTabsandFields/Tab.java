...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "10", "AD_Tab_ID", stradTabId, vars.getClient(), vars.getOrg(), vars.getUser());
  ...
  private TabData getEditVariables(Connection con, VariablesSecureApp vars, String strPAD_Window_ID) throws IOException,ServletException {
    ...
    data.adModuleId = vars.getRequiredGlobalVariable("inpadModuleId", windowId + "|AD_Module_ID");     data.adModuleIdr = vars.getStringParameter("inpadModuleId_R");     data.name = vars.getRequiredStringParameter("inpname");     data.adTableId = vars.getRequiredGlobalVariable("inpadTableId", windowId + "|AD_Table_ID");     data.adTableIdr = vars.getStringParameter("inpadTableId_R");     data.uipattern = vars.getRequiredStringParameter("inpuipattern");     data.uipatternr = vars.getStringParameter("inpuipattern_R");    try {   data.seqno = vars.getRequiredNumericParameter("inpseqno");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.tablevel = vars.getRequiredNumericParameter("inptablevel");  } catch (ServletException paramEx) { ex = paramEx; }     data.help = vars.getStringParameter("inphelp");     data.description = vars.getStringParameter("inpdescription");     data.whereclause = vars.getStringParameter("inpwhereclause");     data.hqlwhereclause = vars.getStringParameter("inphqlwhereclause");     data.filterclause = vars.getStringParameter("inpfilterclause");     data.hqlfilterclause = vars.getStringParameter("inphqlfilterclause");     data.filtername = vars.getStringParameter("inpfiltername");     data.orderbyclause = vars.getStringParameter("inporderbyclause");     data.hqlorderbyclause = vars.getStringParameter("inphqlorderbyclause");     data.isinfotab = vars.getStringParameter("inpisinfotab", "N");     data.istranslationtab = vars.getStringParameter("inpistranslationtab", "N");     data.issinglerow = vars.getStringParameter("inpissinglerow", "N");     data.hastree = vars.getStringParameter("inphastree", "N");     data.showparentbuttons = vars.getStringParameter("inpshowparentbuttons", "N");     data.adProcessId = vars.getStringParameter("inpadProcessId");     data.adProcessIdr = vars.getStringParameter("inpadProcessId_R");     data.editreference = vars.getStringParameter("inpeditreference");     data.editreferencer = vars.getStringParameter("inpeditreference_R");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.displaylogic = vars.getStringParameter("inpdisplaylogic");     data.importfields = vars.getStringParameter("inpimportfields");     data.processing = vars.getStringParameter("inpprocessing");     data.disableParentKeyProperty = vars.getStringParameter("inpdisableParentKeyProperty", "N");     data.emObuiappShowSelect = vars.getStringParameter("inpemObuiappShowSelect", "N");     data.emObuiappCanAdd = vars.getStringParameter("inpemObuiappCanAdd", "N");     data.emObuiappCanDelete = vars.getStringParameter("inpemObuiappCanDelete", "N");     data.emObuiappSelectionType = vars.getStringParameter("inpemObuiappSelectionType");     data.emObuiappSelectionTyper = vars.getStringParameter("inpemObuiappSelectionType_R");     data.emObuiappSelection = vars.getStringParameter("inpemObuiappSelection");     data.emObuiappNewfn = vars.getStringParameter("inpemObuiappNewfn");     data.emObuiappRemovefn = vars.getStringParameter("inpemObuiappRemovefn");     data.adTableTreeId = vars.getStringParameter("inpadTableTreeId");     data.isreadonlytree = vars.getStringParameter("inpisreadonlytree", "N");     data.isshowtreenodeicons = vars.getStringParameter("inpisshowtreenodeicons", "N");     data.hqltreewhereclause = vars.getStringParameter("inphqltreewhereclause");     data.defaulttreeviewlogic = vars.getStringParameter("inpdefaulttreeviewlogic");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.adWindowId = vars.getRequiredStringParameter("inpadWindowId");     data.adImageId = vars.getStringParameter("inpadImageId");     data.adTabId = vars.getRequestGlobalVariable("inpadTabId", windowId + "|AD_Tab_ID");     data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.issorttab = vars.getStringParameter("inpissorttab", "N");     data.adColumnsortyesnoId = vars.getStringParameter("inpadColumnsortyesnoId");     data.commitwarning = vars.getStringParameter("inpcommitwarning");     data.adColumnId = vars.getStringParameter("inpadColumnId");     data.adColumnsortorderId = vars.getStringParameter("inpadColumnsortorderId");     data.includedTabId = vars.getStringParameter("inpincludedTabId"); 
      ...
      data.adWindowId = vars.getGlobalVariable("inpadWindowId", windowId + "|AD_Window_ID");
          ...
          vars.getGlobalVariable("inptableDataOriginType", windowId + "|Table_Data_Origin_Type", "");
          vars.getGlobalVariable("inpistreetable", windowId + "|IsTreeTable", "");
  ...
  private String getParentID(VariablesSecureApp vars, String strAD_Tab_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Module_ID", data[0].getField("adModuleId"));    vars.setSessionValue(windowId + "|AD_Table_ID", data[0].getField("adTableId"));    vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|AD_Tab_ID", data[0].getField("adTabId"));
    }
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _AD_Tab_ID, String strPAD_Window_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strAD_Tab_ID = _AD_Tab_ID;
...
String strParamAD_Window_ID = vars.getSessionValue(tabId + "|paramAD_Window_ID");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("adTabId") == null || dataField.getField("adTabId").equals("")) {
        ...
        String strTable_Data_Origin_Type = TabData.selectAux294C4E2D7138493CA62CD990018832D9(this, ((dataField!=null)?dataField.getField("adTableId"):((data==null || data.length==0)?"":data[0].getField("adTableId"))));
    vars.setSessionValue(windowId + "|Table_Data_Origin_Type", strTable_Data_Origin_Type);
        String strIsTreeTable = TabData.selectAux364291215E9147639E19489DCE02B97F(this, ((dataField!=null)?dataField.getField("adTableId"):((data==null || data.length==0)?"":data[0].getField("adTableId"))));
    vars.setSessionValue(windowId + "|IsTreeTable", strIsTreeTable);
    
    
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        refreshSessionNew(vars, strPAD_Window_ID);
        data = TabData.set(strPAD_Window_ID, Utility.getDefault(this, vars, "HasTree", "", "102", "N", dataField), "", Utility.getDefault(this, vars, "Name", "", "102", "", dataField), Utility.getDefault(this, vars, "Description", "", "102", "", dataField), Utility.getDefault(this, vars, "Help", "", "102", "", dataField), TabData.selectDef165(this, strPAD_Window_ID), Utility.getDefault(this, vars, "IsSingleRow", "", "102", "N", dataField), Utility.getDefault(this, vars, "Displaylogic", "", "102", "", dataField), Utility.getDefault(this, vars, "IsInfoTab", "", "102", "N", dataField), Utility.getDefault(this, vars, "IsTranslationTab", "", "102", "N", dataField), Utility.getDefault(this, vars, "IsReadOnly", "", "102", "N", dataField), Utility.getDefault(this, vars, "AD_Table_ID", "", "102", "", dataField), Utility.getDefault(this, vars, "AD_Table_Tree_ID", "", "102", "", dataField), Utility.getDefault(this, vars, "AD_Column_ID", "", "102", "", dataField), Utility.getDefault(this, vars, "WhereClause", "", "102", "", dataField), Utility.getDefault(this, vars, "OrderByClause", "", "102", "", dataField), Utility.getDefault(this, vars, "CommitWarning", "", "102", "", dataField), Utility.getDefault(this, vars, "AD_Process_ID", "", "102", "", dataField), "0", Utility.getDefault(this, vars, "EM_Obuiapp_Show_Select", "Y", "102", "N", dataField), "0", Utility.getDefault(this, vars, "Processing", "", "102", "N", dataField), TabData.selectDef5661EC317B643D0FE040007F01004528(this, strPAD_Window_ID), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "102", "", dataField), TabData.selectDef575_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "102", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "102", "", dataField), TabData.selectDef577_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "102", "", dataField)), Utility.getDefault(this, vars, "EM_Obuiapp_Removefn", "", "102", "", dataField), Utility.getDefault(this, vars, "Hqlwhereclause", "", "102", "", dataField), Utility.getDefault(this, vars, "IsShowTreeNodeIcons", "Y", "102", "N", dataField), Utility.getDefault(this, vars, "AD_Image_ID", "", "102", "", dataField), Utility.getDefault(this, vars, "ImportFields", "", "102", "N", dataField), Utility.getDefault(this, vars, "Disable_Parent_Key_Property", "N", "102", "N", dataField), Utility.getDefault(this, vars, "TabLevel", "", "102", "0", dataField), Utility.getDefault(this, vars, "UIPattern", "STD", "102", "", dataField), Utility.getDefault(this, vars, "IsSortTab", "N", "102", "N", dataField), Utility.getDefault(this, vars, "AD_ColumnSortYesNo_ID", "", "102", "", dataField), Utility.getDefault(this, vars, "AD_ColumnSortOrder_ID", "", "102", "", dataField), Utility.getDefault(this, vars, "EM_Obuiapp_Newfn", "", "102", "", dataField), Utility.getDefault(this, vars, "EM_Obuiapp_Selection_Type", "", "102", "", dataField), Utility.getDefault(this, vars, "FilterClause", "", "102", "", dataField), Utility.getDefault(this, vars, "EditReference", "", "102", "", dataField), Utility.getDefault(this, vars, "Included_Tab_ID", "", "102", "", dataField), Utility.getDefault(this, vars, "IsReadOnlyTree", "N", "102", "N", dataField), Utility.getDefault(this, vars, "EM_Obuiapp_Can_Delete", "N", "102", "N", dataField), Utility.getDefault(this, vars, "FilterName", "", "102", "", dataField), Utility.getDefault(this, vars, "ShowParentButtons", "Y", "102", "N", dataField), Utility.getDefault(this, vars, "Hqlorderbyclause", "", "102", "", dataField), Utility.getDefault(this, vars, "DefaultTreeViewLogic", "", "102", "", dataField), Utility.getDefault(this, vars, "Hqltreewhereclause", "", "102", "", dataField), Utility.getDefault(this, vars, "Hqlfilterclause", "", "102", "", dataField), Utility.getDefault(this, vars, "EM_Obuiapp_Can_Add", "N", "102", "N", dataField), Utility.getDefault(this, vars, "EM_OBUIAPP_Selection", "", "102", "", dataField));
    ...
    try {
      ...
      throw new ServletException(ex);
        ...
        xmlDocument.setParameter("Table_Data_Origin_Type", strTable_Data_Origin_Type);
        xmlDocument.setParameter("IsTreeTable", strIsTreeTable);
...
comboTableData = new ComboTableData(vars, this, "17", "EM_Obuiapp_Selection_Type", "0BD87850221D409596E57FBFE58B1392", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("emObuiappSelectionType"):dataField.getField("emObuiappSelectionType")));
xmlDocument.setData("reportEM_Obuiapp_Selection_Type","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
