  ...
  private HeaderData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.cDoctypetargetId = vars.getRequiredStringParameter("inpcDoctypetargetId");     data.cDoctypetargetIdr = vars.getStringParameter("inpcDoctypetargetId_R");     data.documentno = vars.getRequiredStringParameter("inpdocumentno");     data.dateinvoiced = vars.getRequiredGlobalVariable("inpdateinvoiced", windowId + "|DateInvoiced");     data.cBpartnerId = vars.getRequiredGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R");     data.cBpartnerLocationId = vars.getRequiredStringParameter("inpcBpartnerLocationId");     data.cBpartnerLocationIdr = vars.getStringParameter("inpcBpartnerLocationId_R");     data.mPricelistId = vars.getRequiredGlobalVariable("inpmPricelistId", windowId + "|M_PriceList_ID");     data.mPricelistIdr = vars.getStringParameter("inpmPricelistId_R");     data.dateacct = vars.getRequiredStringParameter("inpdateacct");     data.cPaymenttermId = vars.getRequiredStringParameter("inpcPaymenttermId");     data.cPaymenttermIdr = vars.getStringParameter("inpcPaymenttermId_R");     data.finPaymentmethodId = vars.getRequiredStringParameter("inpfinPaymentmethodId");     data.finPaymentmethodIdr = vars.getStringParameter("inpfinPaymentmethodId_R");     data.description = vars.getStringParameter("inpdescription");     data.cOrderId = vars.getStringParameter("inpcOrderId");     data.cOrderIdr = vars.getStringParameter("inpcOrderId_R");     data.poreference = vars.getStringParameter("inpporeference");     data.docstatus = vars.getRequiredGlobalVariable("inpdocstatus", windowId + "|DocStatus");    try {   data.grandtotal = vars.getRequiredNumericParameter("inpgrandtotal");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.totallines = vars.getRequiredNumericParameter("inptotallines");  } catch (ServletException paramEx) { ex = paramEx; }     data.cCurrencyId = vars.getRequiredGlobalVariable("inpcCurrencyId", windowId + "|C_Currency_ID");     data.ispaid = vars.getRequiredInputGlobalVariable("inpispaid", windowId + "|Ispaid", "N");     data.adUserId = vars.getStringParameter("inpadUserId");    try {   data.totalpaid = vars.getRequiredNumericParameter("inptotalpaid", vars.getSessionValue(windowId + "|Totalpaid"));  } catch (ServletException paramEx) { ex = paramEx; }     data.lastcalculatedondate = vars.getStringParameter("inplastcalculatedondate");     data.taxdate = vars.getStringParameter("inptaxdate");    try {   data.outstandingamt = vars.getRequiredNumericParameter("inpoutstandingamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.dateordered = vars.getStringParameter("inpdateordered");    try {   data.dueamt = vars.getRequiredNumericParameter("inpdueamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.salesrepId = vars.getStringParameter("inpsalesrepId");    try {   data.daystilldue = vars.getRequiredNumericParameter("inpdaystilldue");  } catch (ServletException paramEx) { ex = paramEx; }     data.isdiscountprinted = vars.getStringParameter("inpisdiscountprinted", "N");     data.cDoctypeId = vars.getRequiredGlobalVariable("inpcDoctypeId", windowId + "|C_DocType_ID");    try {   data.withholdingamount = vars.getNumericParameter("inpwithholdingamount");  } catch (ServletException paramEx) { ex = paramEx; }     data.cWithholdingId = vars.getStringParameter("inpcWithholdingId");    try {   data.percentageoverdue = vars.getNumericParameter("inppercentageoverdue");  } catch (ServletException paramEx) { ex = paramEx; }     data.cActivityId = vars.getStringParameter("inpcActivityId");     data.finalsettlement = vars.getStringParameter("inpfinalsettlement");    try {   data.daysoutstanding = vars.getNumericParameter("inpdaysoutstanding");  } catch (ServletException paramEx) { ex = paramEx; }     data.isactive = vars.getStringParameter("inpisactive", "N");    try {   data.chargeamt = vars.getNumericParameter("inpchargeamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.cChargeId = vars.getStringParameter("inpcChargeId");     data.generateto = vars.getStringParameter("inpgenerateto");     data.adOrgtrxId = vars.getStringParameter("inpadOrgtrxId");     data.updatepaymentmonitor = vars.getRequiredStringParameter("inpupdatepaymentmonitor");     data.emAprmAddpayment = vars.getStringParameter("inpemAprmAddpayment");     data.posted = vars.getRequiredGlobalVariable("inpposted", windowId + "|Posted");     data.emAprmProcessinvoice = vars.getStringParameter("inpemAprmProcessinvoice");     data.docaction = vars.getRequiredStringParameter("inpdocaction");     data.createfrom = vars.getStringParameter("inpcreatefrom");     data.copyfrom = vars.getStringParameter("inpcopyfrom");     data.calculatePromotions = vars.getStringParameter("inpcalculatePromotions");     data.cProjectId = vars.getStringParameter("inpcProjectId");     data.cProjectIdr = vars.getStringParameter("inpcProjectId_R");     data.cCostcenterId = vars.getStringParameter("inpcCostcenterId");     data.aAssetId = vars.getStringParameter("inpaAssetId");     data.cCampaignId = vars.getStringParameter("inpcCampaignId");     data.cCampaignIdr = vars.getStringParameter("inpcCampaignId_R");     data.user1Id = vars.getStringParameter("inpuser1Id");     data.user2Id = vars.getStringParameter("inpuser2Id");    try {   data.prepaymentamt = vars.getRequiredNumericParameter("inpprepaymentamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.isprinted = vars.getStringParameter("inpisprinted", "N");     data.istaxincluded = vars.getStringParameter("inpistaxincluded", "N");     data.processed = vars.getStringParameter("inpprocessed", "N");     data.isselfservice = vars.getStringParameter("inpisselfservice", "N");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.cInvoiceId = vars.getRequestGlobalVariable("inpcInvoiceId", windowId + "|C_Invoice_ID");     data.processing = vars.getStringParameter("inpprocessing");     data.dateprinted = vars.getStringParameter("inpdateprinted");     data.issotrx = vars.getRequiredInputGlobalVariable("inpissotrx", windowId + "|IsSOTrx", "N");     data.paymentrule = vars.getStringParameter("inppaymentrule"); 
      ...
      data.updatedTimeStamp = vars.getStringParameter("updatedTimestamp");
          ...
          vars.getGlobalVariable("inpshowaddpayment", windowId + "|showAddPayment", "");
          vars.getGlobalVariable("inphasCInvoicelines", windowId + "|HAS_C_INVOICELINES", "");
...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header", false, "document.frmMain.inpcInvoiceId", "grid", "../invoices/print.html", "N".equals("Y"), "PurchaseInvoice", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _C_Invoice_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strC_Invoice_ID = _C_Invoice_ID;
...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("cInvoiceId") == null || dataField.getField("cInvoiceId").equals("")) {
        ...
        String strDOCBASETYPE = HeaderData.selectAux68CD2AFDCEAB45ADB0690B33067B7940(this, ((dataField!=null)?dataField.getField("cDoctypetargetId"):((data==null || data.length==0)?"":data[0].getField("cDoctypetargetId"))));
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strVoidAutomaticallyCreated = HeaderData.selectAux7E3FB488115E46C5937FDF8A73D36098(this, ((dataField!=null)?dataField.getField("cInvoiceId"):((data==null || data.length==0)?"":data[0].getField("cInvoiceId"))));
    vars.setSessionValue(windowId + "|VoidAutomaticallyCreated", strVoidAutomaticallyCreated);
        String strshowAddPayment = HeaderData.selectAux9E5EF28335254D948E30BAF9BF41B3A7(this, ((dataField!=null)?dataField.getField("cInvoiceId"):((data==null || data.length==0)?"":data[0].getField("cInvoiceId"))));
    vars.setSessionValue(windowId + "|showAddPayment", strshowAddPayment);
        String strHAS_C_INVOICELINES = HeaderData.selectAuxAF1F32AFD6794C6C9C3C2EC82DC2F92A(this, ((dataField!=null)?dataField.getField("cInvoiceId"):((data==null || data.length==0)?"":data[0].getField("cInvoiceId"))));
    vars.setSessionValue(windowId + "|HAS_C_INVOICELINES", strHAS_C_INVOICELINES);
    
    
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        refreshSessionNew(vars);
        data = HeaderData.set(Utility.getDefault(this, vars, "LastCalculatedOnDate", "", "183", "", dataField), Utility.getDefault(this, vars, "C_Withholding_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "Withholdingamount", "", "183", "", dataField), Utility.getDefault(this, vars, "Taxdate", "", "183", "", dataField), Utility.getDefault(this, vars, "DaysTillDue", "0", "183", "0", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "183", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "183", "", dataField), "Y", Utility.getDefault(this, vars, "Created", "", "183", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "183", "", dataField), HeaderData.selectDef3489_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "183", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "183", "", dataField), HeaderData.selectDef3491_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "183", "", dataField)), Utility.getDefault(this, vars, "DocumentNo", "", "183", "", dataField), Utility.getDefault(this, vars, "C_DocType_ID", "0", "183", "", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "183", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "183", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "183", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "183", "N", dataField))), Utility.getDefault(this, vars, "Processing", "", "183", "N", dataField), Utility.getDefault(this, vars, "Processed", "", "183", "N", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "183", "", dataField), HeaderData.selectDef3499_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "183", "", dataField)), Utility.getDefault(this, vars, "C_PaymentTerm_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "183", "", dataField), Utility.getDefault(this, vars, "TotalLines", "", "183", "0", dataField), Utility.getDefault(this, vars, "GrandTotal", "", "183", "0", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "183", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "183", "", dataField), HeaderData.selectDef3510_3(this, Utility.getDefault(this, vars, "C_Project_ID", "", "183", "", dataField)), Utility.getDefault(this, vars, "C_Activity_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "IsSOTrx", "@IsSOTrx@", "183", "N", dataField), Utility.getDefault(this, vars, "C_DocTypeTarget_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "Description", "", "183", "", dataField), Utility.getDefault(this, vars, "DateInvoiced", "@#Date@", "183", "", dataField), Utility.getDefault(this, vars, "DatePrinted", "", "183", "", dataField), Utility.getDefault(this, vars, "POReference", "", "183", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "", "183", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "PaymentRule", "P", "183", "", dataField), Utility.getDefault(this, vars, "C_Order_ID", "", "183", "", dataField), HeaderData.selectDef4247_4(this, Utility.getDefault(this, vars, "C_Order_ID", "", "183", "", dataField)), Utility.getDefault(this, vars, "DateOrdered", "", "183", "", dataField), Utility.getDefault(this, vars, "IsDiscountPrinted", "", "183", "N", dataField), Utility.getDefault(this, vars, "IsPrinted", "", "183", "N", dataField), Utility.getDefault(this, vars, "Prepaymentamt", "0", "183", "0", dataField), Utility.getDefault(this, vars, "IsTaxIncluded", "", "183", "N", dataField), Utility.getDefault(this, vars, "Posted", "N", "183", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "N", "183", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "N", "183", "N", dataField))), Utility.getDefault(this, vars, "GenerateTo", "", "183", "N", dataField), Utility.getDefault(this, vars, "CreateFrom", "", "183", "N", dataField), Utility.getDefault(this, vars, "EM_APRM_Addpayment", "Y", "183", "N", dataField), Utility.getDefault(this, vars, "FIN_Paymentmethod_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "CopyFrom", "", "183", "N", dataField), Utility.getDefault(this, vars, "IsSelfService", "", "183", "N", dataField), Utility.getDefault(this, vars, "EM_APRM_Processinvoice", "CO", "183", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "EM_APRM_Processinvoice", "CO", "183", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "EM_APRM_Processinvoice", "CO", "183", "N", dataField))), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "Finalsettlement", "", "183", "", dataField), Utility.getDefault(this, vars, "Daysoutstanding", "", "183", "", dataField), Utility.getDefault(this, vars, "Percentageoverdue", "", "183", "", dataField), Utility.getDefault(this, vars, "Totalpaid", "0", "183", "0", dataField), Utility.getDefault(this, vars, "OutstandingAmt", "0", "183", "0", dataField), Utility.getDefault(this, vars, "DueAmt", "0", "183", "0", dataField), Utility.getDefault(this, vars, "Ispaid", "N", "183", "N", dataField), Utility.getDefault(this, vars, "UpdatePaymentMonitor", "N", "183", "N", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "Calculate_Promotions", "", "183", "N", dataField));
    ...
    try {
      ...
      throw new ServletException(ex);
        ...
        xmlDocument.setParameter("showAddPayment", strshowAddPayment);
        xmlDocument.setParameter("HAS_C_INVOICELINES", strHAS_C_INVOICELINES);
...
xmlDocument.setParameter("EM_APRM_Addpayment_BTNname", Utility.getButtonName(this, vars, "80D2CCB125DAECE6E040007F01000DDE", "EM_APRM_Addpayment_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_APRM_Addpayment = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
...
comboTableData = null;
xmlDocument.setParameter("buttonPrepaymentamt", Utility.messageBD(this, "Calc", vars.getLanguage()));
