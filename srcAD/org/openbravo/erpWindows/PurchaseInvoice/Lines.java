...
vars.getGlobalVariable("inpcInvoiceId", windowId + "|C_Invoice_ID");
  ...
  private LinesData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Invoice_ID) throws IOException,ServletException {
   ...
   try {   data.line = vars.getRequiredNumericParameter("inpline");  } catch (ServletException paramEx) { ex = paramEx; }     data.financialInvoiceLine = vars.getStringParameter("inpfinancialInvoiceLine", "N");     data.mProductId = vars.getRequestGlobalVariable("inpmProductId", windowId + "|M_Product_ID");     data.accountId = vars.getStringParameter("inpaccountId");     data.accountIdr = vars.getStringParameter("inpaccountId_R");    try {   data.aumqty = vars.getNumericParameter("inpaumqty");  } catch (ServletException paramEx) { ex = paramEx; }     data.cAum = vars.getStringParameter("inpcAum");     data.cAumr = vars.getStringParameter("inpcAum_R");    try {   data.qtyinvoiced = vars.getRequiredNumericParameter("inpqtyinvoiced");  } catch (ServletException paramEx) { ex = paramEx; }     data.cUomId = vars.getStringParameter("inpcUomId");     data.cUomIdr = vars.getStringParameter("inpcUomId_R");    try {   data.priceactual = vars.getRequiredNumericParameter("inppriceactual");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.grossUnitPrice = vars.getNumericParameter("inpgrossUnitPrice");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.linenetamt = vars.getRequiredNumericParameter("inplinenetamt");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.lineGrossAmount = vars.getNumericParameter("inplineGrossAmount");  } catch (ServletException paramEx) { ex = paramEx; }     data.description = vars.getStringParameter("inpdescription");     data.cTaxId = vars.getStringParameter("inpcTaxId");     data.cTaxIdr = vars.getStringParameter("inpcTaxId_R");    try {   data.grosspricelist = vars.getRequiredNumericParameter("inpgrosspricelist");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.pricelist = vars.getRequiredNumericParameter("inppricelist");  } catch (ServletException paramEx) { ex = paramEx; }     data.mAttributesetinstanceId = vars.getStringParameter("inpmAttributesetinstanceId");     data.mAttributesetinstanceIdr = vars.getStringParameter("inpmAttributesetinstanceId_R");     data.cOrderlineId = vars.getStringParameter("inpcOrderlineId");     data.cOrderlineIdr = vars.getStringParameter("inpcOrderlineId_R");     data.mInoutlineId = vars.getStringParameter("inpmInoutlineId");     data.mInoutlineIdr = vars.getStringParameter("inpmInoutlineId_R");     data.isdeferred = vars.getStringParameter("inpisdeferred", "N");    try {   data.taxbaseamt = vars.getNumericParameter("inptaxbaseamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.excludeforwithholding = vars.getStringParameter("inpexcludeforwithholding", "N");     data.cChargeId = vars.getStringParameter("inpcChargeId");    try {   data.taxamt = vars.getNumericParameter("inptaxamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.iseditlinenetamt = vars.getStringParameter("inpiseditlinenetamt", "N");    try {   data.quantityorder = vars.getNumericParameter("inpquantityorder");  } catch (ServletException paramEx) { ex = paramEx; }     data.mProductUomId = vars.getStringParameter("inpmProductUomId");    try {   data.pricestd = vars.getRequiredNumericParameter("inppricestd");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.grosspricestd = vars.getRequiredNumericParameter("inpgrosspricestd");  } catch (ServletException paramEx) { ex = paramEx; }     data.defplantype = vars.getStringParameter("inpdefplantype");     data.defplantyper = vars.getStringParameter("inpdefplantype_R");    try {   data.periodnumber = vars.getNumericParameter("inpperiodnumber");  } catch (ServletException paramEx) { ex = paramEx; }     data.cPeriodId = vars.getStringParameter("inpcPeriodId");     data.cPeriodIdr = vars.getStringParameter("inpcPeriodId_R");     data.adOrgId = vars.getRequiredStringParameter("inpadOrgId");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R");     data.cProjectId = vars.getStringParameter("inpcProjectId");     data.cProjectIdr = vars.getStringParameter("inpcProjectId_R");     data.cCostcenterId = vars.getStringParameter("inpcCostcenterId");     data.aAssetId = vars.getStringParameter("inpaAssetId");     data.user1Id = vars.getStringParameter("inpuser1Id");     data.user2Id = vars.getStringParameter("inpuser2Id");     data.explode = vars.getStringParameter("inpexplode");     data.bomParentId = vars.getStringParameter("inpbomParentId");     data.matchLccosts = vars.getStringParameter("inpmatchLccosts");    try {   data.pricelimit = vars.getRequiredNumericParameter("inppricelimit");  } catch (ServletException paramEx) { ex = paramEx; }     data.isactive = vars.getStringParameter("inpisactive", "N");     data.sResourceassignmentId = vars.getStringParameter("inpsResourceassignmentId");     data.cProjectlineId = vars.getStringParameter("inpcProjectlineId");     data.cInvoiceId = vars.getRequiredGlobalVariable("inpcInvoiceId", windowId + "|C_Invoice_ID");     data.cInvoicelineId = vars.getRequestGlobalVariable("inpcInvoicelineId", windowId + "|C_InvoiceLine_ID");     data.cInvoiceDiscountId = vars.getStringParameter("inpcInvoiceDiscountId");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.isdescription = vars.getStringParameter("inpisdescription", "N");     data.mOfferId = vars.getStringParameter("inpmOfferId");    try {   data.chargeamt = vars.getNumericParameter("inpchargeamt");  } catch (ServletException paramEx) { ex = paramEx; } 
      ...
      data.cInvoiceId = vars.getGlobalVariable("inpcInvoiceId", windowId + "|C_Invoice_ID");
          ...
          vars.getGlobalVariable("inplcMatched", windowId + "|LC_MATCHED", "");
  ...
  private String getParentID(VariablesSecureApp vars, String strC_InvoiceLine_ID) throws ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|M_Product_ID", data[0].getField("mProductId"));    vars.setSessionValue(windowId + "|C_Invoice_ID", data[0].getField("cInvoiceId"));    vars.setSessionValue(windowId + "|C_InvoiceLine_ID", data[0].getField("cInvoicelineId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
...
String strParamLineNetAmt_f = vars.getSessionValue(tabId + "|paramLineNetAmt_f");
    ...
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Lines", false, "document.frmMain.inpcInvoicelineId", "grid", "..", "".equals("Y"), "PurchaseInvoice", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
    ...
    xmlDocument.setParameter("parentFieldName", Utility.getFieldName("3362", vars.getLanguage()));
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines_Relation.html", "PurchaseInvoice", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _C_InvoiceLine_ID, String strPC_Invoice_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strC_InvoiceLine_ID = _C_InvoiceLine_ID;
...
String strParamLineNetAmt_f = vars.getSessionValue(tabId + "|paramLineNetAmt_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("cInvoicelineId") == null || dataField.getField("cInvoicelineId").equals("")) {
        ...
        String strHASSECONDUOM = LinesData.selectAux800003(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|HASSECONDUOM", strHASSECONDUOM);
        String strC_BPARTNER_ID = ((dataField!=null)?dataField.getField("cBpartnerId"):((data==null || data.length==0)?"":data[0].getField("cBpartnerId")));
    vars.setSessionValue(windowId + "|C_BPARTNER_ID", strC_BPARTNER_ID);
        String strisBOM = LinesData.selectAux162BEBF77E8D419ABDAD4E87A5C17430(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|isBOM", strisBOM);
        String strATTRSETVALUETYPE = LinesData.selectAux494740D6BFAF41F5B3F8863473924301(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|ATTRSETVALUETYPE", strATTRSETVALUETYPE);
        String strLC_MATCHED = LinesData.selectAux7545008A9CB045EAAF5B21BA319BF307(this, ((dataField!=null)?dataField.getField("cInvoicelineId"):((data==null || data.length==0)?"":data[0].getField("cInvoicelineId"))));
    vars.setSessionValue(windowId + "|LC_MATCHED", strLC_MATCHED);
    ...
    vars.setSessionValue(windowId + "|Processed", strProcessed);
        String strDOCBASETYPE = LinesData.selectAux861880FCEE6846A1B6BF4E129EDAF3DD(this, strPC_Invoice_ID);
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strUsesAlternate = LinesData.selectAux9D4E828236844F559BA70E02BD07DED0(this, ((dataField!=null)?dataField.getField("cTaxId"):((data==null || data.length==0)?"":data[0].getField("cTaxId"))));
    vars.setSessionValue(windowId + "|UsesAlternate", strUsesAlternate);
        String strGROSSPRICE = LinesData.selectAuxA30BE76CF53B4365A97DA2B13D23EB5D(this, Utility.getContext(this, vars, "M_PRICELIST_ID", "183"));
    vars.setSessionValue(windowId + "|GROSSPRICE", strGROSSPRICE);
        String strIsStocked = LinesData.selectAuxCDD35787A8094C5180971D4F8EB83DDC(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|IsStocked", strIsStocked);
        String strParent_AD_Org = LinesData.selectAuxE0A2BB772E284F459DCE5CCE23A7149B(this, strPC_Invoice_ID);
    vars.setSessionValue(windowId + "|Parent_AD_Org", strParent_AD_Org);
        String strATTRIBUTESET = LinesData.selectAuxF9684776014A4118AE4EE0596CA2B2A2(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|ATTRIBUTESET", strATTRIBUTESET);
        String strPosted = LinesData.selectAuxFDD08C93EDE54CD88C52DDFE14FCC157(this, strPC_Invoice_ID);
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPC_Invoice_ID, Utility.getDefault(this, vars, "Match_Lccosts", "", "183", "N", dataField), Utility.getDefault(this, vars, "Excludeforwithholding", "", "183", "N", dataField), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "183", "", dataField), LinesData.selectDef1655799099FD4E7A9EB982F98A5C8066_0(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "183", "", dataField)), Utility.getDefault(this, vars, "C_Period_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "Financial_Invoice_Line", "N", "183", "N", dataField), Utility.getDefault(this, vars, "DefPlanType", "", "183", "", dataField), Utility.getDefault(this, vars, "Aumqty", "", "183", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "183", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "183", "", dataField), "Y", Utility.getDefault(this, vars, "Created", "", "183", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "183", "", dataField), LinesData.selectDef3833_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "183", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "183", "", dataField), LinesData.selectDef3835_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "183", "", dataField)), Utility.getDefault(this, vars, "C_OrderLine_ID", "", "183", "", dataField), LinesData.selectDef3837_3(this, Utility.getDefault(this, vars, "C_OrderLine_ID", "", "183", "", dataField)), LinesData.selectDef3838(this, strPC_Invoice_ID), Utility.getDefault(this, vars, "Description", "", "183", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "QtyInvoiced", "1", "183", "0", dataField), Utility.getDefault(this, vars, "PriceList", "", "183", "0", dataField), Utility.getDefault(this, vars, "PriceActual", "", "183", "0", dataField), Utility.getDefault(this, vars, "LineNetAmt", "", "183", "0", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "", "183", "", dataField), Utility.getDefault(this, vars, "C_UOM_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "C_Tax_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "M_InOutLine_ID", "", "183", "", dataField), LinesData.selectDef4251_4(this,  vars.getLanguage(), Utility.getDefault(this, vars, "M_InOutLine_ID", "", "183", "", dataField)), Utility.getDefault(this, vars, "PriceLimit", "", "183", "0", dataField), Utility.getDefault(this, vars, "Grosspricelist", "", "183", "0", dataField), Utility.getDefault(this, vars, "Periodnumber", "", "183", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "C_Aum", "", "183", "", dataField), Utility.getDefault(this, vars, "S_ResourceAssignment_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "Gross_Unit_Price", "0", "183", "", dataField), Utility.getDefault(this, vars, "Iseditlinenetamt", "N", "183", "N", dataField), Utility.getDefault(this, vars, "Taxbaseamt", "", "183", "", dataField), Utility.getDefault(this, vars, "QuantityOrder", "", "183", "", dataField), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "183", "", dataField), Utility.getDefault(this, vars, "C_Invoice_Discount_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "C_Projectline_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "M_Offer_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "PriceStd", "0", "183", "0", dataField), Utility.getDefault(this, vars, "TaxAmt", "", "183", "", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "183", "", dataField), LinesData.selectDef8553_5(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "183", "", dataField)), Utility.getDefault(this, vars, "A_Asset_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "grosspricestd", "0", "183", "0", dataField), Utility.getDefault(this, vars, "IsDescription", "N", "183", "N", dataField), Utility.getDefault(this, vars, "IsDeferred", "N", "183", "N", dataField), Utility.getDefault(this, vars, "Line_Gross_Amount", "0", "183", "", dataField), Utility.getDefault(this, vars, "Explode", "", "183", "N", dataField), Utility.getDefault(this, vars, "BOM_Parent_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "183", "", dataField), LinesData.selectDefE9065F7B304E419787AD6EB080A54143_6(this, Utility.getDefault(this, vars, "C_Project_ID", "", "183", "", dataField)), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "183", "", dataField), Utility.getDefault(this, vars, "Account_ID", "", "183", "", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/PurchaseInvoice/Lines_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/PurchaseInvoice/Lines_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Lines", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcInvoicelineId", "", "..", "".equals("Y"), "PurchaseInvoice", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_InvoiceLine_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines_Relation.html", "PurchaseInvoice", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Lines_Relation.html", strReplaceWith);
      ...
      throw new ServletException(ex);
        ...
        xmlDocument.setParameter("LC_MATCHED", strLC_MATCHED);
...
comboTableData = null;
xmlDocument.setParameter("Explode_BTNname", Utility.getButtonName(this, vars, "D5C2F8F063FCD47CE040007F01004029", "Explode_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalExplode = org.openbravo.erpCommon.utility.Utility.isModalProcess("6E1ADD5C8B6B4ACB82237DAA8114451E"); 
xmlDocument.setParameter("Explode_Modal", modalExplode?"true":"false");
xmlDocument.setParameter("Match_Lccosts_BTNname", Utility.getButtonName(this, vars, "0204598C8B71C2D9E050007F010065CF", "Match_Lccosts_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalMatch_Lccosts = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("Match_Lccosts_Modal", modalMatch_Lccosts?"true":"false");
...
xmlDocument.setParameter("buttonPriceLimit", Utility.messageBD(this, "Calc", vars.getLanguage()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private String getReadOnlyLogicContext(VariablesSecureApp vars) throws IOException, ServletException {
      ...
      String result = "var strUomManagement=\"" + Utility.getContext(this, vars, "UomManagement", windowId) + "\";\n";
      return result;
    }
