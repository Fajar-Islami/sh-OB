...
public class Time extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Time.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(tabId + "|Time.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamMA_Measure_Group_ID", tabId + "|paramMA_Measure_Group_ID");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strMA_Measure_Time_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Time.view", strView);
        }
      }
      ...
      String strMA_Measure_Time_ID = vars.getGlobalVariable("inpmaMeasureTimeId", windowId + "|MA_Measure_Time_ID", "");
      vars.setSessionValue(tabId + "|Time.view", "RELATION");
...
vars.getGlobalVariable("inpmaMeasureGroupId", windowId + "|MA_Measure_Group_ID");
      ...
      vars.setSessionValue(tabId + "|Time.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {
      String strPMA_Measure_Group_ID = vars.getGlobalVariable("inpmaMeasureGroupId", windowId + "|MA_Measure_Group_ID");

      String strInitRecord = vars.getSessionValue(tabId + "|Time.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Time.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|MA_Measure_Time_ID");
      vars.setSessionValue(windowId + "|MA_Measure_Group_ID", strPMA_Measure_Group_ID);
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
      ...
      String strMA_Measure_Time_ID = vars.getRequiredStringParameter("inpmaMeasureTimeId");
      //TimeData data = getEditVariables(vars, strPMA_Measure_Group_ID);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = TimeData.delete(this, strMA_Measure_Time_ID, strPMA_Measure_Group_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
      ...
      try {
        int total = saveRecord(vars, myError, saveType, strPMA_Measure_Group_ID);
        if (myError.isEmpty()) {
          myError = Utility.translateError(this, vars, vars.getLanguage(), "@CODE=RowsUpdated");
          myError.setMessage(total + " " + myError.getMessage());
  ...
  private TimeData getEditVariables(Connection con, VariablesSecureApp vars, String strPMA_Measure_Group_ID) throws IOException,ServletException {
  ...
  private String getParentID(VariablesSecureApp vars, String strMA_Measure_Time_ID) throws ServletException {
    String strPMA_Measure_Group_ID = TimeData.selectParentID(this, strMA_Measure_Time_ID);
    if (strPMA_Measure_Group_ID.equals("")) {
    ...
    private void refreshSessionNew(VariablesSecureApp vars, String strPMA_Measure_Group_ID) throws IOException,ServletException {
      TimeData[] data = TimeData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPMA_Measure_Group_ID, vars.getStringParameter("inpmaMeasureTimeId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strPMA_Measure_Group_ID, String strMA_Measure_Time_ID, TableSQLData tableSQL)
    ...
    hasSearchCondition = (tableSQL.hasInternalFilter() && ("").equals(strParamMA_Measure_Group_ID)) || !(("").equals(strParamMA_Measure_Group_ID) || ("%").equals(strParamMA_Measure_Group_ID)) ;
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/QualityControlReport/Time_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Time", false, "document.frmMain.inpmaMeasureTimeId", "grid", "..", "".equals("Y"), "QualityControlReport", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
    ...
    xmlDocument.setParameter("parentFieldName", Utility.getFieldName("802524", vars.getLanguage()));
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Time_Relation.html", "QualityControlReport", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Time_Relation.html", strReplaceWith);
    ...
    if (vars.getLanguage().equals("en_US")) xmlDocument.setParameter("parent", TimeData.selectParent(this, strPMA_Measure_Group_ID));
    else xmlDocument.setParameter("parent", TimeData.selectParentTrl(this, strPMA_Measure_Group_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _MA_Measure_Time_ID, String strPMA_Measure_Group_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strMA_Measure_Time_ID = _MA_Measure_Time_ID;
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = TimeData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strPMA_Measure_Group_ID, strMA_Measure_Time_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = TimeData.set(strPMA_Measure_Group_ID, "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800064", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800064", "", dataField), "Y", Utility.getDefault(this, vars, "Createdby", "", "800064", "", dataField), TimeData.selectDef802248_0(this, Utility.getDefault(this, vars, "Createdby", "", "800064", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "800064", "", dataField), TimeData.selectDef802250_1(this, Utility.getDefault(this, vars, "Updatedby", "", "800064", "", dataField)), Utility.getDefault(this, vars, "Measurehour", "", "800064", "", dataField), Utility.getDefault(this, vars, "Explode", "", "800064", "N", dataField), Utility.getDefault(this, vars, "Processed", "N", "800064", "N", dataField));
        
      }
     }
      
    String currentPOrg=CheckPointSetData.selectOrg(this, strPMA_Measure_Group_ID);
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/QualityControlReport/Time_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/QualityControlReport/Time_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Time", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmaMeasureTimeId", "", "..", "".equals("Y"), "QualityControlReport", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strMA_Measure_Time_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
      ...
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      // if (!strMA_Measure_Time_ID.equals("")) xmlDocument.setParameter("childTabContainer", tabs.childTabs(false));
	  // else xmlDocument.setParameter("childTabContainer", tabs.childTabs(true));
	  xmlDocument.setParameter("childTabContainer", tabs.childTabs(false));
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Time_Relation.html", "QualityControlReport", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Time_Relation.html", strReplaceWith);
...
comboTableData = new ComboTableData(vars, this, "19", "MA_Measure_Group_ID", "", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("maMeasureGroupId"):dataField.getField("maMeasureGroupId")));
xmlDocument.setData("reportMA_Measure_Group_ID","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
xmlDocument.setParameter("Explode_BTNname", Utility.getButtonName(this, vars, "802572", "Explode_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalExplode = org.openbravo.erpCommon.utility.Utility.isModalProcess("800114"); 
...
xmlDocument.setParameter("Updated_Format", vars.getSessionValue("#AD_SqlDateTimeFormat"));xmlDocument.setParameter("Updated_Maxlength", Integer.toString(vars.getSessionValue("#AD_SqlDateTimeFormat").length()));
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (TimeData.getCurrentDBTimestamp(this, data.maMeasureTimeId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Time. This Servlet was made by Wad constructor";
