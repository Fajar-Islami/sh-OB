...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _GL_JournalBatch_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strGL_JournalBatch_ID = _GL_JournalBatch_ID;
...
String strParamTotalCr_f = vars.getSessionValue(tabId + "|paramTotalCr_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("glJournalbatchId") == null || dataField.getField("glJournalbatchId").equals("")) {
        ...
        String strBatch_Org = ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId")));
