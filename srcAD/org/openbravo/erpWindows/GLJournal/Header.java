...
String stradTableId = "224";
  ...
  private HeaderData getEditVariables(Connection con, VariablesSecureApp vars, String strPGL_JournalBatch_ID) throws IOException,ServletException {
    ...
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.cAcctschemaId = vars.getRequestGlobalVariable("inpcAcctschemaId", windowId + "|C_AcctSchema_ID");     data.cAcctschemaIdr = vars.getStringParameter("inpcAcctschemaId_R");     data.documentno = vars.getRequiredStringParameter("inpdocumentno");     data.description = vars.getRequiredStringParameter("inpdescription");     data.cDoctypeId = vars.getRequiredGlobalVariable("inpcDoctypeId", windowId + "|C_DocType_ID");     data.cDoctypeIdr = vars.getStringParameter("inpcDoctypeId_R");     data.datedoc = vars.getRequiredGlobalVariable("inpdatedoc", windowId + "|DateDoc");     data.dateacct = vars.getRequiredGlobalVariable("inpdateacct", windowId + "|DateAcct");     data.cPeriodId = vars.getRequiredGlobalVariable("inpcPeriodId", windowId + "|C_Period_ID");     data.cPeriodIdr = vars.getStringParameter("inpcPeriodId_R");     data.cCurrencyId = vars.getRequiredGlobalVariable("inpcCurrencyId", windowId + "|C_Currency_ID");     data.cCurrencyIdr = vars.getStringParameter("inpcCurrencyId_R");     data.currencyratetype = vars.getRequiredGlobalVariable("inpcurrencyratetype", windowId + "|CurrencyRateType");    try {   data.currencyrate = vars.getRequiredNumericParameter("inpcurrencyrate", vars.getSessionValue(windowId + "|CurrencyRate"));  } catch (ServletException paramEx) { ex = paramEx; }     data.isopening = vars.getStringParameter("inpisopening", "N");    try {   data.controlamt = vars.getNumericParameter("inpcontrolamt");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.totaldr = vars.getRequiredNumericParameter("inptotaldr");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.totalcr = vars.getRequiredNumericParameter("inptotalcr");  } catch (ServletException paramEx) { ex = paramEx; }     data.docaction = vars.getRequiredStringParameter("inpdocaction");     data.posted = vars.getRequiredGlobalVariable("inpposted", windowId + "|Posted");     data.docstatus = vars.getRequiredStringParameter("inpdocstatus");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.isprinted = vars.getStringParameter("inpisprinted", "N");     data.glCategoryId = vars.getRequiredGlobalVariable("inpglCategoryId", windowId + "|GL_Category_ID");     data.isapproved = vars.getStringParameter("inpisapproved", "N");     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R");     data.mProductId = vars.getStringParameter("inpmProductId");     data.mProductIdr = vars.getStringParameter("inpmProductId_R");     data.cProjectId = vars.getStringParameter("inpcProjectId");     data.cCostcenterId = vars.getStringParameter("inpcCostcenterId");     data.aAssetId = vars.getStringParameter("inpaAssetId");     data.cCampaignId = vars.getStringParameter("inpcCampaignId");     data.user1Id = vars.getStringParameter("inpuser1Id");     data.user2Id = vars.getStringParameter("inpuser2Id");     data.glJournalId = vars.getRequestGlobalVariable("inpglJournalId", windowId + "|GL_Journal_ID");     data.glJournalbatchId = vars.getRequestGlobalVariable("inpglJournalbatchId", windowId + "|GL_JournalBatch_ID");     data.processing = vars.getStringParameter("inpprocessing");     data.postingtype = vars.getRequiredStringParameter("inppostingtype");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.processed = vars.getRequiredInputGlobalVariable("inpprocessed", windowId + "|Processed", "N"); 
      ...
      data.glJournalbatchId = vars.getGlobalVariable("inpglJournalbatchId", windowId + "|GL_JournalBatch_ID");
          ...
          vars.getGlobalVariable("inpdescription0", windowId + "|DESCRIPTION0", "");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPGL_JournalBatch_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|DateDoc", data[0].datedoc);    vars.setSessionValue(windowId + "|DateAcct", data[0].dateacct);    vars.setSessionValue(windowId + "|C_Period_ID", data[0].cPeriodId);    vars.setSessionValue(windowId + "|C_Currency_ID", data[0].cCurrencyId);    vars.setSessionValue(windowId + "|GL_Category_ID", data[0].glCategoryId);    vars.setSessionValue(windowId + "|PostingType", data[0].postingtype);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);    vars.setSessionValue(windowId + "|GL_JournalBatch_ID", data[0].glJournalbatchId);
      ...
      vars.setSessionValue(windowId + "|Batch_Org", ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId"))));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _GL_Journal_ID, String strPGL_JournalBatch_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strGL_Journal_ID = _GL_Journal_ID;
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("glJournalId") == null || dataField.getField("glJournalId").equals("")) {
        ...
        String strDESCRIPTION0 = HeaderData.selectAux12(this, strPGL_JournalBatch_ID);
    vars.setSessionValue(windowId + "|DESCRIPTION0", strDESCRIPTION0);
        String strHeaderDateAcct = ((dataField!=null)?dataField.getField("dateacct"):((data==null || data.length==0)?"":data[0].getField("dateacct")));
    vars.setSessionValue(windowId + "|HeaderDateAcct", strHeaderDateAcct);
        String strHeaderDateDoc = ((dataField!=null)?dataField.getField("datedoc"):((data==null || data.length==0)?"":data[0].getField("datedoc")));
    vars.setSessionValue(windowId + "|HeaderDateDoc", strHeaderDateDoc);
        String strgeneralLedgerCurrency = HeaderData.selectAux9F7DE5D4045A4391A93E1444C6D921C7(this, ((dataField!=null)?dataField.getField("cAcctschemaId"):((data==null || data.length==0)?"":data[0].getField("cAcctschemaId"))));
    vars.setSessionValue(windowId + "|generalLedgerCurrency", strgeneralLedgerCurrency);
        String strParent_AD_Org = ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId")));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(strPGL_JournalBatch_ID, Utility.getDefault(this, vars, "User2_ID", "", "132", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "132", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@Parent_AD_Org@", "132", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "132", "", dataField), HeaderData.selectDef1622_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "132", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "132", "", dataField), HeaderData.selectDef1624_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "132", "", dataField)), HeaderData.selectDef1625(this, Utility.getContext(this, vars, "AD_Org_ID", "132"), Utility.getContext(this, vars, "#AD_Client_ID", windowId)), Utility.getDefault(this, vars, "DocumentNo", "", "132", "", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "132", "", dataField), Utility.getDefault(this, vars, "IsPrinted", "N", "132", "N", dataField), Utility.getDefault(this, vars, "Posted", "N", "132", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "N", "132", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "N", "132", "N", dataField))), Utility.getDefault(this, vars, "Description", "@DESCRIPTION0@", "132", "", dataField), Utility.getDefault(this, vars, "PostingType", "@PostingType@", "132", "", dataField), Utility.getDefault(this, vars, "C_AcctSchema_ID", "@$C_AcctSchema_ID@", "132", "", dataField), Utility.getDefault(this, vars, "GL_Category_ID", "@GL_Category_ID@", "132", "", dataField), HeaderData.selectDef1634(this, Utility.getContext(this, vars, "C_PERIOD_ID", "132"), Utility.getContext(this, vars, "HeaderDateDoc", "132")), HeaderData.selectDef1635(this, Utility.getContext(this, vars, "C_PERIOD_ID", "132"), Utility.getContext(this, vars, "HeaderDateAcct", "132")), HeaderData.selectDef1636(this, Utility.getContext(this, vars, "C_Period_ID", "132"), Utility.getContext(this, vars, "AD_Client_ID", "132"), Utility.getContext(this, vars, "AD_Org_ID", "132"), Utility.getContext(this, vars, "DateAcct", "132"), DateTimeData.today(this)), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "132", "", dataField), Utility.getDefault(this, vars, "TotalDr", "0", "132", "0", dataField), Utility.getDefault(this, vars, "TotalCr", "0", "132", "0", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "132", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "132", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "132", "N", dataField))), Utility.getDefault(this, vars, "IsApproved", "Y", "132", "N", dataField), Utility.getDefault(this, vars, "CurrencyRateType", "S", "132", "", dataField), Utility.getDefault(this, vars, "CurrencyRate", "1", "132", "0", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "132", "", dataField), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "132", "", dataField), Utility.getDefault(this, vars, "IsOpening", "N", "132", "N", dataField), Utility.getDefault(this, vars, "ControlAmt", "", "132", "", dataField), Utility.getDefault(this, vars, "Processed", "", "132", "N", dataField), Utility.getDefault(this, vars, "Processing", "", "132", "N", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "132", "", dataField), HeaderData.selectDef6371060DDBD14FE88ABBCE2DC0EACCF8_2(this,  vars.getLanguage(), Utility.getDefault(this, vars, "M_Product_ID", "", "132", "", dataField)), Utility.getDefault(this, vars, "A_Asset_ID", "", "132", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "132", "", dataField), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "132", "", dataField), HeaderData.selectDefAA038C785DE7452199DB51FE58FE1DA6_3(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "132", "", dataField)), Utility.getDefault(this, vars, "User1_ID", "", "132", "", dataField));
    ...
    try {
      ...
      throw new ServletException(ex);
        ...
        xmlDocument.setParameter("DESCRIPTION0", strDESCRIPTION0);
