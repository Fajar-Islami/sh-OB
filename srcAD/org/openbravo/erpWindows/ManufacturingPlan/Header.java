  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if(saveRequest != null && saveRequest){
      ...
      boolean editableTab = (!org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)
        ...
        String strmrpRunProductionId = request.getParameter("inpmrpRunProductionId");
        
        if (editableTab) {
          int total = 0;
          
          if(commandType.equalsIgnoreCase("EDIT") && !strmrpRunProductionId.equals(""))
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      if (strView.equals("")) {
        ...
        if (strView.equals("EDIT")) {
          if (strMRP_Run_Production_ID.equals("")) strMRP_Run_Production_ID = firstElement(vars, tableSQL);
          if (strMRP_Run_Production_ID.equals("")) strView = "RELATION";
        }
      }
      if (strView.equals("EDIT")) 

        printPageEdit(response, request, vars, false, strMRP_Run_Production_ID, tableSQL);

      else printPageDataSheet(response, vars, strMRP_Run_Production_ID, tableSQL);
    } else if (vars.commandIn("DIRECT")) {
      String strMRP_Run_Production_ID = vars.getStringParameter("inpDirectKey");
      
        
      if (strMRP_Run_Production_ID.equals("")) strMRP_Run_Production_ID = vars.getRequiredGlobalVariable("inpmrpRunProductionId", windowId + "|MRP_Run_Production_ID");
      else vars.setSessionValue(windowId + "|MRP_Run_Production_ID", strMRP_Run_Production_ID);
      ...
      String strView = vars.getSessionValue(tabId + "|Header.view");
      String strMRP_Run_Production_ID = "";
      if (strView.equals("")) {
        strView = defaultTabView;
        if (strView.equals("EDIT")) {
          strMRP_Run_Production_ID = firstElement(vars, tableSQL);
          if (strMRP_Run_Production_ID.equals("")) strView = "RELATION";
        }
      }
      if (strView.equals("EDIT")) {
...
vars.getRequestGlobalVariable("inpParamM_Product_ID", tabId + "|paramM_Product_ID");
      ...
      vars.removeSessionValue(windowId + "|MRP_Run_Production_ID");
      String strMRP_Run_Production_ID="";
      ...
      if (strView.equals("EDIT")) {
        strMRP_Run_Production_ID = firstElement(vars, tableSQL);
        if (strMRP_Run_Production_ID.equals("")) {
      ...
      printPageDataSheet(response, vars, strMRP_Run_Production_ID, tableSQL);
      ...
      String strMRP_Run_Production_ID = vars.getRequiredStringParameter("inpmrpRunProductionId");
      
      String strNext = nextElement(vars, strMRP_Run_Production_ID, tableSQL);
      ...
      String strPrevious = previousElement(vars, strMRP_Run_Production_ID, tableSQL);
      ...
      String strMRP_Run_Production_ID = vars.getRequiredGlobalVariable("inpmrpRunProductionId", windowId + "|MRP_Run_Production_ID");
      OBError myError = new OBError();
      ...
      if (!myError.isEmpty()) {
        ...
        if (vars.commandIn("SAVE_EDIT_NEW")) response.sendRedirect(strDireccion + request.getServletPath() + "?Command=NEW");
          ...
          String strNext = nextElement(vars, strMRP_Run_Production_ID, tableSQL);
          vars.setSessionValue(windowId + "|MRP_Run_Production_ID", strNext);
          response.sendRedirect(strDireccion + request.getServletPath() + "?Command=EDIT");
        } else response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
      }
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = HeaderData.delete(this, strMRP_Run_Production_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
        ...
        vars.removeSessionValue(windowId + "|mrpRunProductionId");
        vars.setSessionValue(tabId + "|Header.view", "RELATION");
      }
      if (myError==null) {
  ...
  private HeaderData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));    vars.setSessionValue(windowId + "|MRP_Run_Production_ID", data[0].getField("mrpRunProductionId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      HeaderData[] data = HeaderData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getStringParameter("inpmrpRunProductionId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strMRP_Run_Production_ID, TableSQLData tableSQL)
...
String strParamM_Product_ID = vars.getSessionValue(tabId + "|paramM_Product_ID");
    ...
    hasSearchCondition = (tableSQL.hasInternalFilter() && ("").equals(strParamName) && ("").equals(strParamMRP_Planner_ID) && ("").equals(strParamM_Product_ID)) || !(("").equals(strParamName) || ("%").equals(strParamName))  || !(("").equals(strParamMRP_Planner_ID) || ("%").equals(strParamMRP_Planner_ID))  || !(("").equals(strParamM_Product_ID) || ("%").equals(strParamM_Product_ID)) ;
    String strOffset = vars.getSessionValue(tabId + "|offset");
    String selectedRow = "0";
    if (!strMRP_Run_Production_ID.equals("")) {
      selectedRow = Integer.toString(getKeyPosition(vars, strMRP_Run_Production_ID, tableSQL));
    }

    String[] discard={"isNotFiltered","isNotTest"};
    if (hasSearchCondition) discard[0] = new String("isFiltered");
    if (vars.getSessionValue("#ShowTest", "N").equals("Y")) discard[1] = new String("isTest");
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/ManufacturingPlan/Header_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header", false, "document.frmMain.inpmrpRunProductionId", "grid", "..", "".equals("Y"), "ManufacturingPlan", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    xmlDocument.setParameter("KeyName", "mrpRunProductionId");
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "ManufacturingPlan", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _MRP_Run_Production_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strMRP_Run_Production_ID = _MRP_Run_Production_ID;
...
String strParamM_Product_ID = vars.getSessionValue(tabId + "|paramM_Product_ID");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = HeaderData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strMRP_Run_Production_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
  
        if (!strMRP_Run_Production_ID.equals("") && (data == null || data.length==0)) {
          response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
          return;
        }
        refreshSessionEdit(vars, data);
      ...
      if (dataField.getField("mrpRunProductionId") == null || dataField.getField("mrpRunProductionId").equals("")) {
        discard[0] = new String ("editDiscard");
        strCommand = "NEW";
        boolNew = true;
      } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set("", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800096", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800096", "", dataField), "Y", Utility.getDefault(this, vars, "Createdby", "", "800096", "", dataField), HeaderData.selectDef803606_0(this, Utility.getDefault(this, vars, "Createdby", "", "800096", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "800096", "", dataField), HeaderData.selectDef803608_1(this, Utility.getDefault(this, vars, "Updatedby", "", "800096", "", dataField)), Utility.getDefault(this, vars, "Name", "", "800096", "", dataField), Utility.getDefault(this, vars, "Description", "", "800096", "", dataField), Utility.getDefault(this, vars, "DateDoc", "@#Date@", "800096", "", dataField), Utility.getDefault(this, vars, "MRP_Planner_ID", "", "800096", "", dataField), Utility.getDefault(this, vars, "M_Product_Category_ID", "", "800096", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "800096", "", dataField), HeaderData.selectDef803614_2(this,  vars.getLanguage(), Utility.getDefault(this, vars, "M_Product_ID", "", "800096", "", dataField)), Utility.getDefault(this, vars, "C_BP_Group_ID", "", "800096", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800096", "", dataField), HeaderData.selectDef803616_3(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "800096", "", dataField)), Utility.getDefault(this, vars, "Timehorizon", "", "800096", "0", dataField), Utility.getDefault(this, vars, "Securitymargin", "", "800096", "0", dataField), Utility.getDefault(this, vars, "Simulate", "N", "800096", "N", dataField), Utility.getDefault(this, vars, "Launchwr", "N", "800096", "N", dataField), Utility.getDefault(this, vars, "Launchmr", "N", "800096", "N", dataField), Utility.getDefault(this, vars, "Recalculatestock", "N", "800096", "N", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/ManufacturingPlan/Header_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/ManufacturingPlan/Header_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmrpRunProductionId", "", "..", "".equals("Y"), "ManufacturingPlan", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strMRP_Run_Production_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
      ...
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      // if (!strMRP_Run_Production_ID.equals("")) xmlDocument.setParameter("childTabContainer", tabs.childTabs(false));
	  // else xmlDocument.setParameter("childTabContainer", tabs.childTabs(true));
	  xmlDocument.setParameter("childTabContainer", tabs.childTabs(false));
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "ManufacturingPlan", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Header_Relation.html", strReplaceWith);
...
comboTableData = null;
xmlDocument.setParameter("Launchwr_BTNname", Utility.getButtonName(this, vars, "803960", "Launchwr_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalLaunchwr = org.openbravo.erpCommon.utility.Utility.isModalProcess("800160"); 
xmlDocument.setParameter("Launchwr_Modal", modalLaunchwr?"true":"false");
xmlDocument.setParameter("Launchmr_BTNname", Utility.getButtonName(this, vars, "803961", "Launchmr_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalLaunchmr = org.openbravo.erpCommon.utility.Utility.isModalProcess("800159"); 
xmlDocument.setParameter("Launchmr_Modal", modalLaunchmr?"true":"false");
xmlDocument.setParameter("Simulate_BTNname", Utility.getButtonName(this, vars, "803959", "Simulate_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalSimulate = org.openbravo.erpCommon.utility.Utility.isModalProcess("6FBD65B0FDB74D1AB07F0EADF18D48AE"); 
xmlDocument.setParameter("Simulate_Modal", modalSimulate?"true":"false");
xmlDocument.setParameter("Recalculatestock_BTNname", Utility.getButtonName(this, vars, "803962", "Recalculatestock_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalRecalculatestock = org.openbravo.erpCommon.utility.Utility.isModalProcess("800161"); 
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = SequenceIdData.getUUID();
                ...
                data.mrpRunProductionId = strSequence;  
            }
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (HeaderData.getCurrentDBTimestamp(this, data.mrpRunProductionId).equals(
        ...
        if(!myError.isEmpty()){
            ...
            vars.setSessionValue(windowId + "|MRP_Run_Production_ID", data.mrpRunProductionId);
        }
    }
    return total;
  }
