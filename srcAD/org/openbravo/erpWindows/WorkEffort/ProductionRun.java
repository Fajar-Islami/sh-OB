...
vars.getGlobalVariable("inpmProductionId", windowId + "|M_Production_ID");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPM_Production_ID) throws IOException,ServletException {
      ...
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].adOrgId);    vars.setSessionValue(windowId + "|M_Production_ID", data[0].mProductionId);    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].adClientId);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _M_ProductionPlan_ID, String strPM_Production_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
