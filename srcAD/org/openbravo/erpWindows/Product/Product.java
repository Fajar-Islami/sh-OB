  ...
  private ProductData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    data.managevariants = vars.getStringParameter("inpmanagevariants");     data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.value = vars.getRequestGlobalVariable("inpvalue", windowId + "|Value");     data.name = vars.getRequiredStringParameter("inpname");     data.adImageId = vars.getStringParameter("inpadImageId");     data.cUomId = vars.getRequiredStringParameter("inpcUomId");     data.cUomIdr = vars.getStringParameter("inpcUomId_R");     data.mProductCategoryId = vars.getRequiredStringParameter("inpmProductCategoryId");     data.mProductCategoryIdr = vars.getStringParameter("inpmProductCategoryId_R");     data.cTaxcategoryId = vars.getRequiredStringParameter("inpcTaxcategoryId");     data.cTaxcategoryIdr = vars.getStringParameter("inpcTaxcategoryId_R");     data.isgeneric = vars.getRequiredInputGlobalVariable("inpisgeneric", windowId + "|IsGeneric", "N");     data.ispurchased = vars.getStringParameter("inpispurchased", "N");     data.issold = vars.getStringParameter("inpissold", "N");     data.genericProductId = vars.getStringParameter("inpgenericProductId");     data.genericProductIdr = vars.getStringParameter("inpgenericProductId_R");     data.description = vars.getStringParameter("inpdescription");     data.producttype = vars.getRequiredGlobalVariable("inpproducttype", windowId + "|ProductType");     data.producttyper = vars.getStringParameter("inpproducttype_R");     data.isstocked = vars.getStringParameter("inpisstocked", "N");    try {   data.weight = vars.getNumericParameter("inpweight");  } catch (ServletException paramEx) { ex = paramEx; }     data.cUomWeightId = vars.getStringParameter("inpcUomWeightId");     data.cUomWeightIdr = vars.getStringParameter("inpcUomWeightId_R");     data.costtype = vars.getRequestGlobalVariable("inpcosttype", windowId + "|Costtype");     data.costtyper = vars.getStringParameter("inpcosttype_R");    try {   data.coststd = vars.getNumericParameter("inpcoststd");  } catch (ServletException paramEx) { ex = paramEx; }     data.mAttributesetId = vars.getRequestGlobalVariable("inpmAttributesetId", windowId + "|M_AttributeSet_ID");     data.mAttributesetIdr = vars.getStringParameter("inpmAttributesetId_R");     data.attrsetvaluetype = vars.getStringParameter("inpattrsetvaluetype");     data.attrsetvaluetyper = vars.getStringParameter("inpattrsetvaluetype_R");     data.mAttributesetinstanceId = vars.getRequestGlobalVariable("inpmAttributesetinstanceId", windowId + "|M_AttributeSetInstance_ID");     data.mAttributesetinstanceIdr = vars.getStringParameter("inpmAttributesetinstanceId_R");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.upc = vars.getStringParameter("inpupc");     data.mBrandId = vars.getStringParameter("inpmBrandId");     data.mBrandIdr = vars.getStringParameter("inpmBrandId_R");     data.salesrepId = vars.getStringParameter("inpsalesrepId");     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.imageurl = vars.getStringParameter("inpimageurl");     data.descriptionurl = vars.getStringParameter("inpdescriptionurl");     data.production = vars.getStringParameter("inpproduction", "N");     data.maProcessplanId = vars.getStringParameter("inpmaProcessplanId");     data.maProcessplanIdr = vars.getStringParameter("inpmaProcessplanId_R");     data.issummary = vars.getStringParameter("inpissummary", "N");     data.mLocatorId = vars.getStringParameter("inpmLocatorId");    try {   data.volume = vars.getNumericParameter("inpvolume");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.shelfwidth = vars.getNumericParameter("inpshelfwidth");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.shelfheight = vars.getNumericParameter("inpshelfheight");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.shelfdepth = vars.getNumericParameter("inpshelfdepth");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.unitsperpallet = vars.getNumericParameter("inpunitsperpallet");  } catch (ServletException paramEx) { ex = paramEx; }     data.discontinued = vars.getStringParameter("inpdiscontinued", "N");     data.discontinuedby = vars.getStringParameter("inpdiscontinuedby");     data.isbom = vars.getRequiredInputGlobalVariable("inpisbom", windowId + "|IsBOM", "N");     data.isinvoiceprintdetails = vars.getStringParameter("inpisinvoiceprintdetails", "N");     data.ispicklistprintdetails = vars.getStringParameter("inpispicklistprintdetails", "N");     data.isverified = vars.getStringParameter("inpisverified", "N");     data.processing = vars.getRequiredStringParameter("inpprocessing");     data.sExpensetypeId = vars.getStringParameter("inpsExpensetypeId");     data.isquantityvariable = vars.getStringParameter("inpisquantityvariable", "N");     data.sResourceId = vars.getStringParameter("inpsResourceId");     data.isdeferredrevenue = vars.getStringParameter("inpisdeferredrevenue", "N");     data.isdeferredexpense = vars.getStringParameter("inpisdeferredexpense", "N");     data.bookusingpoprice = vars.getStringParameter("inpbookusingpoprice", "N");     data.characteristicDesc = vars.getStringParameter("inpcharacteristicDesc");     data.revplantype = vars.getStringParameter("inprevplantype");     data.revplantyper = vars.getStringParameter("inprevplantype_R");    try {   data.periodnumber = vars.getNumericParameter("inpperiodnumber");  } catch (ServletException paramEx) { ex = paramEx; }     data.defaultperiod = vars.getStringParameter("inpdefaultperiod");     data.defaultperiodr = vars.getStringParameter("inpdefaultperiod_R");     data.expplantype = vars.getStringParameter("inpexpplantype");     data.expplantyper = vars.getStringParameter("inpexpplantype_R");    try {   data.periodnumberExp = vars.getNumericParameter("inpperiodnumberExp");  } catch (ServletException paramEx) { ex = paramEx; }     data.defaultperiodExp = vars.getStringParameter("inpdefaultperiodExp");     data.defaultperiodExpr = vars.getStringParameter("inpdefaultperiodExp_R");     data.calculated = vars.getStringParameter("inpcalculated", "N");    try {   data.capacity = vars.getNumericParameter("inpcapacity");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.delaymin = vars.getNumericParameter("inpdelaymin");  } catch (ServletException paramEx) { ex = paramEx; }     data.mrpPlannerId = vars.getStringParameter("inpmrpPlannerId");     data.mrpPlanningmethodId = vars.getStringParameter("inpmrpPlanningmethodId");    try {   data.qtymax = vars.getNumericParameter("inpqtymax");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.qtymin = vars.getNumericParameter("inpqtymin");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.qtystd = vars.getNumericParameter("inpqtystd");  } catch (ServletException paramEx) { ex = paramEx; }     data.qtytype = vars.getStringParameter("inpqtytype", "N");    try {   data.stockmin = vars.getNumericParameter("inpstockmin");  } catch (ServletException paramEx) { ex = paramEx; }     data.createvariants = vars.getStringParameter("inpcreatevariants");     data.updateinvariants = vars.getStringParameter("inpupdateinvariants");     data.islinkedtoproduct = vars.getStringParameter("inpislinkedtoproduct", "N");     data.prodCatSelection = vars.getRequestGlobalVariable("inpprodCatSelection", windowId + "|Prod_Cat_Selection");     data.prodCatSelectionr = vars.getStringParameter("inpprodCatSelection_R");     data.productSelection = vars.getRequestGlobalVariable("inpproductSelection", windowId + "|Product_Selection");     data.productSelectionr = vars.getStringParameter("inpproductSelection_R");     data.returnable = vars.getStringParameter("inpreturnable", "N");    try {   data.overdueReturnDays = vars.getNumericParameter("inpoverdueReturnDays");  } catch (ServletException paramEx) { ex = paramEx; }     data.ispricerulebased = vars.getRequiredInputGlobalVariable("inpispricerulebased", windowId + "|Ispricerulebased", "N");     data.quantityRule = vars.getStringParameter("inpquantityRule");     data.quantityRuler = vars.getStringParameter("inpquantityRule_R");     data.uniquePerDocument = vars.getStringParameter("inpuniquePerDocument", "N");     data.printDescription = vars.getStringParameter("inpprintDescription", "N");     data.relateprodcattoservice = vars.getStringParameter("inprelateprodcattoservice");     data.relateprodtoservice = vars.getStringParameter("inprelateprodtoservice");     data.allowDeferredSell = vars.getStringParameter("inpallowDeferredSell", "N");    try {   data.deferredSellMaxDays = vars.getNumericParameter("inpdeferredSellMaxDays");  } catch (ServletException paramEx) { ex = paramEx; }     data.downloadurl = vars.getStringParameter("inpdownloadurl");     data.mFreightcategoryId = vars.getStringParameter("inpmFreightcategoryId");     data.ispriceprinted = vars.getStringParameter("inpispriceprinted", "N");     data.name2 = vars.getStringParameter("inpname2");    try {   data.stockMin = vars.getNumericParameter("inpstockMin");  } catch (ServletException paramEx) { ex = paramEx; }     data.enforceAttribute = vars.getStringParameter("inpenforceAttribute", "N");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.versionno = vars.getStringParameter("inpversionno");     data.mProductId = vars.getRequestGlobalVariable("inpmProductId", windowId + "|M_Product_ID");     data.help = vars.getStringParameter("inphelp");     data.documentnote = vars.getStringParameter("inpdocumentnote");     data.classification = vars.getStringParameter("inpclassification");    try {   data.guaranteedays = vars.getNumericParameter("inpguaranteedays");  } catch (ServletException paramEx) { ex = paramEx; }     data.sku = vars.getStringParameter("inpsku"); 
      ...
      data.updatedTimeStamp = vars.getStringParameter("updatedTimestamp");
          ...
          vars.getGlobalVariable("inphasinvariants", windowId + "|HasInvariants", "");
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _M_Product_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strM_Product_ID = _M_Product_ID;
...
String strParamC_TaxCategory_ID = vars.getSessionValue(tabId + "|paramC_TaxCategory_ID");
    ...
    vars.setSessionValue(windowId + "|M_WAREHOUSE_ID", strM_WAREHOUSE_ID);
        String strProduct_Org = ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId")));
    vars.setSessionValue(windowId + "|Product_Org", strProduct_Org);
        String strHasInvariants = ProductData.selectAuxE63B6F9E7F2849D8837B8CD083A35597(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|HasInvariants", strHasInvariants);
    
    
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        refreshSessionNew(vars);
        data = ProductData.set("", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "140", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "140", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "140", "", dataField), ProductData.selectDef1407_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "140", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "140", "", dataField), ProductData.selectDef1409_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "140", "", dataField)), Utility.getDefault(this, vars, "Name", "", "140", "", dataField), Utility.getDefault(this, vars, "Description", "", "140", "", dataField), Utility.getDefault(this, vars, "IsSummary", "", "140", "N", dataField), Utility.getDefault(this, vars, "C_UOM_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "IsStocked", "Y", "140", "N", dataField), Utility.getDefault(this, vars, "IsPurchased", "Y", "140", "N", dataField), Utility.getDefault(this, vars, "IsSold", "Y", "140", "N", dataField), Utility.getDefault(this, vars, "Volume", "", "140", "", dataField), Utility.getDefault(this, vars, "Weight", "", "140", "", dataField), Utility.getDefault(this, vars, "Revplantype", "", "140", "", dataField), Utility.getDefault(this, vars, "Quantity_Rule", "", "140", "", dataField), Utility.getDefault(this, vars, "Value", "", "140", "", dataField), ProductData.selectDef2012(this, Utility.getContext(this, vars, "AD_ORG_ID", "140"), Utility.getContext(this, vars, "#AD_CLIENT_ID", windowId)), Utility.getDefault(this, vars, "C_TaxCategory_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "UPC", "", "140", "", dataField), Utility.getDefault(this, vars, "SKU", "", "140", "", dataField), Utility.getDefault(this, vars, "ShelfWidth", "", "140", "", dataField), Utility.getDefault(this, vars, "ShelfHeight", "", "140", "", dataField), Utility.getDefault(this, vars, "ShelfDepth", "", "140", "", dataField), Utility.getDefault(this, vars, "UnitsPerPallet", "", "140", "", dataField), Utility.getDefault(this, vars, "Discontinued", "", "140", "N", dataField), Utility.getDefault(this, vars, "DiscontinuedBy", "", "140", "", dataField), Utility.getDefault(this, vars, "DefaultPeriod", "", "140", "", dataField), Utility.getDefault(this, vars, "Allow_Deferred_Sell", "N", "140", "N", dataField), Utility.getDefault(this, vars, "Relateprodtoservice", "", "140", "N", dataField), Utility.getDefault(this, vars, "DocumentNote", "", "140", "", dataField), Utility.getDefault(this, vars, "Help", "", "140", "", dataField), Utility.getDefault(this, vars, "Classification", "", "140", "", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "Bookusingpoprice", "N", "140", "N", dataField), Utility.getDefault(this, vars, "IsBOM", "N", "140", "N", dataField), Utility.getDefault(this, vars, "IsInvoicePrintDetails", "", "140", "N", dataField), Utility.getDefault(this, vars, "IsPickListPrintDetails", "", "140", "N", dataField), Utility.getDefault(this, vars, "IsVerified", "N", "140", "N", dataField), Utility.getDefault(this, vars, "Processing", "N", "140", "N", dataField), Utility.getDefault(this, vars, "Islinkedtoproduct", "N", "140", "N", dataField), Utility.getDefault(this, vars, "Capacity", "", "140", "", dataField), Utility.getDefault(this, vars, "Delaymin", "", "140", "", dataField), Utility.getDefault(this, vars, "MRP_Planner_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "MRP_Planningmethod_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "Qtymax", "", "140", "", dataField), Utility.getDefault(this, vars, "Qtymin", "", "140", "", dataField), Utility.getDefault(this, vars, "Qtystd", "", "140", "", dataField), Utility.getDefault(this, vars, "Qtytype", "", "140", "N", dataField), Utility.getDefault(this, vars, "Stockmin", "", "140", "", dataField), Utility.getDefault(this, vars, "Product_Selection", "", "140", "", dataField), Utility.getDefault(this, vars, "Unique_Per_Document", "N", "140", "N", dataField), Utility.getDefault(this, vars, "Overdue_Return_Days", "", "140", "", dataField), Utility.getDefault(this, vars, "Relateprodcattoservice", "", "140", "N", dataField), Utility.getDefault(this, vars, "S_ExpenseType_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "S_Resource_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "Ispricerulebased", "N", "140", "N", dataField), Utility.getDefault(this, vars, "ProductType", "I", "140", "", dataField), Utility.getDefault(this, vars, "ImageURL", "", "140", "", dataField), Utility.getDefault(this, vars, "DescriptionURL", "", "140", "", dataField), Utility.getDefault(this, vars, "VersionNo", "", "140", "", dataField), Utility.getDefault(this, vars, "GuaranteeDays", "", "140", "", dataField), Utility.getDefault(this, vars, "Deferred_Sell_Max_Days", "", "140", "", dataField), Utility.getDefault(this, vars, "Attrsetvaluetype", "", "140", "", dataField), Utility.getDefault(this, vars, "AD_Image_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "Ispriceprinted", "Y", "140", "N", dataField), Utility.getDefault(this, vars, "Name2", "", "140", "", dataField), Utility.getDefault(this, vars, "Costtype", "", "140", "", dataField), Utility.getDefault(this, vars, "Coststd", "", "140", "", dataField), Utility.getDefault(this, vars, "Stock_Min", "", "140", "", dataField), Utility.getDefault(this, vars, "Enforce_Attribute", "N", "140", "N", dataField), Utility.getDefault(this, vars, "Calculated", "", "140", "N", dataField), Utility.getDefault(this, vars, "MA_Processplan_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "Production", "", "140", "N", dataField), Utility.getDefault(this, vars, "Isdeferredrevenue", "N", "140", "N", dataField), Utility.getDefault(this, vars, "M_AttributeSet_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "140", "", dataField), ProductData.selectDef8418_2(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "140", "", dataField)), Utility.getDefault(this, vars, "DownloadURL", "", "140", "", dataField), Utility.getDefault(this, vars, "M_FreightCategory_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "M_Locator_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "Isdeferredexpense", "N", "140", "N", dataField), Utility.getDefault(this, vars, "Print_Description", "N", "140", "N", dataField), Utility.getDefault(this, vars, "Prod_Cat_Selection", "", "140", "", dataField), Utility.getDefault(this, vars, "DefaultPeriod_Exp", "", "140", "", dataField), Utility.getDefault(this, vars, "Expplantype", "", "140", "", dataField), Utility.getDefault(this, vars, "Periodnumber_Exp", "", "140", "", dataField), Utility.getDefault(this, vars, "Updateinvariants", "", "140", "N", dataField), Utility.getDefault(this, vars, "Returnable", "Y", "140", "N", dataField), Utility.getDefault(this, vars, "M_Brand_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "IsGeneric", "N", "140", "N", dataField), Utility.getDefault(this, vars, "Generic_Product_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "CreateVariants", "", "140", "N", dataField), Utility.getDefault(this, vars, "Characteristic_Desc", "", "140", "", dataField), Utility.getDefault(this, vars, "ManageVariants", "N", "140", "N", dataField), Utility.getDefault(this, vars, "C_Uom_Weight_ID", "", "140", "", dataField), Utility.getDefault(this, vars, "Isquantityvariable", "N", "140", "N", dataField), Utility.getDefault(this, vars, "Periodnumber", "", "140", "", dataField));
    ...
    try {
      ...
      throw new ServletException(ex);
        ...
        xmlDocument.setParameter("HasInvariants", strHasInvariants);
...
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "18", "Generic_Product_ID", "84ECA724EF074F679DFD69556C6DAF21", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("genericProductId"):dataField.getField("genericProductId")));
xmlDocument.setData("reportGeneric_Product_ID","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
...
xmlDocument.setParameter("CreateVariants_BTNname", Utility.getButtonName(this, vars, "DA25E4835891E0B5E040007F01001FA0", "CreateVariants_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalCreateVariants = org.openbravo.erpCommon.utility.Utility.isModalProcess("3C386BC12832466790E50F2F8C5EBD85"); 
xmlDocument.setParameter("CreateVariants_Modal", modalCreateVariants?"true":"false");
xmlDocument.setParameter("Updateinvariants_BTNname", Utility.getButtonName(this, vars, "9692D614473D43848E449FED6786A7D0", "Updateinvariants_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalUpdateinvariants = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("Updateinvariants_Modal", modalUpdateinvariants?"true":"false");
comboTableData = new ComboTableData(vars, this, "17", "Prod_Cat_Selection", "800029", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("prodCatSelection"):dataField.getField("prodCatSelection")));
xmlDocument.setData("reportProd_Cat_Selection","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "17", "Product_Selection", "800029", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("productSelection"):dataField.getField("productSelection")));
xmlDocument.setData("reportProduct_Selection","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "17", "Quantity_Rule", "4E07601C34764669B75FCA1808F55B57", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("quantityRule"):dataField.getField("quantityRule")));
xmlDocument.setData("reportQuantity_Rule","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
xmlDocument.setParameter("Relateprodcattoservice_BTNname", Utility.getButtonName(this, vars, "AF32AFAECE844C3F91893AF6DC4F4111", "Relateprodcattoservice_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalRelateprodcattoservice = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("Relateprodcattoservice_Modal", modalRelateprodcattoservice?"true":"false");
xmlDocument.setParameter("Relateprodtoservice_BTNname", Utility.getButtonName(this, vars, "F4B0776AF8CA411192380177637389C4", "Relateprodtoservice_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalRelateprodtoservice = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
...
xmlDocument.setParameter("buttonStock_Min", Utility.messageBD(this, "Calc", vars.getLanguage()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private String getDisplayLogicContext(VariablesSecureApp vars, boolean isNew) throws IOException, ServletException {
      ...
      String result = "var strHideManageVariantsButton=\"" +Utility.getContext(this, vars, "HideManageVariantsButton", windowId) + "\";\nvar strCost_Eng_Ins_Migrated=\"" +Utility.getContext(this, vars, "Cost_Eng_Ins_Migrated", windowId) + "\";\nvar strshowMRPandProductionFields=\"" +Utility.getContext(this, vars, "showMRPandProductionFields", windowId) + "\";\nvar strHideCreateVariantsButton=\"" +Utility.getContext(this, vars, "HideCreateVariantsButton", windowId) + "\";\nvar strShowAudit=\"" +(isNew?"N":Utility.getContext(this, vars, "ShowAudit", windowId)) + "\";\n";
      return result;
    }
