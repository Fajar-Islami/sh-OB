...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("cOrderId") == null || dataField.getField("cOrderId").equals("")) {
        ...
        String strDOCBASETYPE = HeaderData.selectAux056333746538425CB0718F8AF9E458E5(this, ((dataField!=null)?dataField.getField("cDoctypetargetId"):((data==null || data.length==0)?"":data[0].getField("cDoctypetargetId"))));
