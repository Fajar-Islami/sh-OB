...
public class Requisition extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strView = vars.getSessionValue(tabId + "|Requisition.view");
      if (strView.equals("")) {
      ...
      vars.setSessionValue(tabId + "|Requisition.view", "EDIT");
...
vars.getRequestGlobalVariable("inpParamDocStatus", tabId + "|paramDocStatus");
      ...
      if (strView.equals("EDIT")) {
        ...
        if (strM_Requisition_ID.equals("")) {
          ...
          vars.setSessionValue(tabId + "|Requisition.view", strView);
        }
      }
      ...
      String strM_Requisition_ID = vars.getGlobalVariable("inpmRequisitionId", windowId + "|M_Requisition_ID", "");
      vars.setSessionValue(tabId + "|Requisition.view", "RELATION");
      ...
      vars.setSessionValue(tabId + "|Requisition.initRecordNumber", "0");
      response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
    } else if (vars.commandIn("PREVIOUS_RELATION")) {

      String strInitRecord = vars.getSessionValue(tabId + "|Requisition.initRecordNumber");
      ...
      if (strInitRecord.equals("") || strInitRecord.equals("0")) {
        ...
        vars.setSessionValue(tabId + "|Requisition.initRecordNumber", strInitRecord);
      }
      vars.removeSessionValue(windowId + "|M_Requisition_ID");
      ...
      String strM_Requisition_ID = vars.getRequiredStringParameter("inpmRequisitionId");
      //RequisitionData data = getEditVariables(vars);
      int total = 0;
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = RequisitionData.delete(this, strM_Requisition_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
...
String stradTableId = "800212";
  ...
  private RequisitionData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      RequisitionData[] data = RequisitionData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "#AD_User_ID", windowId), vars.getStringParameter("inpmRequisitionId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
...
String strParamDocStatus = vars.getSessionValue(tabId + "|paramDocStatus");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Requisition/Requisition_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Requisition", false, "document.frmMain.inpmRequisitionId", "grid", "../RptM_Requisition.pdf", "N".equals("Y"), "Requisition", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Requisition_Relation.html", "Requisition", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Requisition_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _M_Requisition_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strM_Requisition_ID = _M_Requisition_ID;
...
String strParamDocStatus = vars.getSessionValue(tabId + "|paramDocStatus");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = RequisitionData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), Utility.getContext(this, vars, "#AD_User_ID", windowId), strM_Requisition_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = RequisitionData.set(Utility.getDefault(this, vars, "Createpo", "N", "800092", "N", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "800092", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "800092", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "800092", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "800092", "N", dataField))), Utility.getDefault(this, vars, "Processed", "N", "800092", "N", dataField), Utility.getDefault(this, vars, "AD_User_ID", "@#AD_User_ID@", "800092", "", dataField), Utility.getDefault(this, vars, "Processing", "N", "800092", "N", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "800092", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "800092", "", dataField), "Y", Utility.getDefault(this, vars, "Createdby", "", "800092", "", dataField), RequisitionData.selectDef803534_0(this, Utility.getDefault(this, vars, "Createdby", "", "800092", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "800092", "", dataField), RequisitionData.selectDef803536_1(this, Utility.getDefault(this, vars, "Updatedby", "", "800092", "", dataField)), Utility.getDefault(this, vars, "Description", "", "800092", "", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "800092", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "800092", "", dataField), RequisitionData.selectDef803539_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "800092", "", dataField)), Utility.getDefault(this, vars, "M_PriceList_ID", "", "800092", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "800092", "", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Requisition/Requisition_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/Requisition/Requisition_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Requisition", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmRequisitionId", "", "../RptM_Requisition.pdf", "N".equals("Y"), "Requisition", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_Requisition_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Requisition_Relation.html", "Requisition", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Requisition_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("array", dact.toString());
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (RequisitionData.getCurrentDBTimestamp(this, data.mRequisitionId).equals(
  ...
  public String getServletInfo() {
    return "Servlet Requisition. This Servlet was made by Wad constructor";
