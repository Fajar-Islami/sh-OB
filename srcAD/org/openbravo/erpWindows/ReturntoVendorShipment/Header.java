...
public class Header extends HttpSecureAppServlet {
  ...
  private static final String windowId = "273673D2ED914C399A6C51DB758BE0F9";
  private static final String tabId = "728DBD16A1F14A4D82335E37BA433E33";
...
String stradTableId = "319";
  ...
  private HeaderData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    try {
    data.rmShipmentPickedit = vars.getStringParameter("inprmShipmentPickedit");     data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.cDoctypeId = vars.getRequiredStringParameter("inpcDoctypeId");     data.cDoctypeIdr = vars.getStringParameter("inpcDoctypeId_R");     data.mConditionGoodsId = vars.getStringParameter("inpmConditionGoodsId");     data.documentno = vars.getRequiredStringParameter("inpdocumentno");     data.poreference = vars.getStringParameter("inpporeference");     data.cBpartnerId = vars.getRequiredGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R");     data.cBpartnerLocationId = vars.getRequiredStringParameter("inpcBpartnerLocationId");     data.cBpartnerLocationIdr = vars.getStringParameter("inpcBpartnerLocationId_R");     data.movementdate = vars.getRequiredStringParameter("inpmovementdate");     data.dateacct = vars.getRequiredStringParameter("inpdateacct");     data.mWarehouseId = vars.getRequiredGlobalVariable("inpmWarehouseId", windowId + "|M_Warehouse_ID");     data.cOrderId = vars.getStringParameter("inpcOrderId");     data.description = vars.getStringParameter("inpdescription");     data.docstatus = vars.getRequiredGlobalVariable("inpdocstatus", windowId + "|DocStatus");     data.adUserId = vars.getStringParameter("inpadUserId");     data.createfrom = vars.getStringParameter("inpcreatefrom");     data.generateto = vars.getStringParameter("inpgenerateto");     data.docaction = vars.getRequiredStringParameter("inpdocaction");     data.posted = vars.getRequiredGlobalVariable("inpposted", windowId + "|Posted");     data.salesrepId = vars.getStringParameter("inpsalesrepId");     data.cChargeId = vars.getStringParameter("inpcChargeId");    try {   data.chargeamt = vars.getNumericParameter("inpchargeamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.deliveryrule = vars.getRequiredStringParameter("inpdeliveryrule");     data.deliveryviarule = vars.getRequiredStringParameter("inpdeliveryviarule");    try {   data.freightamt = vars.getNumericParameter("inpfreightamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.freightcostrule = vars.getRequiredStringParameter("inpfreightcostrule");     data.priorityrule = vars.getRequiredStringParameter("inppriorityrule");     data.movementtype = vars.getRequiredStringParameter("inpmovementtype");     data.mShipperId = vars.getStringParameter("inpmShipperId");    try {   data.nopackages = vars.getNumericParameter("inpnopackages");  } catch (ServletException paramEx) { ex = paramEx; }     data.mFreightcategoryId = vars.getStringParameter("inpmFreightcategoryId");     data.calculateFreight = vars.getStringParameter("inpcalculateFreight");     data.freightCurrencyId = vars.getRequestGlobalVariable("inpfreightCurrencyId", windowId + "|Freight_Currency_ID");     data.cProjectId = vars.getStringParameter("inpcProjectId");     data.cProjectIdr = vars.getStringParameter("inpcProjectId_R");     data.cActivityId = vars.getStringParameter("inpcActivityId");     data.cCampaignId = vars.getStringParameter("inpcCampaignId");     data.adOrgtrxId = vars.getStringParameter("inpadOrgtrxId");     data.user1Id = vars.getStringParameter("inpuser1Id");     data.user2Id = vars.getStringParameter("inpuser2Id");     data.dateordered = vars.getStringParameter("inpdateordered");     data.cInvoiceId = vars.getStringParameter("inpcInvoiceId");     data.trackingno = vars.getStringParameter("inptrackingno");     data.pickdate = vars.getStringParameter("inppickdate");     data.rmReceiptPickedit = vars.getStringParameter("inprmReceiptPickedit");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.generatelines = vars.getStringParameter("inpgeneratelines");     data.processing = vars.getStringParameter("inpprocessing", "N");     data.shipdate = vars.getStringParameter("inpshipdate");     data.dateprinted = vars.getStringParameter("inpdateprinted");     data.processed = vars.getStringParameter("inpprocessed", "N");     data.mInoutId = vars.getRequestGlobalVariable("inpmInoutId", windowId + "|M_InOut_ID");     data.islogistic = vars.getStringParameter("inpislogistic", "N");     data.updatelines = vars.getStringParameter("inpupdatelines");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.isprinted = vars.getStringParameter("inpisprinted", "N");     data.deliveryLocationId = vars.getStringParameter("inpdeliveryLocationId");     data.issotrx = vars.getRequiredInputGlobalVariable("inpissotrx", windowId + "|IsSOTrx", "N"); 
...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    hasSearchCondition = (tableSQL.hasInternalFilter() && ("").equals(strParamDocumentNo) && ("").equals(strParamMovementDate) && ("").equals(strParamC_BPartner_ID) && ("").equals(strParamAD_Org_ID) && ("").equals(strParamPOReference) && ("").equals(strParamM_Warehouse_ID) && ("").equals(strParamDocStatus) && ("").equals(strParamMovementDate_f)) || !(("").equals(strParamDocumentNo) || ("%").equals(strParamDocumentNo))  || !(("").equals(strParamMovementDate) || ("%").equals(strParamMovementDate))  || !(("").equals(strParamC_BPartner_ID) || ("%").equals(strParamC_BPartner_ID))  || !(("").equals(strParamAD_Org_ID) || ("%").equals(strParamAD_Org_ID))  || !(("").equals(strParamPOReference) || ("%").equals(strParamPOReference))  || !(("").equals(strParamM_Warehouse_ID) || ("%").equals(strParamM_Warehouse_ID))  || !(("").equals(strParamDocStatus) || ("%").equals(strParamDocStatus))  || !(("").equals(strParamMovementDate_f) || ("%").equals(strParamMovementDate_f)) ;
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/ReturntoVendorShipment/Header_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header", false, "document.frmMain.inpmInoutId", "grid", "../shipments/print.html", "N".equals("Y"), "ReturntoVendorShipment", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "ReturntoVendorShipment", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "Freight_Currency_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "Description", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "MovementType", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "MovementDate", "@#Date@", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "Processed", "", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField), Utility.getDefault(this, vars, "Processing", "", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), HeaderData.selectDef3526_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), HeaderData.selectDef3528_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField)), Utility.getDefault(this, vars, "IsSOTrx", "@IsSOTrx@", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "C_DocType_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "IsPrinted", "", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), HeaderData.selectDef3795_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField)), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "POReference", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "DeliveryRule", "A", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "FreightCostRule", "I", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "FreightAmt", "0", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "DeliveryViaRule", "P", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "PriorityRule", "5", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "DatePrinted", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "C_Order_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "M_Condition_Goods_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "DateOrdered", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField))), Utility.getDefault(this, vars, "CreateFrom", "", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField), Utility.getDefault(this, vars, "GenerateTo", "", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField), Utility.getDefault(this, vars, "C_Invoice_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "Posted", "", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField))), Utility.getDefault(this, vars, "UpdateLines", "N", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField), Utility.getDefault(this, vars, "Islogistic", "@ISLOGISTICAUX@", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField), Utility.getDefault(this, vars, "GenerateLines", "N", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField), Utility.getDefault(this, vars, "Delivery_Location_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "M_FreightCategory_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "Calculate_Freight", "", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "PickDate", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "TrackingNo", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "NoPackages", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "ShipDate", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), HeaderData.selectDef9585_3(this, Utility.getDefault(this, vars, "C_Project_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField)), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "273673D2ED914C399A6C51DB758BE0F9", "", dataField), Utility.getDefault(this, vars, "RM_Receipt_PickEdit", "", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField), Utility.getDefault(this, vars, "RM_Shipment_Pickedit", "", "273673D2ED914C399A6C51DB758BE0F9", "N", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/ReturntoVendorShipment/Header_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/ReturntoVendorShipment/Header_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmInoutId", "", "../shipments/print.html", "N".equals("Y"), "ReturntoVendorShipment", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_InOut_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "ReturntoVendorShipment", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Header_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("RM_Shipment_Pickedit_BTNname", Utility.getButtonName(this, vars, "B151562D2395E05CE040007F010034F9", "RM_Shipment_Pickedit_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalRM_Shipment_Pickedit = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("RM_Shipment_Pickedit_Modal", modalRM_Shipment_Pickedit?"true":"false");
String userOrgList = "";
if (editableTab) 
