...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("cOrderId") == null || dataField.getField("cOrderId").equals("")) {
        ...
        String strOriginalOrderInvoiced = HeaderData.selectAux15881B450C7B49BE863EB74EA921E3A1(this, ((dataField!=null)?dataField.getField("cOrderId"):((data==null || data.length==0)?"":data[0].getField("cOrderId"))));
    ...
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strORDERTYPE = HeaderData.selectAux2D63067CABB647F08A0EBE14281A4DB8(this, ((dataField!=null)?dataField.getField("cOrderId"):((data==null || data.length==0)?"":data[0].getField("cOrderId"))));
    vars.setSessionValue(windowId + "|ORDERTYPE", strORDERTYPE);
        String strorphanlinesnumber = HeaderData.selectAux66407108B92F49CBB40135E149FC3B46(this, ((dataField!=null)?dataField.getField("cOrderId"):((data==null || data.length==0)?"":data[0].getField("cOrderId"))));
    vars.setSessionValue(windowId + "|orphanlinesnumber", strorphanlinesnumber);
        String strPendingToInvoice = HeaderData.selectAux73DECB6E080A4D44AD634276A3C895DE(this, ((dataField!=null)?dataField.getField("cOrderId"):((data==null || data.length==0)?"":data[0].getField("cOrderId"))));
