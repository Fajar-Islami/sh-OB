...
String strParamPaymentdate_f = vars.getSessionValue(tabId + "|paramPaymentdate_f");
    ...
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strFinancialAccountCurrencyId = HeaderData.selectAux40289DEF2E1E98E4012E1EE6C6CD002E(this, ((dataField!=null)?dataField.getField("finFinancialAccountId"):((data==null || data.length==0)?"":data[0].getField("finFinancialAccountId"))));
    ...
    vars.setSessionValue(windowId + "|FIN_ISRECEIPT", strFIN_ISRECEIPT);
        String strIsMultiCurrencyEnabled = HeaderData.selectAuxFF8080812E26BF58012E27DC86DE016C(this, ((dataField!=null)?dataField.getField("finFinancialAccountId"):((data==null || data.length==0)?"":data[0].getField("finFinancialAccountId"))), ((dataField!=null)?dataField.getField("finPaymentmethodId"):((data==null || data.length==0)?"":data[0].getField("finPaymentmethodId"))));
...
xmlDocument.setParameter("EM_Aprm_Add_Scheduledpayments_BTNname", Utility.getButtonName(this, vars, "80D55E34FCEE37C9E040007F01001C25", "EM_Aprm_Add_Scheduledpayments_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Aprm_Add_Scheduledpayments = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
