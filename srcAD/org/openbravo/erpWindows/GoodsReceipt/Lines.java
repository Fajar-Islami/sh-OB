...
vars.getGlobalVariable("inpmInoutId", windowId + "|M_InOut_ID");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPM_InOut_ID) throws IOException,ServletException {
      ...
      vars.setSessionValue(windowId + "|HAS_M_INOUTLINES", HeaderData.selectAux9655D5D7E29B4B2C80DF63CBB011148D(this, strPM_InOut_ID));
...
String strParamMovementQty_f = vars.getSessionValue(tabId + "|paramMovementQty_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("mInoutlineId") == null || dataField.getField("mInoutlineId").equals("")) {
        ...
        String strHASSECONDUOM = LinesData.selectAux800005(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    vars.setSessionValue(windowId + "|C_BPARTNER_ID", strC_BPARTNER_ID);
        String strIsStocked = LinesData.selectAux0AD5488DC1E74A3997B8D9D6C5E16841(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|IsStocked", strIsStocked);
        String strisBOM = LinesData.selectAux24824516BC4A40CB8E81F52301EF5F8E(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    vars.setSessionValue(windowId + "|Posted", strPosted);
        String strATTRIBUTESET = LinesData.selectAux52BCE83D589C498B9803D32847553A8D(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    vars.setSessionValue(windowId + "|M_Warehouse_ID", strM_Warehouse_ID);
        String strOnHandLocatorDefault = LinesData.selectAux8CE0EE9876AB46108C71DC94FE330EA4(this, strPM_InOut_ID);
    ...
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strATTRSETVALUETYPE = LinesData.selectAuxB1CA1E7F4D9547F7B0317146C1742F88(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPM_InOut_ID, Utility.getDefault(this, vars, "A_Asset_ID", "", "184", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "184", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "184", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "184", "", dataField), LinesData.selectDef3534_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "184", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "184", "", dataField), LinesData.selectDef3536_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "184", "", dataField)), Utility.getDefault(this, vars, "M_Locator_ID", "@OnHandLocatorDefault@", "184", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "184", "", dataField), LinesData.selectDef3539_2(this,  vars.getLanguage(), Utility.getDefault(this, vars, "M_Product_ID", "", "184", "", dataField)), Utility.getDefault(this, vars, "MovementQty", "0", "184", "0", dataField), Utility.getDefault(this, vars, "Description", "", "184", "", dataField), Utility.getDefault(this, vars, "M_Condition_Goods_ID", "", "184", "", dataField), LinesData.selectDef3810(this, strPM_InOut_ID), Utility.getDefault(this, vars, "C_OrderLine_ID", "", "184", "", dataField), LinesData.selectDef3811_3(this, Utility.getDefault(this, vars, "C_OrderLine_ID", "", "184", "", dataField)), Utility.getDefault(this, vars, "C_UOM_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "IsInvoiced", "", "184", "N", dataField), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "Aumqty", "", "184", "", dataField), Utility.getDefault(this, vars, "C_Aum", "", "184", "", dataField), Utility.getDefault(this, vars, "Explode", "N", "184", "N", dataField), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "184", "", dataField), Utility.getDefault(this, vars, "QuantityOrder", "", "184", "", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "184", "", dataField), LinesData.selectDef8772_4(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "184", "", dataField)), Utility.getDefault(this, vars, "IsDescription", "N", "184", "N", dataField), Utility.getDefault(this, vars, "User2_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "Canceled_Inoutline_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "184", "", dataField), LinesData.selectDefBD1602011B5E4AD1B5DD85E8E9017B11_5(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "184", "", dataField)), Utility.getDefault(this, vars, "Manage_Prereservation", "", "184", "N", dataField), Utility.getDefault(this, vars, "BOM_Parent_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "184", "", dataField), LinesData.selectDefF12044E4570546E18AF6834B00961F8E_6(this, Utility.getDefault(this, vars, "C_Project_ID", "", "184", "", dataField)));
