  ...
  private HeaderData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.documentno = vars.getRequiredStringParameter("inpdocumentno");     data.mConditionGoodsId = vars.getStringParameter("inpmConditionGoodsId");     data.cDoctypeId = vars.getRequiredStringParameter("inpcDoctypeId");     data.cDoctypeIdr = vars.getStringParameter("inpcDoctypeId_R");     data.mWarehouseId = vars.getRequiredGlobalVariable("inpmWarehouseId", windowId + "|M_Warehouse_ID");     data.cBpartnerId = vars.getRequiredGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R");     data.cBpartnerLocationId = vars.getRequiredStringParameter("inpcBpartnerLocationId");     data.cBpartnerLocationIdr = vars.getStringParameter("inpcBpartnerLocationId_R");     data.movementdate = vars.getRequiredStringParameter("inpmovementdate");     data.dateacct = vars.getRequiredStringParameter("inpdateacct");     data.cOrderId = vars.getStringParameter("inpcOrderId");     data.cOrderIdr = vars.getStringParameter("inpcOrderId_R");     data.poreference = vars.getStringParameter("inpporeference");     data.description = vars.getStringParameter("inpdescription");     data.docstatus = vars.getRequiredGlobalVariable("inpdocstatus", windowId + "|DocStatus");     data.adUserId = vars.getStringParameter("inpadUserId");     data.createfrom = vars.getStringParameter("inpcreatefrom");     data.generateto = vars.getStringParameter("inpgenerateto");     data.processGoodsJava = vars.getStringParameter("inpprocessGoodsJava");     data.docaction = vars.getRequiredStringParameter("inpdocaction");     data.posted = vars.getRequiredGlobalVariable("inpposted", windowId + "|Posted");     data.salesrepId = vars.getStringParameter("inpsalesrepId");     data.cChargeId = vars.getStringParameter("inpcChargeId");    try {   data.chargeamt = vars.getNumericParameter("inpchargeamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.deliveryrule = vars.getRequiredStringParameter("inpdeliveryrule");     data.deliveryviarule = vars.getRequiredStringParameter("inpdeliveryviarule");    try {   data.freightamt = vars.getNumericParameter("inpfreightamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.freightcostrule = vars.getRequiredStringParameter("inpfreightcostrule");     data.priorityrule = vars.getRequiredStringParameter("inppriorityrule");     data.movementtype = vars.getRequiredStringParameter("inpmovementtype");     data.mShipperId = vars.getStringParameter("inpmShipperId");    try {   data.nopackages = vars.getNumericParameter("inpnopackages");  } catch (ServletException paramEx) { ex = paramEx; }     data.cActivityId = vars.getStringParameter("inpcActivityId");     data.cCampaignId = vars.getStringParameter("inpcCampaignId");     data.adOrgtrxId = vars.getStringParameter("inpadOrgtrxId");     data.mFreightcategoryId = vars.getStringParameter("inpmFreightcategoryId");     data.calculateFreight = vars.getStringParameter("inpcalculateFreight");     data.freightCurrencyId = vars.getRequestGlobalVariable("inpfreightCurrencyId", windowId + "|Freight_Currency_ID");     data.cProjectId = vars.getStringParameter("inpcProjectId");     data.cProjectIdr = vars.getStringParameter("inpcProjectId_R");     data.cCostcenterId = vars.getStringParameter("inpcCostcenterId");     data.aAssetId = vars.getStringParameter("inpaAssetId");     data.user1Id = vars.getStringParameter("inpuser1Id");     data.user2Id = vars.getStringParameter("inpuser2Id");     data.dateordered = vars.getStringParameter("inpdateordered");     data.islogistic = vars.getStringParameter("inpislogistic", "N");     data.shipdate = vars.getStringParameter("inpshipdate");     data.trackingno = vars.getStringParameter("inptrackingno");     data.pickdate = vars.getStringParameter("inppickdate");     data.generatelines = vars.getStringParameter("inpgeneratelines");     data.cInvoiceId = vars.getStringParameter("inpcInvoiceId");     data.deliveryLocationId = vars.getStringParameter("inpdeliveryLocationId");     data.rmReceiptPickedit = vars.getStringParameter("inprmReceiptPickedit");     data.rmShipmentPickedit = vars.getStringParameter("inprmShipmentPickedit");     data.processed = vars.getStringParameter("inpprocessed", "N");     data.isprinted = vars.getStringParameter("inpisprinted", "N");     data.issotrx = vars.getRequiredInputGlobalVariable("inpissotrx", windowId + "|IsSOTrx", "N");     data.dateprinted = vars.getStringParameter("inpdateprinted");     data.processing = vars.getStringParameter("inpprocessing", "N");     data.mInoutId = vars.getRequestGlobalVariable("inpmInoutId", windowId + "|M_InOut_ID");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.updatelines = vars.getStringParameter("inpupdatelines"); 
      ...
      data.updatedTimeStamp = vars.getStringParameter("updatedTimestamp");
          ...
          vars.getGlobalVariable("inphasMInoutlines", windowId + "|HAS_M_INOUTLINES", "");
...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/GoodsReceipt/Header_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header", false, "document.frmMain.inpmInoutId", "grid", "../shipments/print.html", "N".equals("Y"), "GoodsReceipt", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "GoodsReceipt", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    vars.setSessionValue(windowId + "|ISLOGISTICAUX", strISLOGISTICAUX);
        String strDOCBASETYPE = HeaderData.selectAux343D4CF5B66246348ECF5F82D201E9C6(this, ((dataField!=null)?dataField.getField("cDoctypeId"):((data==null || data.length==0)?"":data[0].getField("cDoctypeId"))));
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strHAS_M_INOUTLINES = HeaderData.selectAux9655D5D7E29B4B2C80DF63CBB011148D(this, ((dataField!=null)?dataField.getField("mInoutId"):((data==null || data.length==0)?"":data[0].getField("mInoutId"))));
    vars.setSessionValue(windowId + "|HAS_M_INOUTLINES", strHAS_M_INOUTLINES);
    
    
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        refreshSessionNew(vars);
        data = HeaderData.set(Utility.getDefault(this, vars, "Freight_Currency_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "Process_Goods_Java", "CO", "184", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "Process_Goods_Java", "CO", "184", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "Process_Goods_Java", "CO", "184", "N", dataField))), Utility.getDefault(this, vars, "Description", "", "184", "", dataField), Utility.getDefault(this, vars, "MovementType", "", "184", "", dataField), Utility.getDefault(this, vars, "MovementDate", "@#Date@", "184", "", dataField), Utility.getDefault(this, vars, "Processed", "", "184", "N", dataField), Utility.getDefault(this, vars, "Processing", "", "184", "N", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "184", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "184", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "184", "", dataField), HeaderData.selectDef3526_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "184", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "184", "", dataField), HeaderData.selectDef3528_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "184", "", dataField)), Utility.getDefault(this, vars, "IsSOTrx", "@IsSOTrx@", "184", "N", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "184", "", dataField), Utility.getDefault(this, vars, "C_DocType_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "IsPrinted", "", "184", "N", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "184", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "184", "", dataField), HeaderData.selectDef3795_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "184", "", dataField)), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "POReference", "", "184", "", dataField), Utility.getDefault(this, vars, "DeliveryRule", "A", "184", "", dataField), Utility.getDefault(this, vars, "FreightCostRule", "I", "184", "", dataField), Utility.getDefault(this, vars, "FreightAmt", "0", "184", "", dataField), Utility.getDefault(this, vars, "DeliveryViaRule", "P", "184", "", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "184", "", dataField), Utility.getDefault(this, vars, "PriorityRule", "5", "184", "", dataField), Utility.getDefault(this, vars, "DatePrinted", "", "184", "", dataField), Utility.getDefault(this, vars, "C_Order_ID", "", "184", "", dataField), HeaderData.selectDef3809_3(this, Utility.getDefault(this, vars, "C_Order_ID", "", "184", "", dataField)), Utility.getDefault(this, vars, "M_Condition_Goods_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "DateOrdered", "", "184", "", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "184", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "184", "N", dataField), Utility.getDefault(this, vars, "CreateFrom", "", "184", "N", dataField), Utility.getDefault(this, vars, "GenerateTo", "", "184", "N", dataField), Utility.getDefault(this, vars, "C_Invoice_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "Posted", "", "184", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "", "184", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "", "184", "N", dataField))), Utility.getDefault(this, vars, "UpdateLines", "N", "184", "N", dataField), Utility.getDefault(this, vars, "Islogistic", "@ISLOGISTICAUX@", "184", "N", dataField), Utility.getDefault(this, vars, "GenerateLines", "N", "184", "N", dataField), Utility.getDefault(this, vars, "Delivery_Location_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "M_FreightCategory_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "Calculate_Freight", "", "184", "N", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "PickDate", "", "184", "", dataField), Utility.getDefault(this, vars, "TrackingNo", "", "184", "", dataField), Utility.getDefault(this, vars, "NoPackages", "", "184", "", dataField), Utility.getDefault(this, vars, "ShipDate", "", "184", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "184", "", dataField), HeaderData.selectDef9585_4(this, Utility.getDefault(this, vars, "C_Project_ID", "", "184", "", dataField)), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "184", "", dataField), Utility.getDefault(this, vars, "RM_Receipt_PickEdit", "", "184", "N", dataField), Utility.getDefault(this, vars, "RM_Shipment_Pickedit", "", "184", "N", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "184", "", dataField));
    ...
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmInoutId", "", "../shipments/print.html", "N".equals("Y"), "GoodsReceipt", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_InOut_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "GoodsReceipt", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Header_Relation.html", strReplaceWith);
      ...
      throw new ServletException(ex);
        ...
        xmlDocument.setParameter("HAS_M_INOUTLINES", strHAS_M_INOUTLINES);
...
xmlDocument.setParameter("CreateFrom_BTNname", Utility.getButtonName(this, vars, "4248", "CreateFrom_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalCreateFrom = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("CreateFrom_Modal", modalCreateFrom?"true":"false");
xmlDocument.setParameter("GenerateTo_BTNname", Utility.getButtonName(this, vars, "4249", "GenerateTo_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalGenerateTo = org.openbravo.erpCommon.utility.Utility.isModalProcess("154"); 
xmlDocument.setParameter("GenerateTo_Modal", modalGenerateTo?"true":"false");
