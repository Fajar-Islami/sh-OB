...
String strParamPaymentdate_f = vars.getSessionValue(tabId + "|paramPaymentdate_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/PaymentIn/Header_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header", false, "document.frmMain.inpfinPaymentId", "grid", "../payments/print.html", "N".equals("Y"), "PaymentIn", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "PaymentIn", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _Fin_Payment_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strFin_Payment_ID = _Fin_Payment_ID;
...
String strParamPaymentdate_f = vars.getSessionValue(tabId + "|paramPaymentdate_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("finPaymentId") == null || dataField.getField("finPaymentId").equals("")) {
        ...
        String strDOCBASETYPE = "ARR";
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strFIN_ISRECEIPT = "Y";
    vars.setSessionValue(windowId + "|FIN_ISRECEIPT", strFIN_ISRECEIPT);
        String strFinancialAccountCurrencyId = HeaderData.selectAuxFF8080812E26BF58012E2772F0B2003B(this, ((dataField!=null)?dataField.getField("finFinancialAccountId"):((data==null || data.length==0)?"":data[0].getField("finFinancialAccountId"))));
    vars.setSessionValue(windowId + "|FinancialAccountCurrencyId", strFinancialAccountCurrencyId);
        String strIsMultiCurrencyEnabled = HeaderData.selectAuxFF8080812E26BF58012E27DDC44E0170(this, ((dataField!=null)?dataField.getField("finFinancialAccountId"):((data==null || data.length==0)?"":data[0].getField("finFinancialAccountId"))), ((dataField!=null)?dataField.getField("finPaymentmethodId"):((data==null || data.length==0)?"":data[0].getField("finPaymentmethodId"))));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "Fin_Financial_Account_ID", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "CreatedByAlgorithm", "N", "E547CE89D4C04429B6340FFA44E70716", "N", dataField), Utility.getDefault(this, vars, "Finacc_Txn_Convert_Rate", "1.0", "E547CE89D4C04429B6340FFA44E70716", "0", dataField), Utility.getDefault(this, vars, "Finacc_Txn_Amount", "", "E547CE89D4C04429B6340FFA44E70716", "0", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), HeaderData.selectDef7891269C83D4655DE040007F010155CE_0(this, Utility.getDefault(this, vars, "Createdby", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), HeaderData.selectDef7891269C83D6655DE040007F010155CE_1(this, Utility.getDefault(this, vars, "Updatedby", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField)), "Y", Utility.getDefault(this, vars, "Isreceipt", "@FIN_ISRECEIPT@", "E547CE89D4C04429B6340FFA44E70716", "N", dataField), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), HeaderData.selectDef7891269C83D9655DE040007F010155CE_2(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField)), Utility.getDefault(this, vars, "Paymentdate", "@#Date@", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "Amount", "0", "E547CE89D4C04429B6340FFA44E70716", "0", dataField), Utility.getDefault(this, vars, "Writeoffamt", "0", "E547CE89D4C04429B6340FFA44E70716", "0", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "Referenceno", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "Status", "RPAP", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "Processed", "N", "E547CE89D4C04429B6340FFA44E70716", "N", dataField), Utility.getDefault(this, vars, "Processing", "N", "E547CE89D4C04429B6340FFA44E70716", "N", dataField), Utility.getDefault(this, vars, "Posted", "N", "E547CE89D4C04429B6340FFA44E70716", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "N", "E547CE89D4C04429B6340FFA44E70716", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "N", "E547CE89D4C04429B6340FFA44E70716", "N", dataField))), Utility.getDefault(this, vars, "Fin_Paymentmethod_ID", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "EM_APRM_Process_Payment", "P", "E547CE89D4C04429B6340FFA44E70716", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "36972531DA994BB38ECB91993058282F", Utility.getDefault(this, vars, "EM_APRM_Process_Payment", "P", "E547CE89D4C04429B6340FFA44E70716", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "36972531DA994BB38ECB91993058282F", Utility.getDefault(this, vars, "EM_APRM_Process_Payment", "P", "E547CE89D4C04429B6340FFA44E70716", "N", dataField))), Utility.getDefault(this, vars, "EM_APRM_Reconcile_Payment", "", "E547CE89D4C04429B6340FFA44E70716", "N", dataField), Utility.getDefault(this, vars, "EM_Aprm_Add_Scheduledpayments", "", "E547CE89D4C04429B6340FFA44E70716", "N", dataField), HeaderData.selectDef8032E178607750D5E040007F01004282(this, Utility.getContext(this, vars, "AD_Org_ID", "E547CE89D4C04429B6340FFA44E70716"), Utility.getContext(this, vars, "#AD_Client_ID", windowId), Utility.getContext(this, vars, "Isreceipt", "E547CE89D4C04429B6340FFA44E70716")), Utility.getDefault(this, vars, "C_Project_ID", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), HeaderData.selectDef828EE0AE800D5FA1E040007F010067C7_3(this, Utility.getDefault(this, vars, "C_Project_ID", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField)), Utility.getDefault(this, vars, "C_Campaign_ID", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "EM_Aprm_Executepayment", "", "E547CE89D4C04429B6340FFA44E70716", "N", dataField), Utility.getDefault(this, vars, "Description", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "Generated_Credit", "0", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "Used_Credit", "0", "E547CE89D4C04429B6340FFA44E70716", "", dataField), Utility.getDefault(this, vars, "EM_APRM_ReversePayment", "N", "E547CE89D4C04429B6340FFA44E70716", "N", dataField), Utility.getDefault(this, vars, "FIN_Rev_Payment_ID", "", "E547CE89D4C04429B6340FFA44E70716", "", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/PaymentIn/Header_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/PaymentIn/Header_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpfinPaymentId", "", "../payments/print.html", "N".equals("Y"), "PaymentIn", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strFin_Payment_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "PaymentIn", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Header_Relation.html", strReplaceWith);
...
comboTableData = new ComboTableData(vars, this, "19", "Fin_Financial_Account_ID", "", "6910516E0A54432CA2E6A0C058346F92", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
...
xmlDocument.setParameter("EM_Aprm_Add_Scheduledpayments_BTNname", Utility.getButtonName(this, vars, "7FCAAFE989BDA375E040007F01007F0A", "EM_Aprm_Add_Scheduledpayments_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Aprm_Add_Scheduledpayments = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
...
xmlDocument.setParameter("EM_Aprm_Executepayment_BTNname", Utility.getButtonName(this, vars, "87AA16ECFE55144FE040007F01001F08", "EM_Aprm_Executepayment_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Aprm_Executepayment = org.openbravo.erpCommon.utility.Utility.isModalProcess("E011F492B0814A74B63CD1F3B9FF0526"); 
