  ...
  private AccountData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.name = vars.getRequiredStringParameter("inpname");     data.cCurrencyId = vars.getRequiredGlobalVariable("inpcCurrencyId", windowId + "|C_Currency_ID");     data.cCurrencyIdr = vars.getStringParameter("inpcCurrencyId_R");     data.type = vars.getRequiredStringParameter("inptype");     data.typer = vars.getStringParameter("inptype_R");     data.description = vars.getStringParameter("inpdescription");     data.cLocationId = vars.getStringParameter("inpcLocationId");     data.cLocationIdr = vars.getStringParameter("inpcLocationId_R");     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.isdefault = vars.getStringParameter("inpisdefault", "N");    try {   data.currentbalance = vars.getRequiredNumericParameter("inpcurrentbalance");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.creditlimit = vars.getRequiredNumericParameter("inpcreditlimit");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.initialbalance = vars.getRequiredNumericParameter("inpinitialbalance");  } catch (ServletException paramEx) { ex = paramEx; }     data.finMatchingAlgorithmId = vars.getStringParameter("inpfinMatchingAlgorithmId");     data.finMatchingAlgorithmIdr = vars.getStringParameter("inpfinMatchingAlgorithmId_R");     data.genericaccountno = vars.getStringParameter("inpgenericaccountno");     data.iban = vars.getStringParameter("inpiban");     data.swiftcode = vars.getStringParameter("inpswiftcode");     data.ineNumber = vars.getStringParameter("inpineNumber");     data.cCountryId = vars.getStringParameter("inpcCountryId");     data.cCountryIdr = vars.getStringParameter("inpcCountryId_R");     data.bankformat = vars.getStringParameter("inpbankformat");     data.bankformatr = vars.getStringParameter("inpbankformat_R");     data.typewriteoff = vars.getStringParameter("inptypewriteoff");     data.typewriteoffr = vars.getStringParameter("inptypewriteoff_R");    try {   data.writeofflimit = vars.getNumericParameter("inpwriteofflimit");  } catch (ServletException paramEx) { ex = paramEx; }     data.emAprmImportbankfile = vars.getStringParameter("inpemAprmImportbankfile");     data.emAprmMatchtransactions = vars.getStringParameter("inpemAprmMatchtransactions");     data.emAprmMatchtransForce = vars.getStringParameter("inpemAprmMatchtransForce");     data.emAprmReconcile = vars.getStringParameter("inpemAprmReconcile");     data.emAprmAddtransactions = vars.getStringParameter("inpemAprmAddtransactions");     data.emAprmAddmultiplepayments = vars.getStringParameter("inpemAprmAddmultiplepayments");     data.codebank = vars.getStringParameter("inpcodebank");     data.codebranch = vars.getStringParameter("inpcodebranch");     data.bankDigitcontrol = vars.getStringParameter("inpbankDigitcontrol");     data.accountDigitcontrol = vars.getStringParameter("inpaccountDigitcontrol");     data.codeaccount = vars.getStringParameter("inpcodeaccount");     data.accountno = vars.getStringParameter("inpaccountno");     data.emAprmAddtransactionpd = vars.getStringParameter("inpemAprmAddtransactionpd");     data.emAprmFindtransactionspd = vars.getStringParameter("inpemAprmFindtransactionspd");     data.emAprmFundsTrans = vars.getStringParameter("inpemAprmFundsTrans");     data.finFinancialAccountId = vars.getRequestGlobalVariable("inpfinFinancialAccountId", windowId + "|Fin_Financial_Account_ID");     data.routingno = vars.getStringParameter("inproutingno");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID"); 
      ...
      data.updatedTimeStamp = vars.getStringParameter("updatedTimestamp");
          ...
          vars.getGlobalVariable("inp$elementPj", windowId + "|$Element_PJ", "");
          vars.getGlobalVariable("inp$elementU1FatH", windowId + "|$Element_U1_FAT_H", "");
          vars.getGlobalVariable("inp$elementPjFatH", windowId + "|$Element_PJ_FAT_H", "");
          vars.getGlobalVariable("inp$elementOoFatH", windowId + "|$Element_OO_FAT_H", "");
          vars.getGlobalVariable("inp$elementSr", windowId + "|$Element_SR", "");
          vars.getGlobalVariable("inpdraftreconciliation", windowId + "|DRAFTRECONCILIATION", "");
          vars.getGlobalVariable("inp$elementCcFatH", windowId + "|$Element_CC_FAT_H", "");
          vars.getGlobalVariable("inp$elementCc", windowId + "|$Element_CC", "");
          vars.getGlobalVariable("inplastrecon", windowId + "|LASTRECON", "");
          vars.getGlobalVariable("inp$elementPrFatH", windowId + "|$Element_PR_FAT_H", "");
          vars.getGlobalVariable("inp$elementU1", windowId + "|$Element_U1", "");
          vars.getGlobalVariable("inp$elementOo", windowId + "|$Element_OO", "");
          vars.getGlobalVariable("inp$elementPr", windowId + "|$Element_PR", "");
          vars.getGlobalVariable("inp$elementU2FatH", windowId + "|$Element_U2_FAT_H", "");
          vars.getGlobalVariable("inp$elementAy", windowId + "|$Element_AY", "");
          vars.getGlobalVariable("inphastransaction", windowId + "|HasTransaction", "");
          vars.getGlobalVariable("inp$elementU2", windowId + "|$Element_U2", "");
          vars.getGlobalVariable("inp$elementBpFatH", windowId + "|$Element_BP_FAT_H", "");
          vars.getGlobalVariable("inp$isacctdimcentrally", windowId + "|$IsAcctDimCentrally", "");
          vars.getGlobalVariable("inp$elementMc", windowId + "|$Element_MC", "");
          vars.getGlobalVariable("inp$elementBp", windowId + "|$Element_BP", "");
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|C_Currency_ID", data[0].getField("cCurrencyId"));    vars.setSessionValue(windowId + "|Fin_Financial_Account_ID", data[0].getField("finFinancialAccountId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _Fin_Financial_Account_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strFin_Financial_Account_ID = _Fin_Financial_Account_ID;
...
String strParamC_Currency_ID = vars.getSessionValue(tabId + "|paramC_Currency_ID");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("finFinancialAccountId") == null || dataField.getField("finFinancialAccountId").equals("")) {
        ...
        String str$Element_PJ = AccountData.selectAux0389829094184BC4A99B307868F278EE(this, ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId"))), ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_PJ", str$Element_PJ);
        String str$Element_U1_FAT_H = AccountData.selectAux07608CACCACF4A398D8FB4869CE70571(this, ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_U1_FAT_H", str$Element_U1_FAT_H);
        String str$Element_PJ_FAT_H = AccountData.selectAux1022B3987A6B481C85968D79658DA6C6(this, ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_PJ_FAT_H", str$Element_PJ_FAT_H);
        String str$Element_OO_FAT_H = AccountData.selectAux1453726EFC4B4E2898296BB44A7172ED(this, ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_OO_FAT_H", str$Element_OO_FAT_H);
        String str$Element_SR = AccountData.selectAux154056E8BD07443E9760F8C76FA9533F(this, ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId"))), ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_SR", str$Element_SR);
        String strDRAFTRECONCILIATION = AccountData.selectAux1FF62A68BA95425CA76E4317DD195C62(this, ((dataField!=null)?dataField.getField("finFinancialAccountId"):((data==null || data.length==0)?"":data[0].getField("finFinancialAccountId"))));
    vars.setSessionValue(windowId + "|DRAFTRECONCILIATION", strDRAFTRECONCILIATION);
        String str$Element_CC_FAT_H = AccountData.selectAux311BE34CB1684926877B28AFE1939C26(this, ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_CC_FAT_H", str$Element_CC_FAT_H);
        String str$Element_CC = AccountData.selectAux4A555D695EE84BD08225721AF0DB4660(this, ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId"))), ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_CC", str$Element_CC);
        String strLASTRECON = AccountData.selectAux4FD70C86888041D695C59CFA792BBCC6(this, ((dataField!=null)?dataField.getField("finFinancialAccountId"):((data==null || data.length==0)?"":data[0].getField("finFinancialAccountId"))));
    vars.setSessionValue(windowId + "|LASTRECON", strLASTRECON);
        String str$Element_PR_FAT_H = AccountData.selectAux58585C6A8EFE4E0EBD3DFF8746206EAF(this, ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_PR_FAT_H", str$Element_PR_FAT_H);
        String str$Element_U1 = AccountData.selectAux5AA02067B7A046B39F6C1D0D5072CC9F(this, ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId"))), ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_U1", str$Element_U1);
        String str$Element_OO = AccountData.selectAux5BB2952CE3234414A146E35032539257(this, ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId"))), ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_OO", str$Element_OO);
        String str$Element_PR = AccountData.selectAux5BF658979C8C4F29949B1542FD065423(this, ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId"))), ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_PR", str$Element_PR);
        String str$Element_U2_FAT_H = AccountData.selectAux7B711DEB519143C4A8C97E6C05300E07(this, ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_U2_FAT_H", str$Element_U2_FAT_H);
        String str$Element_AY = AccountData.selectAux7B7890725A7C4C06BBD98CBBFB325D39(this, ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId"))), ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_AY", str$Element_AY);
        String strHasTransaction = AccountData.selectAuxA72A59A036BB47B09105AC5C3361C99C(this, ((dataField!=null)?dataField.getField("finFinancialAccountId"):((data==null || data.length==0)?"":data[0].getField("finFinancialAccountId"))));
    vars.setSessionValue(windowId + "|HasTransaction", strHasTransaction);
        String str$Element_U2 = AccountData.selectAuxAA110F79CC9C4DD8B51EBBB234E3AD1B(this, ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId"))), ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_U2", str$Element_U2);
        String str$Element_BP_FAT_H = AccountData.selectAuxD453894F70014B078F7DE07DFD7A112F(this, ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_BP_FAT_H", str$Element_BP_FAT_H);
        String str$IsAcctDimCentrally = AccountData.selectAuxDA4CDAF77BAF42118049D8DA9A6FF05B(this, ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$IsAcctDimCentrally", str$IsAcctDimCentrally);
        String str$Element_MC = AccountData.selectAuxE396BAA4096A4AA0ABA0CEC0A52BF983(this, ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId"))), ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_MC", str$Element_MC);
        String str$Element_BP = AccountData.selectAuxEBFF532722F5438BAACA625CE5E69A41(this, ((dataField!=null)?dataField.getField("adOrgId"):((data==null || data.length==0)?"":data[0].getField("adOrgId"))), ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|$Element_BP", str$Element_BP);
    
    
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        refreshSessionNew(vars);
        data = AccountData.set(Utility.getDefault(this, vars, "EM_Aprm_Addtransactionpd", "", "94EAA455D2644E04AB25D93BE5157B6D", "N", dataField), Utility.getDefault(this, vars, "BankFormat", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "EM_Aprm_Findtransactionspd", "", "94EAA455D2644E04AB25D93BE5157B6D", "N", dataField), Utility.getDefault(this, vars, "Writeofflimit", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Typewriteoff", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "InitialBalance", "0", "94EAA455D2644E04AB25D93BE5157B6D", "0", dataField), Utility.getDefault(this, vars, "C_Country_ID", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_ORG_ID@", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Createdby", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), AccountData.selectDef7891269C8404655DE040007F010155CE_0(this, Utility.getDefault(this, vars, "Createdby", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField)), Utility.getDefault(this, vars, "Updatedby", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), AccountData.selectDef7891269C8406655DE040007F010155CE_1(this, Utility.getDefault(this, vars, "Updatedby", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField)), "Y", Utility.getDefault(this, vars, "C_Currency_ID", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Name", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Description", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Type", "B", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "C_Location_ID", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), AccountData.selectDef828EE0AE80485FA1E040007F010067C7_2(this,  vars.getLanguage(), Utility.getDefault(this, vars, "C_Location_ID", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField)), Utility.getDefault(this, vars, "Routingno", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Swiftcode", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Codebank", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Codebranch", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Bank_Digitcontrol", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "INE_Number", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Account_Digitcontrol", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Codeaccount", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Accountno", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Currentbalance", "0", "94EAA455D2644E04AB25D93BE5157B6D", "0", dataField), Utility.getDefault(this, vars, "Creditlimit", "0", "94EAA455D2644E04AB25D93BE5157B6D", "0", dataField), Utility.getDefault(this, vars, "Iban", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "Isdefault", "N", "94EAA455D2644E04AB25D93BE5157B6D", "N", dataField), Utility.getDefault(this, vars, "EM_APRM_MatchTrans_Force", "", "94EAA455D2644E04AB25D93BE5157B6D", "N", dataField), Utility.getDefault(this, vars, "GenericAccountNo", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField), Utility.getDefault(this, vars, "EM_APRM_ImportBankFile", "", "94EAA455D2644E04AB25D93BE5157B6D", "N", dataField), Utility.getDefault(this, vars, "EM_APRM_MatchTransactions", "", "94EAA455D2644E04AB25D93BE5157B6D", "N", dataField), Utility.getDefault(this, vars, "EM_APRM_Reconcile", "", "94EAA455D2644E04AB25D93BE5157B6D", "N", dataField), Utility.getDefault(this, vars, "EM_APRM_AddTransactions", "", "94EAA455D2644E04AB25D93BE5157B6D", "N", dataField), Utility.getDefault(this, vars, "EM_Aprm_Funds_Trans", "", "94EAA455D2644E04AB25D93BE5157B6D", "N", dataField), Utility.getDefault(this, vars, "EM_Aprm_AddMultiplePayments", "N", "94EAA455D2644E04AB25D93BE5157B6D", "N", dataField), Utility.getDefault(this, vars, "FIN_Matching_Algorithm_ID", "", "94EAA455D2644E04AB25D93BE5157B6D", "", dataField));
    ...
    try {
      ...
      throw new ServletException(ex);
        ...
        xmlDocument.setParameter("$Element_PJ", str$Element_PJ);
        xmlDocument.setParameter("$Element_U1_FAT_H", str$Element_U1_FAT_H);
        xmlDocument.setParameter("$Element_PJ_FAT_H", str$Element_PJ_FAT_H);
        xmlDocument.setParameter("$Element_OO_FAT_H", str$Element_OO_FAT_H);
        xmlDocument.setParameter("$Element_SR", str$Element_SR);
        xmlDocument.setParameter("DRAFTRECONCILIATION", strDRAFTRECONCILIATION);
        xmlDocument.setParameter("$Element_CC_FAT_H", str$Element_CC_FAT_H);
        xmlDocument.setParameter("$Element_CC", str$Element_CC);
        xmlDocument.setParameter("LASTRECON", strLASTRECON);
        xmlDocument.setParameter("$Element_PR_FAT_H", str$Element_PR_FAT_H);
        xmlDocument.setParameter("$Element_U1", str$Element_U1);
        xmlDocument.setParameter("$Element_OO", str$Element_OO);
        xmlDocument.setParameter("$Element_PR", str$Element_PR);
        xmlDocument.setParameter("$Element_U2_FAT_H", str$Element_U2_FAT_H);
        xmlDocument.setParameter("$Element_AY", str$Element_AY);
        xmlDocument.setParameter("HasTransaction", strHasTransaction);
        xmlDocument.setParameter("$Element_U2", str$Element_U2);
        xmlDocument.setParameter("$Element_BP_FAT_H", str$Element_BP_FAT_H);
        xmlDocument.setParameter("$IsAcctDimCentrally", str$IsAcctDimCentrally);
        xmlDocument.setParameter("$Element_MC", str$Element_MC);
        xmlDocument.setParameter("$Element_BP", str$Element_BP);
...
xmlDocument.setParameter("EM_APRM_MatchTrans_Force_BTNname", Utility.getButtonName(this, vars, "B7C06E2CD9EC460FBA493804E274ACC7", "EM_APRM_MatchTrans_Force_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_APRM_MatchTrans_Force = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("EM_APRM_MatchTrans_Force_Modal", modalEM_APRM_MatchTrans_Force?"true":"false");
xmlDocument.setParameter("EM_APRM_MatchTransactions_BTNname", Utility.getButtonName(this, vars, "A0417A0E9255CA28E040007F01003C18", "EM_APRM_MatchTransactions_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_APRM_MatchTransactions = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
...
xmlDocument.setParameter("EM_Aprm_AddMultiplePayments_BTNname", Utility.getButtonName(this, vars, "6AACBA272E5347899B134AD4FEBADB9A", "EM_Aprm_AddMultiplePayments_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Aprm_AddMultiplePayments = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("EM_Aprm_AddMultiplePayments_Modal", modalEM_Aprm_AddMultiplePayments?"true":"false");
xmlDocument.setParameter("EM_Aprm_Addtransactionpd_BTNname", Utility.getButtonName(this, vars, "2A4F1DAD0EDB4049926BD08A25111914", "EM_Aprm_Addtransactionpd_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Aprm_Addtransactionpd = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("EM_Aprm_Addtransactionpd_Modal", modalEM_Aprm_Addtransactionpd?"true":"false");
xmlDocument.setParameter("EM_Aprm_Findtransactionspd_BTNname", Utility.getButtonName(this, vars, "FC6A539FAE444706A27E013B9D62D10F", "EM_Aprm_Findtransactionspd_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Aprm_Findtransactionspd = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("EM_Aprm_Findtransactionspd_Modal", modalEM_Aprm_Findtransactionspd?"true":"false");
xmlDocument.setParameter("EM_Aprm_Funds_Trans_BTNname", Utility.getButtonName(this, vars, "0A650E8E8BD944018FD4FD6866AF1481", "EM_Aprm_Funds_Trans_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_Aprm_Funds_Trans = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("EM_Aprm_Funds_Trans_Modal", modalEM_Aprm_Funds_Trans?"true":"false");
