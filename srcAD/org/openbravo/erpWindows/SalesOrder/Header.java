  ...
  private HeaderData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.cDoctypetargetId = vars.getRequiredStringParameter("inpcDoctypetargetId");     data.cDoctypetargetIdr = vars.getStringParameter("inpcDoctypetargetId_R");     data.documentno = vars.getRequiredStringParameter("inpdocumentno");     data.cReturnReasonId = vars.getStringParameter("inpcReturnReasonId");     data.dateordered = vars.getRequiredGlobalVariable("inpdateordered", windowId + "|DateOrdered");     data.cBpartnerId = vars.getRequiredGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R");     data.rmPickfromshipment = vars.getStringParameter("inprmPickfromshipment");     data.cBpartnerLocationId = vars.getRequiredGlobalVariable("inpcBpartnerLocationId", windowId + "|C_BPartner_Location_ID");     data.cBpartnerLocationIdr = vars.getStringParameter("inpcBpartnerLocationId_R");     data.mPricelistId = vars.getRequiredGlobalVariable("inpmPricelistId", windowId + "|M_PriceList_ID");     data.mPricelistIdr = vars.getStringParameter("inpmPricelistId_R");     data.rmReceivematerials = vars.getStringParameter("inprmReceivematerials");     data.datepromised = vars.getRequiredGlobalVariable("inpdatepromised", windowId + "|DatePromised");     data.finPaymentmethodId = vars.getStringParameter("inpfinPaymentmethodId");     data.finPaymentmethodIdr = vars.getStringParameter("inpfinPaymentmethodId_R");     data.rmCreateinvoice = vars.getStringParameter("inprmCreateinvoice");     data.cPaymenttermId = vars.getRequiredStringParameter("inpcPaymenttermId");     data.cPaymenttermIdr = vars.getStringParameter("inpcPaymenttermId_R");     data.mWarehouseId = vars.getRequiredGlobalVariable("inpmWarehouseId", windowId + "|M_Warehouse_ID");     data.invoicerule = vars.getRequiredStringParameter("inpinvoicerule");     data.invoiceruler = vars.getStringParameter("inpinvoicerule_R");     data.docstatus = vars.getRequiredGlobalVariable("inpdocstatus", windowId + "|DocStatus");    try {   data.grandtotal = vars.getRequiredNumericParameter("inpgrandtotal");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.totallines = vars.getRequiredNumericParameter("inptotallines");  } catch (ServletException paramEx) { ex = paramEx; }     data.cCurrencyId = vars.getRequiredGlobalVariable("inpcCurrencyId", windowId + "|C_Currency_ID");     data.adUserId = vars.getStringParameter("inpadUserId");     data.cDoctypeId = vars.getRequiredGlobalVariable("inpcDoctypeId", windowId + "|C_DocType_ID");     data.soResStatus = vars.getStringParameter("inpsoResStatus");     data.poreference = vars.getStringParameter("inpporeference");     data.salesrepId = vars.getStringParameter("inpsalesrepId");     data.salesrepIdr = vars.getStringParameter("inpsalesrepId_R");     data.description = vars.getStringParameter("inpdescription");     data.billtoId = vars.getRequiredStringParameter("inpbilltoId");     data.billtoIdr = vars.getStringParameter("inpbilltoId_R");     data.deliveryLocationId = vars.getStringParameter("inpdeliveryLocationId");     data.deliveryLocationIdr = vars.getStringParameter("inpdeliveryLocationId_R");     data.emAprmAddpayment = vars.getStringParameter("inpemAprmAddpayment");     data.docaction = vars.getRequiredStringParameter("inpdocaction");     data.copyfrom = vars.getStringParameter("inpcopyfrom");     data.copyfrompo = vars.getStringParameter("inpcopyfrompo");     data.deliveryviarule = vars.getRequiredGlobalVariable("inpdeliveryviarule", windowId + "|DeliveryViaRule");     data.mShipperId = vars.getRequestGlobalVariable("inpmShipperId", windowId + "|M_Shipper_ID");     data.deliveryrule = vars.getRequiredStringParameter("inpdeliveryrule");     data.freightcostrule = vars.getRequiredGlobalVariable("inpfreightcostrule", windowId + "|FreightCostRule");    try {   data.freightamt = vars.getRequiredNumericParameter("inpfreightamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.isdiscountprinted = vars.getStringParameter("inpisdiscountprinted", "N");     data.priorityrule = vars.getRequiredStringParameter("inppriorityrule");     data.cCampaignId = vars.getStringParameter("inpcCampaignId");    try {   data.chargeamt = vars.getNumericParameter("inpchargeamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.cChargeId = vars.getStringParameter("inpcChargeId");     data.cActivityId = vars.getStringParameter("inpcActivityId");     data.adOrgtrxId = vars.getStringParameter("inpadOrgtrxId");     data.quotationId = vars.getStringParameter("inpquotationId");     data.quotationIdr = vars.getStringParameter("inpquotationId_R");     data.calculatePromotions = vars.getStringParameter("inpcalculatePromotions");     data.rmAddorphanline = vars.getStringParameter("inprmAddorphanline");     data.convertquotation = vars.getStringParameter("inpconvertquotation");     data.cRejectReasonId = vars.getStringParameter("inpcRejectReasonId");     data.validuntil = vars.getStringParameter("inpvaliduntil");     data.cancelledorderId = vars.getStringParameter("inpcancelledorderId");     data.cancelledorderIdr = vars.getStringParameter("inpcancelledorderId_R");     data.replacedorderId = vars.getStringParameter("inpreplacedorderId");     data.replacedorderIdr = vars.getStringParameter("inpreplacedorderId_R");     data.replacementorderId = vars.getStringParameter("inpreplacementorderId");     data.replacementorderIdr = vars.getStringParameter("inpreplacementorderId_R");     data.iscancelled = vars.getStringParameter("inpiscancelled", "N");     data.cProjectId = vars.getStringParameter("inpcProjectId");     data.cProjectIdr = vars.getStringParameter("inpcProjectId_R");     data.cCostcenterId = vars.getStringParameter("inpcCostcenterId");     data.aAssetId = vars.getStringParameter("inpaAssetId");     data.user1Id = vars.getStringParameter("inpuser1Id");     data.user2Id = vars.getStringParameter("inpuser2Id");     data.cancelandreplace = vars.getStringParameter("inpcancelandreplace");     data.confirmcancelandreplace = vars.getStringParameter("inpconfirmcancelandreplace");     data.issotrx = vars.getRequiredInputGlobalVariable("inpissotrx", windowId + "|IsSOTrx", "N");     data.paymentrule = vars.getRequiredStringParameter("inppaymentrule");     data.dateprinted = vars.getStringParameter("inpdateprinted");     data.posted = vars.getRequiredGlobalVariable("inpposted", windowId + "|Posted");     data.cIncotermsId = vars.getStringParameter("inpcIncotermsId");     data.istaxincluded = vars.getStringParameter("inpistaxincluded", "N");     data.dateacct = vars.getRequiredStringParameter("inpdateacct");     data.isselected = vars.getStringParameter("inpisselected", "N");     data.dropshipUserId = vars.getStringParameter("inpdropshipUserId");     data.isprinted = vars.getStringParameter("inpisprinted", "N");     data.isinvoiced = vars.getStringParameter("inpisinvoiced", "N");     data.isdelivered = vars.getStringParameter("inpisdelivered", "N");     data.dropshipBpartnerId = vars.getStringParameter("inpdropshipBpartnerId");     data.processed = vars.getRequiredInputGlobalVariable("inpprocessed", windowId + "|Processed", "N");     data.generatetemplate = vars.getStringParameter("inpgeneratetemplate");     data.dropshipLocationId = vars.getStringParameter("inpdropshipLocationId");     data.isselfservice = vars.getStringParameter("inpisselfservice", "N");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.cOrderId = vars.getRequestGlobalVariable("inpcOrderId", windowId + "|C_Order_ID");     data.incotermsdescription = vars.getStringParameter("inpincotermsdescription");     data.deliverynotes = vars.getStringParameter("inpdeliverynotes");     data.processing = vars.getStringParameter("inpprocessing"); 
      ...
      data.updatedTimeStamp = vars.getStringParameter("updatedTimestamp");
          ...
          vars.getGlobalVariable("inpaprmOrderispaid", windowId + "|APRM_OrderIsPaid", "");
...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/SalesOrder/Header_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header", false, "document.frmMain.inpcOrderId", "grid", "../orders/print.html", "N".equals("Y"), "SalesOrder", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "SalesOrder", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _C_Order_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strC_Order_ID = _C_Order_ID;
...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("cOrderId") == null || dataField.getField("cOrderId").equals("")) {
        ...
        String strORDERTYPE = HeaderData.selectAux6(this, ((dataField!=null)?dataField.getField("cOrderId"):((data==null || data.length==0)?"":data[0].getField("cOrderId"))));
    vars.setSessionValue(windowId + "|ORDERTYPE", strORDERTYPE);
        String strDOCBASETYPE = HeaderData.selectAux09BF7886BE7846C3B870F354B8301159(this, ((dataField!=null)?dataField.getField("cDoctypetargetId"):((data==null || data.length==0)?"":data[0].getField("cDoctypetargetId"))));
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strPromotionsDefined = HeaderData.selectAuxD0DC4F3EC11B4F6D9457EF08B5AF54C5(this, ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|PromotionsDefined", strPromotionsDefined);
        String strAPRM_OrderIsPaid = HeaderData.selectAux9FF4321DE0E5487B8A649A444F3F64BC(this, ((dataField!=null)?dataField.getField("cOrderId"):((data==null || data.length==0)?"":data[0].getField("cOrderId"))));
    vars.setSessionValue(windowId + "|APRM_OrderIsPaid", strAPRM_OrderIsPaid);
    
    
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        refreshSessionNew(vars);
        data = HeaderData.set(Utility.getDefault(this, vars, "Cancelledorder_id", "", "143", "", dataField), Utility.getDefault(this, vars, "Convertquotation", "", "143", "N", dataField), Utility.getDefault(this, vars, "validuntil", "", "143", "", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "143", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "143", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "143", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "143", "", dataField), HeaderData.selectDef2166_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "143", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "143", "", dataField), HeaderData.selectDef2168_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "143", "", dataField)), Utility.getDefault(this, vars, "DocumentNo", "", "143", "", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "143", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "143", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "FF80818130217A35013021A672400035", Utility.getDefault(this, vars, "DocAction", "CO", "143", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "FF80818130217A35013021A672400035", Utility.getDefault(this, vars, "DocAction", "CO", "143", "N", dataField))), Utility.getDefault(this, vars, "C_DocType_ID", "0", "143", "", dataField), Utility.getDefault(this, vars, "C_DocTypeTarget_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Description", "", "143", "", dataField), Utility.getDefault(this, vars, "IsDelivered", "", "143", "N", dataField), Utility.getDefault(this, vars, "IsInvoiced", "", "143", "N", dataField), Utility.getDefault(this, vars, "IsPrinted", "", "143", "N", dataField), Utility.getDefault(this, vars, "DateOrdered", "@#Date@", "143", "", dataField), Utility.getDefault(this, vars, "DatePromised", "@#Date@", "143", "", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "143", "", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "C_PaymentTerm_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "BillTo_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "143", "", dataField), Utility.getDefault(this, vars, "InvoiceRule", "D", "143", "", dataField), Utility.getDefault(this, vars, "FreightAmt", "", "143", "0", dataField), Utility.getDefault(this, vars, "DeliveryViaRule", "P", "143", "", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "PriorityRule", "5", "143", "", dataField), Utility.getDefault(this, vars, "TotalLines", "", "143", "0", dataField), Utility.getDefault(this, vars, "GrandTotal", "", "143", "0", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "M_PriceList_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Processing", "", "143", "N", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "143", "", dataField), HeaderData.selectDef2762_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "143", "", dataField)), Utility.getDefault(this, vars, "AD_User_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "POReference", "", "143", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "143", "", dataField), Utility.getDefault(this, vars, "Processed", "", "143", "N", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "143", "", dataField), HeaderData.selectDef3402_3(this, Utility.getDefault(this, vars, "C_Project_ID", "", "143", "", dataField)), Utility.getDefault(this, vars, "C_Activity_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Quotation_ID", "", "143", "", dataField), HeaderData.selectDef367DCAA9CF4442ADB9A76F6539102217_4(this, Utility.getDefault(this, vars, "Quotation_ID", "", "143", "", dataField)), Utility.getDefault(this, vars, "IsSOTrx", "@IsSOTrx@", "143", "N", dataField), Utility.getDefault(this, vars, "DatePrinted", "", "143", "", dataField), Utility.getDefault(this, vars, "DeliveryRule", "A", "143", "", dataField), Utility.getDefault(this, vars, "FreightCostRule", "I", "143", "", dataField), Utility.getDefault(this, vars, "PaymentRule", "B", "143", "", dataField), Utility.getDefault(this, vars, "IsDiscountPrinted", "", "143", "N", dataField), Utility.getDefault(this, vars, "Posted", "N", "143", "N", dataField), Utility.getDefault(this, vars, "IsTaxIncluded", "", "143", "N", dataField), Utility.getDefault(this, vars, "IsSelected", "", "143", "N", dataField), Utility.getDefault(this, vars, "Confirmcancelandreplace", "", "143", "N", dataField), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Deliverynotes", "", "143", "", dataField), Utility.getDefault(this, vars, "C_Incoterms_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Incotermsdescription", "", "143", "", dataField), Utility.getDefault(this, vars, "Generatetemplate", "", "143", "N", dataField), Utility.getDefault(this, vars, "Delivery_Location_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "CopyFromPO", "", "143", "N", dataField), Utility.getDefault(this, vars, "FIN_Paymentmethod_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "DropShip_User_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "DropShip_BPartner_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "CopyFrom", "", "143", "N", dataField), Utility.getDefault(this, vars, "DropShip_Location_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "IsSelfService", "", "143", "N", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Calculate_Promotions", "", "143", "N", dataField), Utility.getDefault(this, vars, "Cancelandreplace", "", "143", "N", dataField), Utility.getDefault(this, vars, "RM_PickFromShipment", "", "143", "N", dataField), Utility.getDefault(this, vars, "RM_ReceiveMaterials", "", "143", "N", dataField), Utility.getDefault(this, vars, "RM_CreateInvoice", "", "143", "N", dataField), Utility.getDefault(this, vars, "C_Return_Reason_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Replacedorder_id", "", "143", "", dataField), Utility.getDefault(this, vars, "RM_AddOrphanLine", "", "143", "N", dataField), Utility.getDefault(this, vars, "SO_Res_Status", "", "143", "", dataField), Utility.getDefault(this, vars, "C_Reject_Reason_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Replacementorder_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Iscancelled", "N", "143", "N", dataField), Utility.getDefault(this, vars, "EM_APRM_AddPayment", "", "143", "N", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/SalesOrder/Header_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/SalesOrder/Header_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcOrderId", "", "../orders/print.html", "N".equals("Y"), "SalesOrder", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_Order_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "SalesOrder", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Header_Relation.html", strReplaceWith);
      ...
      throw new ServletException(ex);
        ...
        xmlDocument.setParameter("APRM_OrderIsPaid", strAPRM_OrderIsPaid);
...
comboTableData = null;
xmlDocument.setParameter("EM_APRM_AddPayment_BTNname", Utility.getButtonName(this, vars, "04CFE3A53162449380A253DE0B814AEF", "EM_APRM_AddPayment_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_APRM_AddPayment = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
...
xmlDocument.setParameter("CopyFrom_BTNname", Utility.getButtonName(this, vars, "6560", "CopyFrom_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalCopyFrom = org.openbravo.erpCommon.utility.Utility.isModalProcess("211"); 
xmlDocument.setParameter("CopyFrom_Modal", modalCopyFrom?"true":"false");
xmlDocument.setParameter("CopyFromPO_BTNname", Utility.getButtonName(this, vars, "804079", "CopyFromPO_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalCopyFromPO = org.openbravo.erpCommon.utility.Utility.isModalProcess("800165"); 
...
comboTableData = new ComboTableData(vars, this, "18", "Cancelledorder_id", "290", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("cancelledorderId"):dataField.getField("cancelledorderId")));
xmlDocument.setData("reportCancelledorder_id","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "18", "Replacedorder_id", "290", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("replacedorderId"):dataField.getField("replacedorderId")));
xmlDocument.setData("reportReplacedorder_id","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "18", "Replacementorder_ID", "290", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("replacementorderId"):dataField.getField("replacementorderId")));
xmlDocument.setData("reportReplacementorder_ID","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
xmlDocument.setParameter("Cancelandreplace_BTNname", Utility.getButtonName(this, vars, "3C9B97CD980A4D809BDE5B9FDC3E0E73", "Cancelandreplace_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalCancelandreplace = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("Cancelandreplace_Modal", modalCancelandreplace?"true":"false");
xmlDocument.setParameter("Confirmcancelandreplace_BTNname", Utility.getButtonName(this, vars, "F0BF2E4561024D30B93AC7B471DBF5D7", "Confirmcancelandreplace_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalConfirmcancelandreplace = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("Confirmcancelandreplace_Modal", modalConfirmcancelandreplace?"true":"false");
