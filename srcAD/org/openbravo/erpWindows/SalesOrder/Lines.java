...
vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID");
  ...
  private LinesData getEditVariables(Connection con, VariablesSecureApp vars, String strPC_Order_ID) throws IOException,ServletException {
   ...
   try {   data.line = vars.getRequiredNumericParameter("inpline");  } catch (ServletException paramEx) { ex = paramEx; }     data.mProductId = vars.getRequiredGlobalVariable("inpmProductId", windowId + "|M_Product_ID");     data.mProductIdr = vars.getStringParameter("inpmProductId_R");    try {   data.aumqty = vars.getNumericParameter("inpaumqty");  } catch (ServletException paramEx) { ex = paramEx; }     data.cAum = vars.getStringParameter("inpcAum");     data.cAumr = vars.getStringParameter("inpcAum_R");     data.mInoutlineId = vars.getStringParameter("inpmInoutlineId");    try {   data.qtyordered = vars.getRequiredNumericParameter("inpqtyordered");  } catch (ServletException paramEx) { ex = paramEx; }     data.cUomId = vars.getRequiredGlobalVariable("inpcUomId", windowId + "|C_UOM_ID");     data.cUomIdr = vars.getStringParameter("inpcUomId_R");     data.cReturnReasonId = vars.getStringParameter("inpcReturnReasonId");     data.mAttributesetinstanceId = vars.getRequestGlobalVariable("inpmAttributesetinstanceId", windowId + "|M_AttributeSetInstance_ID");     data.mAttributesetinstanceIdr = vars.getStringParameter("inpmAttributesetinstanceId_R");    try {   data.priceactual = vars.getRequiredNumericParameter("inppriceactual");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.grossUnitPrice = vars.getNumericParameter("inpgrossUnitPrice");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.linenetamt = vars.getRequiredNumericParameter("inplinenetamt");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.lineGrossAmount = vars.getNumericParameter("inplineGrossAmount");  } catch (ServletException paramEx) { ex = paramEx; }     data.cTaxId = vars.getRequiredStringParameter("inpcTaxId");     data.cTaxIdr = vars.getStringParameter("inpcTaxId_R");    try {   data.pricelist = vars.getRequiredNumericParameter("inppricelist");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.grosspricelist = vars.getNumericParameter("inpgrosspricelist");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.discount = vars.getNumericParameter("inpdiscount");  } catch (ServletException paramEx) { ex = paramEx; }     data.mWarehouseRuleId = vars.getStringParameter("inpmWarehouseRuleId");     data.mWarehouseRuleIdr = vars.getStringParameter("inpmWarehouseRuleId_R");     data.description = vars.getStringParameter("inpdescription");     data.replacedorderlineId = vars.getStringParameter("inpreplacedorderlineId");     data.replacedorderlineIdr = vars.getStringParameter("inpreplacedorderlineId_R");     data.createReservation = vars.getStringParameter("inpcreateReservation");     data.createReservationr = vars.getStringParameter("inpcreateReservation_R");    try {   data.taxbaseamt = vars.getNumericParameter("inptaxbaseamt");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.qtyinvoiced = vars.getRequiredNumericParameter("inpqtyinvoiced");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.qtydelivered = vars.getRequiredNumericParameter("inpqtydelivered");  } catch (ServletException paramEx) { ex = paramEx; }     data.dateordered = vars.getRequiredGlobalVariable("inpdateordered", windowId + "|DateOrdered");     data.datepromised = vars.getRequestGlobalVariable("inpdatepromised", windowId + "|DatePromised");     data.mWarehouseId = vars.getRequiredGlobalVariable("inpmWarehouseId", windowId + "|M_Warehouse_ID");    try {   data.qtyreserved = vars.getRequiredNumericParameter("inpqtyreserved");  } catch (ServletException paramEx) { ex = paramEx; }     data.mShipperId = vars.getRequestGlobalVariable("inpmShipperId", windowId + "|M_Shipper_ID");     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.directship = vars.getStringParameter("inpdirectship", "N");    try {   data.freightamt = vars.getRequiredNumericParameter("inpfreightamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.cBpartnerLocationId = vars.getRequestGlobalVariable("inpcBpartnerLocationId", windowId + "|C_BPartner_Location_ID");     data.cancelpricead = vars.getStringParameter("inpcancelpricead", "N");     data.mProductUomId = vars.getStringParameter("inpmProductUomId");    try {   data.quantityorder = vars.getNumericParameter("inpquantityorder");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.grosspricestd = vars.getRequiredNumericParameter("inpgrosspricestd");  } catch (ServletException paramEx) { ex = paramEx; }    try {   data.pricestd = vars.getRequiredNumericParameter("inppricestd");  } catch (ServletException paramEx) { ex = paramEx; }     data.iseditlinenetamt = vars.getStringParameter("inpiseditlinenetamt", "N");     data.soResStatus = vars.getStringParameter("inpsoResStatus");     data.quotationlineId = vars.getStringParameter("inpquotationlineId");     data.quotationlineIdr = vars.getStringParameter("inpquotationlineId_R");     data.manageReservation = vars.getStringParameter("inpmanageReservation");     data.printDescription = vars.getStringParameter("inpprintDescription", "N");    try {   data.overdueReturnDays = vars.getNumericParameter("inpoverdueReturnDays");  } catch (ServletException paramEx) { ex = paramEx; }     data.adOrgId = vars.getRequiredStringParameter("inpadOrgId");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.cProjectId = vars.getStringParameter("inpcProjectId");     data.cProjectIdr = vars.getStringParameter("inpcProjectId_R");     data.cCostcenterId = vars.getStringParameter("inpcCostcenterId");     data.aAssetId = vars.getStringParameter("inpaAssetId");     data.user1Id = vars.getStringParameter("inpuser1Id");     data.user2Id = vars.getStringParameter("inpuser2Id");     data.explode = vars.getStringParameter("inpexplode");     data.bomParentId = vars.getStringParameter("inpbomParentId");     data.relateOrderline = vars.getRequiredStringParameter("inprelateOrderline");     data.cOrderlineId = vars.getRequestGlobalVariable("inpcOrderlineId", windowId + "|C_OrderLine_ID");     data.managePrereservation = vars.getStringParameter("inpmanagePrereservation");     data.cOrderDiscountId = vars.getStringParameter("inpcOrderDiscountId");     data.mOfferId = vars.getStringParameter("inpmOfferId");     data.isdescription = vars.getStringParameter("inpisdescription", "N");     data.refOrderlineId = vars.getStringParameter("inprefOrderlineId");     data.sResourceassignmentId = vars.getStringParameter("inpsResourceassignmentId");    try {   data.pricelimit = vars.getRequiredNumericParameter("inppricelimit");  } catch (ServletException paramEx) { ex = paramEx; }     data.cChargeId = vars.getStringParameter("inpcChargeId");    try {   data.chargeamt = vars.getNumericParameter("inpchargeamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.cCurrencyId = vars.getRequiredGlobalVariable("inpcCurrencyId", windowId + "|C_Currency_ID");     data.dateinvoiced = vars.getStringParameter("inpdateinvoiced");     data.datedelivered = vars.getStringParameter("inpdatedelivered");     data.cOrderId = vars.getRequiredGlobalVariable("inpcOrderId", windowId + "|C_Order_ID");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID"); 
      ...
      data.cOrderId = vars.getGlobalVariable("inpcOrderId", windowId + "|C_Order_ID");
          ...
          vars.getGlobalVariable("inpattributesetinstanciable", windowId + "|ATTRIBUTESETINSTANCIABLE", "");
          ...
          vars.getGlobalVariable("inphasrelatedservice", windowId + "|HASRELATEDSERVICE", "");
          vars.getGlobalVariable("inpproducttype", windowId + "|PRODUCTTYPE", "");
          vars.getGlobalVariable("inpusesalternate", windowId + "|UsesAlternate", "");
          vars.getGlobalVariable("inpislinkedtoproduct", windowId + "|ISLINKEDTOPRODUCT", "");
          vars.getGlobalVariable("inpisbom", windowId + "|isBOM", "");
          vars.getGlobalVariable("inpisstocked", windowId + "|IsStocked", "");
          vars.getGlobalVariable("inplinkedtoproduct", windowId + "|LINKEDTOPRODUCT", "");
          vars.getGlobalVariable("inpisquantityvariable", windowId + "|isQuantityVariable", "");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPC_Order_ID) throws IOException,ServletException {
      ...
      vars.setSessionValue(windowId + "|PromotionsDefined", HeaderData.selectAuxD0DC4F3EC11B4F6D9457EF08B5AF54C5(this, ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId")))));
      
      vars.setSessionValue(windowId + "|APRM_OrderIsPaid", HeaderData.selectAux9FF4321DE0E5487B8A649A444F3F64BC(this, strPC_Order_ID));
...
String strParamLineNetAmt_f = vars.getSessionValue(tabId + "|paramLineNetAmt_f");
    ...
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Lines", false, "document.frmMain.inpcOrderlineId", "grid", "..", "".equals("Y"), "SalesOrder", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
    ...
    xmlDocument.setParameter("parentFieldName", Utility.getFieldName("1119", vars.getLanguage()));
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines_Relation.html", "SalesOrder", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _C_OrderLine_ID, String strPC_Order_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strC_OrderLine_ID = _C_OrderLine_ID;
...
String strParamLineNetAmt_f = vars.getSessionValue(tabId + "|paramLineNetAmt_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("cOrderlineId") == null || dataField.getField("cOrderlineId").equals("")) {
        ...
        String strHASSECONDUOM = LinesData.selectAux800010(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|HASSECONDUOM", strHASSECONDUOM);
        String strATTRIBUTESET = LinesData.selectAux0A17DEEA6AE34D0AAF8D7D789BBEB16A(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|ATTRIBUTESET", strATTRIBUTESET);
        String strParent_AD_Org = LinesData.selectAux2DED276495BD4544AA805CDF95409734(this, strPC_Order_ID);
    vars.setSessionValue(windowId + "|Parent_AD_Org", strParent_AD_Org);
        String strDOCBASETYPE = LinesData.selectAux2F68ED80A1824966845A6CED4A2B5B45(this, strPC_Order_ID);
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strATTRIBUTESETINSTANCIABLE = LinesData.selectAux377353A77F7A4876BE4F36592679CD4C(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|ATTRIBUTESETINSTANCIABLE", strATTRIBUTESETINSTANCIABLE);
        String strC_BPARTNER_ID = LinesData.selectAux39F11BEB43D7442F81AE2ECE5341550F(this, strPC_Order_ID);
    ...
    vars.setSessionValue(windowId + "|Processed", strProcessed);
        String strATTRSETVALUETYPE = LinesData.selectAux4B4FADE3E6AC41F0827B3120AD6C3FAA(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|ATTRSETVALUETYPE", strATTRSETVALUETYPE);
        String strHASRELATEDSERVICE = LinesData.selectAux67C474B1ACCB4442BC5C0CC1B8CFA727(this, ((dataField!=null)?dataField.getField("cOrderlineId"):((data==null || data.length==0)?"":data[0].getField("cOrderlineId"))));
    vars.setSessionValue(windowId + "|HASRELATEDSERVICE", strHASRELATEDSERVICE);
        String strPRODUCTTYPE = LinesData.selectAux6FF318BC6B214568AF629A157CD8E84C(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|PRODUCTTYPE", strPRODUCTTYPE);
        String strUsesAlternate = LinesData.selectAux81E735D7FA45476498395FDD9AB982ED(this, ((dataField!=null)?dataField.getField("cTaxId"):((data==null || data.length==0)?"":data[0].getField("cTaxId"))));
    vars.setSessionValue(windowId + "|UsesAlternate", strUsesAlternate);
        String strISLINKEDTOPRODUCT = LinesData.selectAux9C4726AC432E4C5A81A21436D4062611(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|ISLINKEDTOPRODUCT", strISLINKEDTOPRODUCT);
        String strisBOM = LinesData.selectAuxBBFAC7EEB599451388E60BA877C89809(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|isBOM", strisBOM);
        String strIsStocked = LinesData.selectAuxCF00CC6BA5F747CBB77CA682833A22FE(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|IsStocked", strIsStocked);
        String strLINKEDTOPRODUCT = LinesData.selectAuxDED55CC8E7EB48899AB8779A3C8233BD(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|LINKEDTOPRODUCT", strLINKEDTOPRODUCT);
        String strisQuantityVariable = LinesData.selectAuxE4536B2BCBDB4469A130B3BD4D7DEB53(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|isQuantityVariable", strisQuantityVariable);
        String strGROSSPRICE = LinesData.selectAuxF77560579B7E4105A0C8455FCFB1B333(this, Utility.getContext(this, vars, "M_PRICELIST_ID", "143"));
    vars.setSessionValue(windowId + "|GROSSPRICE", strGROSSPRICE);
        String strPosted = LinesData.selectAuxFF45754650034D1695FB584866C04DC5(this, strPC_Order_ID);
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPC_Order_ID, Utility.getDefault(this, vars, "Line_Gross_Amount", "0", "143", "", dataField), Utility.getDefault(this, vars, "CANCELPRICEAD", "N", "143", "N", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "143", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "143", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "143", "", dataField), LinesData.selectDef2210_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "143", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "143", "", dataField), LinesData.selectDef2212_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "143", "", dataField)), LinesData.selectDef2214(this, strPC_Order_ID), Utility.getDefault(this, vars, "DateOrdered", "@DateOrdered@", "143", "", dataField), Utility.getDefault(this, vars, "DatePromised", "@DatePromised@", "143", "", dataField), Utility.getDefault(this, vars, "DateDelivered", "", "143", "", dataField), Utility.getDefault(this, vars, "DateInvoiced", "", "143", "", dataField), Utility.getDefault(this, vars, "Description", "", "143", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "143", "", dataField), LinesData.selectDef2221_2(this,  vars.getLanguage(), Utility.getDefault(this, vars, "M_Product_ID", "", "143", "", dataField)), Utility.getDefault(this, vars, "C_UOM_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "@M_Warehouse_ID@", "143", "", dataField), Utility.getDefault(this, vars, "QtyOrdered", "1", "143", "0", dataField), Utility.getDefault(this, vars, "QtyReserved", "", "143", "0", dataField), Utility.getDefault(this, vars, "QtyDelivered", "", "143", "0", dataField), Utility.getDefault(this, vars, "QtyInvoiced", "", "143", "0", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "@M_Shipper_ID@", "143", "", dataField), Utility.getDefault(this, vars, "C_Currency_ID", "@C_Currency_ID@", "143", "", dataField), Utility.getDefault(this, vars, "PriceList", "", "143", "0", dataField), Utility.getDefault(this, vars, "PriceActual", "", "143", "0", dataField), Utility.getDefault(this, vars, "C_Tax_ID", "", "143", "", dataField), LinesData.selectDef2764(this, strPC_Order_ID), Utility.getDefault(this, vars, "DirectShip", "", "143", "N", dataField), Utility.getDefault(this, vars, "FreightAmt", "", "143", "0", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "143", "", dataField), Utility.getDefault(this, vars, "Relate_Orderline", "N", "143", "N", dataField), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "@C_BPartner_Location_ID@", "143", "", dataField), Utility.getDefault(this, vars, "LineNetAmt", "", "143", "0", dataField), Utility.getDefault(this, vars, "PriceLimit", "", "143", "0", dataField), Utility.getDefault(this, vars, "Discount", "0", "143", "", dataField), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Print_Description", "N", "143", "N", dataField), Utility.getDefault(this, vars, "C_Return_Reason_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "S_ResourceAssignment_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "C_Order_Discount_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Overdue_Return_Days", "", "143", "", dataField), Utility.getDefault(this, vars, "Ref_OrderLine_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Iseditlinenetamt", "N", "143", "N", dataField), Utility.getDefault(this, vars, "Taxbaseamt", "", "143", "", dataField), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "143", "", dataField), Utility.getDefault(this, vars, "QuantityOrder", "", "143", "", dataField), Utility.getDefault(this, vars, "M_Offer_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "PriceStd", "0", "143", "0", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "143", "", dataField), LinesData.selectDef8767_3(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "143", "", dataField)), Utility.getDefault(this, vars, "User1_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "C_Aum", "", "143", "", dataField), Utility.getDefault(this, vars, "IsDescription", "N", "143", "N", dataField), Utility.getDefault(this, vars, "BOM_Parent_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "grosspricestd", "0", "143", "0", dataField), Utility.getDefault(this, vars, "Explode", "", "143", "N", dataField), Utility.getDefault(this, vars, "M_Inoutline_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "143", "", dataField), LinesData.selectDefB2023461A08649D58E5D144D4FC2C507_4(this, Utility.getDefault(this, vars, "C_Project_ID", "", "143", "", dataField)), Utility.getDefault(this, vars, "Aumqty", "", "143", "", dataField), Utility.getDefault(this, vars, "GrossPriceList", "", "143", "", dataField), Utility.getDefault(this, vars, "Replacedorderline_id", "", "143", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_Rule_ID", "", "143", "", dataField), Utility.getDefault(this, vars, "Create_Reservation", "", "143", "", dataField), Utility.getDefault(this, vars, "SO_Res_Status", "", "143", "", dataField), Utility.getDefault(this, vars, "Manage_Reservation", "", "143", "N", dataField), Utility.getDefault(this, vars, "Manage_Prereservation", "", "143", "N", dataField), Utility.getDefault(this, vars, "Quotationline_ID", "", "143", "", dataField), LinesData.selectDefE9612846B6F5472A8F64CF729E0B25AE_5(this, Utility.getDefault(this, vars, "Quotationline_ID", "", "143", "", dataField)), Utility.getDefault(this, vars, "Gross_Unit_Price", "0", "143", "", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/SalesOrder/Lines_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/SalesOrder/Lines_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Lines", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpcOrderlineId", "", "..", "".equals("Y"), "SalesOrder", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strC_OrderLine_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Lines_Relation.html", "SalesOrder", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Lines_Relation.html", strReplaceWith);
      ...
      throw new ServletException(ex);
        ...
        xmlDocument.setParameter("ATTRIBUTESETINSTANCIABLE", strATTRIBUTESETINSTANCIABLE);
        ...
        xmlDocument.setParameter("HASRELATEDSERVICE", strHASRELATEDSERVICE);
        xmlDocument.setParameter("PRODUCTTYPE", strPRODUCTTYPE);
        xmlDocument.setParameter("UsesAlternate", strUsesAlternate);
        xmlDocument.setParameter("ISLINKEDTOPRODUCT", strISLINKEDTOPRODUCT);
        xmlDocument.setParameter("isBOM", strisBOM);
        xmlDocument.setParameter("IsStocked", strIsStocked);
        xmlDocument.setParameter("LINKEDTOPRODUCT", strLINKEDTOPRODUCT);
        xmlDocument.setParameter("isQuantityVariable", strisQuantityVariable);
...
xmlDocument.setParameter("buttonAumqty", Utility.messageBD(this, "Calc", vars.getLanguage()));
comboTableData = new ComboTableData(vars, this, "18", "C_Aum", "D8CABB4103B14B42BE3064A68C600935", "5ABEE0829BD24BFB9BA454E607825821", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("cAum"):dataField.getField("cAum")));
xmlDocument.setData("reportC_Aum","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
...
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "18", "Replacedorderline_id", "271", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("replacedorderlineId"):dataField.getField("replacedorderlineId")));
xmlDocument.setData("reportReplacedorderline_id","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "17", "Create_Reservation", "1852D69AB3FD453F8F031813501B26F0", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("createReservation"):dataField.getField("createReservation")));
xmlDocument.setData("reportCreate_Reservation","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
...
xmlDocument.setParameter("Manage_Reservation_BTNname", Utility.getButtonName(this, vars, "CE626BBC5EB58638E040007F01001502", "Manage_Reservation_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalManage_Reservation = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("Manage_Reservation_Modal", modalManage_Reservation?"true":"false");
String userOrgList = "";
if (editableTab) 
...
comboTableData = null;
xmlDocument.setParameter("Explode_BTNname", Utility.getButtonName(this, vars, "8CF90D88C5F445C59FF111C9FCEBF413", "Explode_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalExplode = org.openbravo.erpCommon.utility.Utility.isModalProcess("DFC78024B1F54CBB95DC73425BA6687F"); 
xmlDocument.setParameter("Explode_Modal", modalExplode?"true":"false");
xmlDocument.setParameter("Relate_Orderline_BTNname", Utility.getButtonName(this, vars, "FD42EB7017AA42009DF8E7EE9ECBA325", "Relate_Orderline_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalRelate_Orderline = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("Relate_Orderline_Modal", modalRelate_Orderline?"true":"false");
...
xmlDocument.setParameter("buttonPriceLimit", Utility.messageBD(this, "Calc", vars.getLanguage()));
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private String getReadOnlyLogicContext(VariablesSecureApp vars) throws IOException, ServletException {
      ...
      String result = "var strIsSOTrx=\"" + Utility.getContext(this, vars, "IsSOTrx", windowId) + "\";\nvar strUomManagement=\"" + Utility.getContext(this, vars, "UomManagement", windowId) + "\";\n";
      return result;
    }
