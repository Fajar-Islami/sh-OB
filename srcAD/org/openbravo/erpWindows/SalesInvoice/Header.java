...
String strParamGrandTotal_f = vars.getSessionValue(tabId + "|paramGrandTotal_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("cInvoiceId") == null || dataField.getField("cInvoiceId").equals("")) {
        ...
        String strPromotionsDefined = HeaderData.selectAux1459AA66723E4905BE05C09DC757DA6E(this, ((dataField!=null)?dataField.getField("adClientId"):((data==null || data.length==0)?"":data[0].getField("adClientId"))));
    vars.setSessionValue(windowId + "|PromotionsDefined", strPromotionsDefined);
        String strHAS_C_INVOICELINES = HeaderData.selectAux34E27119A7B74205B025002E9CD5074F(this, ((dataField!=null)?dataField.getField("cInvoiceId"):((data==null || data.length==0)?"":data[0].getField("cInvoiceId"))));
    vars.setSessionValue(windowId + "|HAS_C_INVOICELINES", strHAS_C_INVOICELINES);
        String strDOCBASETYPE = HeaderData.selectAux7A6DD0A1AF304BE288BBFBE305EA1227(this, ((dataField!=null)?dataField.getField("cDoctypetargetId"):((data==null || data.length==0)?"":data[0].getField("cDoctypetargetId"))));
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strVoidAutomaticallyCreated = HeaderData.selectAuxB54EEEFACAD4427ABE5F88D0C27524B5(this, ((dataField!=null)?dataField.getField("cInvoiceId"):((data==null || data.length==0)?"":data[0].getField("cInvoiceId"))));
    vars.setSessionValue(windowId + "|VoidAutomaticallyCreated", strVoidAutomaticallyCreated);
        String strshowAddPayment = HeaderData.selectAuxFFA925AAC4BB49D5A67C05DAD16EFA32(this, ((dataField!=null)?dataField.getField("cInvoiceId"):((data==null || data.length==0)?"":data[0].getField("cInvoiceId"))));
...
xmlDocument.setParameter("EM_APRM_Addpayment_BTNname", Utility.getButtonName(this, vars, "AD7C15BA367642AFB471EFAFD768FB2D", "EM_APRM_Addpayment_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalEM_APRM_Addpayment = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
