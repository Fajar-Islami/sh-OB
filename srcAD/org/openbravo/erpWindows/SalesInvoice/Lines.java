...
vars.getGlobalVariable("inpcInvoiceId", windowId + "|C_Invoice_ID");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPC_Invoice_ID) throws IOException,ServletException {
      ...
      vars.setSessionValue(windowId + "|showAddPayment", HeaderData.selectAuxFFA925AAC4BB49D5A67C05DAD16EFA32(this, strPC_Invoice_ID));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _C_InvoiceLine_ID, String strPC_Invoice_ID, TableSQLData tableSQL)
    ...
    String orderClause = " C_InvoiceLine.M_Product_Uom_Id, C_InvoiceLine.QuantityOrder, C_InvoiceLine.Line";
...
String strParamLineNetAmt_f = vars.getSessionValue(tabId + "|paramLineNetAmt_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("cInvoicelineId") == null || dataField.getField("cInvoicelineId").equals("")) {
        ...
        String strHASSECONDUOM = LinesData.selectAux800004(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    vars.setSessionValue(windowId + "|C_BPARTNER_ID", strC_BPARTNER_ID);
        String strUsesAlternate = LinesData.selectAux1F06154C94734F81A968E51738CC7B62(this, ((dataField!=null)?dataField.getField("cTaxId"):((data==null || data.length==0)?"":data[0].getField("cTaxId"))));
    ...
    vars.setSessionValue(windowId + "|Parent_AD_Org", strParent_AD_Org);
        String strisBOM = LinesData.selectAux3EE2062DF62F4E948FD9786D21AF2D0C(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    vars.setSessionValue(windowId + "|isBOM", strisBOM);
        String strIsStocked = LinesData.selectAux467629226B744AD5A9D5CEBD284C29E4(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    vars.setSessionValue(windowId + "|Processed", strProcessed);
        String strATTRSETVALUETYPE = LinesData.selectAux51568B79156646C8966F49F82EE51CB7(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    vars.setSessionValue(windowId + "|Posted", strPosted);
        String strATTRIBUTESET = LinesData.selectAux637CCFE37ADD45B5810D3490DF33CF2E(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPC_Invoice_ID, Utility.getDefault(this, vars, "Excludeforwithholding", "", "167", "N", dataField), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "167", "", dataField), LinesData.selectDef1655799099FD4E7A9EB982F98A5C8066_0(this, Utility.getDefault(this, vars, "C_Bpartner_ID", "", "167", "", dataField)), Utility.getDefault(this, vars, "C_Period_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "Financial_Invoice_Line", "N", "167", "N", dataField), Utility.getDefault(this, vars, "DefPlanType", "", "167", "", dataField), Utility.getDefault(this, vars, "Aumqty", "", "167", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "167", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "167", "", dataField), "Y", Utility.getDefault(this, vars, "Created", "", "167", "", dataField), Utility.getDefault(this, vars, "CreatedBy", "", "167", "", dataField), LinesData.selectDef3833_1(this, Utility.getDefault(this, vars, "CreatedBy", "", "167", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "167", "", dataField), LinesData.selectDef3835_2(this, Utility.getDefault(this, vars, "UpdatedBy", "", "167", "", dataField)), Utility.getDefault(this, vars, "C_OrderLine_ID", "", "167", "", dataField), LinesData.selectDef3837_3(this, Utility.getDefault(this, vars, "C_OrderLine_ID", "", "167", "", dataField)), LinesData.selectDef3838(this, strPC_Invoice_ID), Utility.getDefault(this, vars, "Description", "", "167", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "QtyInvoiced", "1", "167", "0", dataField), Utility.getDefault(this, vars, "PriceList", "", "167", "0", dataField), Utility.getDefault(this, vars, "PriceActual", "", "167", "0", dataField), Utility.getDefault(this, vars, "LineNetAmt", "", "167", "0", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "", "167", "", dataField), Utility.getDefault(this, vars, "C_UOM_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Tax_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "M_InOutLine_ID", "", "167", "", dataField), LinesData.selectDef4251_4(this,  vars.getLanguage(), Utility.getDefault(this, vars, "M_InOutLine_ID", "", "167", "", dataField)), Utility.getDefault(this, vars, "PriceLimit", "", "167", "0", dataField), Utility.getDefault(this, vars, "Grosspricelist", "", "167", "0", dataField), Utility.getDefault(this, vars, "Periodnumber", "", "167", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Aum", "", "167", "", dataField), Utility.getDefault(this, vars, "S_ResourceAssignment_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "Gross_Unit_Price", "0", "167", "", dataField), Utility.getDefault(this, vars, "Iseditlinenetamt", "N", "167", "N", dataField), Utility.getDefault(this, vars, "Taxbaseamt", "", "167", "", dataField), Utility.getDefault(this, vars, "QuantityOrder", "", "167", "", dataField), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Invoice_Discount_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Projectline_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "M_Offer_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "PriceStd", "0", "167", "0", dataField), Utility.getDefault(this, vars, "TaxAmt", "", "167", "", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "167", "", dataField), LinesData.selectDef8553_5(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "167", "", dataField)), Utility.getDefault(this, vars, "A_Asset_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "grosspricestd", "0", "167", "0", dataField), Utility.getDefault(this, vars, "IsDescription", "N", "167", "N", dataField), Utility.getDefault(this, vars, "IsDeferred", "N", "167", "N", dataField), Utility.getDefault(this, vars, "Line_Gross_Amount", "0", "167", "", dataField), Utility.getDefault(this, vars, "Explode", "", "167", "N", dataField), Utility.getDefault(this, vars, "BOM_Parent_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "167", "", dataField), LinesData.selectDefE9065F7B304E419787AD6EB080A54143_6(this, Utility.getDefault(this, vars, "C_Project_ID", "", "167", "", dataField)), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "167", "", dataField), Utility.getDefault(this, vars, "Account_ID", "", "167", "", dataField));
