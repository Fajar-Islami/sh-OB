...
vars.getGlobalVariable("inpmInoutId", windowId + "|M_InOut_ID");
  ...
  private LinesData getEditVariables(Connection con, VariablesSecureApp vars, String strPM_InOut_ID) throws IOException,ServletException {
   ...
   try {   data.line = vars.getRequiredNumericParameter("inpline");  } catch (ServletException paramEx) { ex = paramEx; }     data.mProductId = vars.getRequestGlobalVariable("inpmProductId", windowId + "|M_Product_ID");     data.mProductIdr = vars.getStringParameter("inpmProductId_R");     data.mConditionGoodsId = vars.getStringParameter("inpmConditionGoodsId");     data.mAttributesetinstanceId = vars.getStringParameter("inpmAttributesetinstanceId");     data.mAttributesetinstanceIdr = vars.getStringParameter("inpmAttributesetinstanceId_R");    try {   data.aumqty = vars.getNumericParameter("inpaumqty");  } catch (ServletException paramEx) { ex = paramEx; }     data.cAum = vars.getStringParameter("inpcAum");     data.cAumr = vars.getStringParameter("inpcAum_R");    try {   data.movementqty = vars.getRequiredNumericParameter("inpmovementqty", vars.getSessionValue(windowId + "|MovementQty"));  } catch (ServletException paramEx) { ex = paramEx; }     data.cUomId = vars.getRequiredGlobalVariable("inpcUomId", windowId + "|C_UOM_ID");     data.cUomIdr = vars.getStringParameter("inpcUomId_R");     data.mLocatorId = vars.getRequestGlobalVariable("inpmLocatorId", windowId + "|M_Locator_ID");     data.description = vars.getRequestGlobalVariable("inpdescription", windowId + "|Description");     data.cOrderlineId = vars.getRequestGlobalVariable("inpcOrderlineId", windowId + "|C_OrderLine_ID");     data.cOrderlineIdr = vars.getStringParameter("inpcOrderlineId_R");     data.mProductUomId = vars.getStringParameter("inpmProductUomId");    try {   data.quantityorder = vars.getNumericParameter("inpquantityorder");  } catch (ServletException paramEx) { ex = paramEx; }     data.isdescription = vars.getStringParameter("inpisdescription", "N");     data.canceledInoutlineId = vars.getStringParameter("inpcanceledInoutlineId");     data.adOrgId = vars.getRequiredStringParameter("inpadOrgId");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.cProjectId = vars.getStringParameter("inpcProjectId");     data.cProjectIdr = vars.getStringParameter("inpcProjectId_R");     data.cCostcenterId = vars.getStringParameter("inpcCostcenterId");     data.aAssetId = vars.getStringParameter("inpaAssetId");     data.user1Id = vars.getStringParameter("inpuser1Id");     data.user2Id = vars.getStringParameter("inpuser2Id");     data.explode = vars.getRequiredStringParameter("inpexplode");     data.bomParentId = vars.getStringParameter("inpbomParentId");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.isinvoiced = vars.getStringParameter("inpisinvoiced", "N");     data.managePrereservation = vars.getStringParameter("inpmanagePrereservation");     data.cBpartnerId = vars.getStringParameter("inpcBpartnerId");     data.mInoutlineId = vars.getRequestGlobalVariable("inpmInoutlineId", windowId + "|M_InOutLine_ID");     data.mInoutId = vars.getRequiredGlobalVariable("inpmInoutId", windowId + "|M_InOut_ID");     data.isactive = vars.getStringParameter("inpisactive", "N"); 
      ...
      data.mInoutId = vars.getGlobalVariable("inpmInoutId", windowId + "|M_InOut_ID");
          ...
          vars.getGlobalVariable("inponhandlocatordefault", windowId + "|OnHandLocatorDefault", "");
  ...
  private void refreshParentSession(VariablesSecureApp vars, String strPM_InOut_ID) throws IOException,ServletException {
      ...
      vars.setSessionValue(windowId + "|HAS_M_INOUTLINES", HeaderData.selectAux97AB64E23F264957BA14C2DAA29DBD80(this, strPM_InOut_ID));
...
String strParamMovementQty_f = vars.getSessionValue(tabId + "|paramMovementQty_f");
    ...
    hasSearchCondition = (tableSQL.hasInternalFilter() && ("").equals(strParamM_InOut_ID) && ("").equals(strParamLine) && ("").equals(strParamM_Product_ID) && ("").equals(strParamMovementQty) && ("").equals(strParamLine_f) && ("").equals(strParamMovementQty_f)) || !(("").equals(strParamM_InOut_ID) || ("%").equals(strParamM_InOut_ID))  || !(("").equals(strParamLine) || ("%").equals(strParamLine))  || !(("").equals(strParamM_Product_ID) || ("%").equals(strParamM_Product_ID))  || !(("").equals(strParamMovementQty) || ("%").equals(strParamMovementQty))  || !(("").equals(strParamLine_f) || ("%").equals(strParamLine_f))  || !(("").equals(strParamMovementQty_f) || ("%").equals(strParamMovementQty_f)) ;
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _M_InOutLine_ID, String strPM_InOut_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strM_InOutLine_ID = _M_InOutLine_ID;
...
String strParamMovementQty_f = vars.getSessionValue(tabId + "|paramMovementQty_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("mInoutlineId") == null || dataField.getField("mInoutlineId").equals("")) {
        ...
        String strHASSECONDUOM = LinesData.selectAux800009(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    vars.setSessionValue(windowId + "|C_BPARTNER_ID", strC_BPARTNER_ID);
        String strIsStocked = LinesData.selectAux1FC6075EA994422F8CF3B041621F374D(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strOnHandLocatorDefault = LinesData.selectAux4E3EE7A38AF3414FB89B496F9F4E8263(this, strPM_InOut_ID);
    vars.setSessionValue(windowId + "|OnHandLocatorDefault", strOnHandLocatorDefault);
        String strATTRSETVALUETYPE = LinesData.selectAux8EE1AE595E1E462BBFE568C0C27BEAC0(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    vars.setSessionValue(windowId + "|Posted", strPosted);
        String strisBOM = LinesData.selectAuxAA79289FD0CB4B69BFB31FC8A8C076EB(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    vars.setSessionValue(windowId + "|Processed", strProcessed);
        String strATTRIBUTESET = LinesData.selectAuxDE561A006F4247DFA68E13C955437EF5(this, ((dataField!=null)?dataField.getField("mProductId"):((data==null || data.length==0)?"":data[0].getField("mProductId"))));
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = LinesData.set(strPM_InOut_ID, Utility.getDefault(this, vars, "A_Asset_ID", "", "169", "", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_Client_ID@", "169", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "169", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "169", "", dataField), LinesData.selectDef3534_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "169", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "169", "", dataField), LinesData.selectDef3536_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "169", "", dataField)), Utility.getDefault(this, vars, "M_Locator_ID", "@OnHandLocatorDefault@", "169", "", dataField), Utility.getDefault(this, vars, "M_Product_ID", "", "169", "", dataField), LinesData.selectDef3539_2(this,  vars.getLanguage(), Utility.getDefault(this, vars, "M_Product_ID", "", "169", "", dataField)), Utility.getDefault(this, vars, "MovementQty", "0", "169", "0", dataField), Utility.getDefault(this, vars, "Description", "", "169", "", dataField), Utility.getDefault(this, vars, "M_Condition_Goods_ID", "", "169", "", dataField), LinesData.selectDef3810(this, strPM_InOut_ID), Utility.getDefault(this, vars, "C_OrderLine_ID", "", "169", "", dataField), LinesData.selectDef3811_3(this, Utility.getDefault(this, vars, "C_OrderLine_ID", "", "169", "", dataField)), Utility.getDefault(this, vars, "C_UOM_ID", "", "169", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "169", "", dataField), Utility.getDefault(this, vars, "IsInvoiced", "", "169", "N", dataField), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "169", "", dataField), Utility.getDefault(this, vars, "Aumqty", "", "169", "", dataField), Utility.getDefault(this, vars, "C_Aum", "", "169", "", dataField), Utility.getDefault(this, vars, "Explode", "N", "169", "N", dataField), Utility.getDefault(this, vars, "M_Product_Uom_Id", "", "169", "", dataField), Utility.getDefault(this, vars, "QuantityOrder", "", "169", "", dataField), Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "169", "", dataField), LinesData.selectDef8772_4(this, Utility.getDefault(this, vars, "M_AttributeSetInstance_ID", "", "169", "", dataField)), Utility.getDefault(this, vars, "IsDescription", "N", "169", "N", dataField), Utility.getDefault(this, vars, "User2_ID", "", "169", "", dataField), Utility.getDefault(this, vars, "Canceled_Inoutline_ID", "", "169", "", dataField), Utility.getDefault(this, vars, "C_Bpartner_ID", "", "169", "", dataField), Utility.getDefault(this, vars, "Manage_Prereservation", "", "169", "N", dataField), Utility.getDefault(this, vars, "BOM_Parent_ID", "", "169", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "169", "", dataField), LinesData.selectDefF12044E4570546E18AF6834B00961F8E_5(this, Utility.getDefault(this, vars, "C_Project_ID", "", "169", "", dataField)));
    ...
    try {
      ...
      throw new ServletException(ex);
        ...
        xmlDocument.setParameter("OnHandLocatorDefault", strOnHandLocatorDefault);
