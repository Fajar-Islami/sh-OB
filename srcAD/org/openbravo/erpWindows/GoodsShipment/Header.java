...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    vars.setSessionValue(windowId + "|ISLOGISTICAUX", strISLOGISTICAUX);
        String strDOCBASETYPE = HeaderData.selectAux3E769128EA274A8480EBB341E05468AF(this, ((dataField!=null)?dataField.getField("cDoctypeId"):((data==null || data.length==0)?"":data[0].getField("cDoctypeId"))));
    vars.setSessionValue(windowId + "|DOCBASETYPE", strDOCBASETYPE);
        String strHAS_M_INOUTLINES = HeaderData.selectAux97AB64E23F264957BA14C2DAA29DBD80(this, ((dataField!=null)?dataField.getField("mInoutId"):((data==null || data.length==0)?"":data[0].getField("mInoutId"))));
