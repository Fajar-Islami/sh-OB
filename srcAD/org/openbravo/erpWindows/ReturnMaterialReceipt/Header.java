  ...
  private HeaderData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    data.rmReceiptPickedit = vars.getStringParameter("inprmReceiptPickedit");     data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.cDoctypeId = vars.getRequiredStringParameter("inpcDoctypeId");     data.cDoctypeIdr = vars.getStringParameter("inpcDoctypeId_R");     data.documentno = vars.getRequiredStringParameter("inpdocumentno");     data.mConditionGoodsId = vars.getStringParameter("inpmConditionGoodsId");     data.mConditionGoodsIdr = vars.getStringParameter("inpmConditionGoodsId_R");     data.movementdate = vars.getRequiredStringParameter("inpmovementdate");     data.cBpartnerId = vars.getRequiredGlobalVariable("inpcBpartnerId", windowId + "|C_BPartner_ID");     data.cBpartnerIdr = vars.getStringParameter("inpcBpartnerId_R");     data.description = vars.getStringParameter("inpdescription");     data.mWarehouseId = vars.getRequiredGlobalVariable("inpmWarehouseId", windowId + "|M_Warehouse_ID");     data.cBpartnerLocationId = vars.getRequiredStringParameter("inpcBpartnerLocationId");     data.cBpartnerLocationIdr = vars.getStringParameter("inpcBpartnerLocationId_R");     data.deliveryLocationId = vars.getStringParameter("inpdeliveryLocationId");     data.docstatus = vars.getRequiredGlobalVariable("inpdocstatus", windowId + "|DocStatus");     data.adUserId = vars.getStringParameter("inpadUserId");     data.cProjectId = vars.getStringParameter("inpcProjectId");     data.cProjectIdr = vars.getStringParameter("inpcProjectId_R");     data.dateacct = vars.getRequiredStringParameter("inpdateacct");     data.cOrderId = vars.getStringParameter("inpcOrderId");     data.cOrderIdr = vars.getStringParameter("inpcOrderId_R");     data.poreference = vars.getStringParameter("inpporeference");     data.dateordered = vars.getStringParameter("inpdateordered");     data.salesrepId = vars.getStringParameter("inpsalesrepId");     data.createfrom = vars.getStringParameter("inpcreatefrom");     data.docaction = vars.getRequiredStringParameter("inpdocaction");     data.posted = vars.getRequiredGlobalVariable("inpposted", windowId + "|Posted");     data.deliveryrule = vars.getRequiredStringParameter("inpdeliveryrule");     data.deliveryviarule = vars.getRequiredStringParameter("inpdeliveryviarule");    try {   data.freightamt = vars.getNumericParameter("inpfreightamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.freightcostrule = vars.getRequiredStringParameter("inpfreightcostrule");     data.mShipperId = vars.getStringParameter("inpmShipperId");     data.priorityrule = vars.getRequiredStringParameter("inppriorityrule");     data.pickdate = vars.getStringParameter("inppickdate");     data.trackingno = vars.getStringParameter("inptrackingno");    try {   data.nopackages = vars.getNumericParameter("inpnopackages");  } catch (ServletException paramEx) { ex = paramEx; }     data.movementtype = vars.getRequiredStringParameter("inpmovementtype");     data.cChargeId = vars.getStringParameter("inpcChargeId");    try {   data.chargeamt = vars.getNumericParameter("inpchargeamt");  } catch (ServletException paramEx) { ex = paramEx; }     data.shipdate = vars.getStringParameter("inpshipdate");     data.mFreightcategoryId = vars.getStringParameter("inpmFreightcategoryId");     data.calculateFreight = vars.getStringParameter("inpcalculateFreight");     data.freightCurrencyId = vars.getRequestGlobalVariable("inpfreightCurrencyId", windowId + "|Freight_Currency_ID");     data.cActivityId = vars.getStringParameter("inpcActivityId");     data.cCampaignId = vars.getStringParameter("inpcCampaignId");     data.adOrgtrxId = vars.getStringParameter("inpadOrgtrxId");     data.user1Id = vars.getStringParameter("inpuser1Id");     data.user2Id = vars.getStringParameter("inpuser2Id");     data.cInvoiceId = vars.getStringParameter("inpcInvoiceId");     data.islogistic = vars.getStringParameter("inpislogistic", "N");     data.rmShipmentPickedit = vars.getStringParameter("inprmShipmentPickedit");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.isprinted = vars.getStringParameter("inpisprinted", "N");     data.dateprinted = vars.getStringParameter("inpdateprinted");     data.processed = vars.getStringParameter("inpprocessed", "N");     data.generatelines = vars.getStringParameter("inpgeneratelines");     data.issotrx = vars.getRequiredInputGlobalVariable("inpissotrx", windowId + "|IsSOTrx", "N");     data.generateto = vars.getStringParameter("inpgenerateto");     data.processing = vars.getStringParameter("inpprocessing", "N");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.updatelines = vars.getStringParameter("inpupdatelines");     data.mInoutId = vars.getRequestGlobalVariable("inpmInoutId", windowId + "|M_InOut_ID"); 
      ...
      data.updatedTimeStamp = vars.getStringParameter("updatedTimestamp");
          ...
          vars.getGlobalVariable("inpreturnlocator", windowId + "|ReturnLocator", "");
...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    hasSearchCondition = (tableSQL.hasInternalFilter() && ("").equals(strParamDocumentNo) && ("").equals(strParamMovementDate) && ("").equals(strParamC_BPartner_ID) && ("").equals(strParamAD_Org_ID) && ("").equals(strParamM_Warehouse_ID) && ("").equals(strParamDocStatus) && ("").equals(strParamMovementDate_f)) || !(("").equals(strParamDocumentNo) || ("%").equals(strParamDocumentNo))  || !(("").equals(strParamMovementDate) || ("%").equals(strParamMovementDate))  || !(("").equals(strParamC_BPartner_ID) || ("%").equals(strParamC_BPartner_ID))  || !(("").equals(strParamAD_Org_ID) || ("%").equals(strParamAD_Org_ID))  || !(("").equals(strParamM_Warehouse_ID) || ("%").equals(strParamM_Warehouse_ID))  || !(("").equals(strParamDocStatus) || ("%").equals(strParamDocStatus))  || !(("").equals(strParamMovementDate_f) || ("%").equals(strParamMovementDate_f)) ;
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/ReturnMaterialReceipt/Header_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header", false, "document.frmMain.inpmInoutId", "grid", "../shipments/print.html", "N".equals("Y"), "ReturnMaterialReceipt", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "ReturnMaterialReceipt", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _M_InOut_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strM_InOut_ID = _M_InOut_ID;
...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    if (dataField==null) {
      ...
      if (dataField.getField("mInoutId") == null || dataField.getField("mInoutId").equals("")) {
        ...
        String strReturnLocator = HeaderData.selectAux3C83C6D91C664F6A96AE0530C75277A9(this, ((dataField!=null)?dataField.getField("mWarehouseId"):((data==null || data.length==0)?"":data[0].getField("mWarehouseId"))));
    vars.setSessionValue(windowId + "|ReturnLocator", strReturnLocator);
        String strisReturnMaterial = "Y";
    vars.setSessionValue(windowId + "|isReturnMaterial", strisReturnMaterial);
        String strDOCBASETYPE = "MMS";
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set(Utility.getDefault(this, vars, "Freight_Currency_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "Description", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "MovementType", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "MovementDate", "@#Date@", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "Processed", "", "123271B9AD60469BAE8A924841456B63", "N", dataField), Utility.getDefault(this, vars, "Processing", "", "123271B9AD60469BAE8A924841456B63", "N", dataField), "", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@#AD_Org_ID@", "123271B9AD60469BAE8A924841456B63", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "123271B9AD60469BAE8A924841456B63", "", dataField), HeaderData.selectDef3526_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "123271B9AD60469BAE8A924841456B63", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "123271B9AD60469BAE8A924841456B63", "", dataField), HeaderData.selectDef3528_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "123271B9AD60469BAE8A924841456B63", "", dataField)), Utility.getDefault(this, vars, "IsSOTrx", "@IsSOTrx@", "123271B9AD60469BAE8A924841456B63", "N", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "C_DocType_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "IsPrinted", "", "123271B9AD60469BAE8A924841456B63", "N", dataField), Utility.getDefault(this, vars, "DateAcct", "@#Date@", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "C_BPartner_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), HeaderData.selectDef3795_2(this, Utility.getDefault(this, vars, "C_BPartner_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField)), Utility.getDefault(this, vars, "C_BPartner_Location_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "AD_User_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "M_Warehouse_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "POReference", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "DeliveryRule", "A", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "FreightCostRule", "I", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "FreightAmt", "0", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "DeliveryViaRule", "P", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "M_Shipper_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "C_Charge_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "ChargeAmt", "0", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "PriorityRule", "5", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "DatePrinted", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "C_Order_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), HeaderData.selectDef3809_3(this, Utility.getDefault(this, vars, "C_Order_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField)), Utility.getDefault(this, vars, "M_Condition_Goods_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "DateOrdered", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "DocStatus", "DR", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "DocAction", "CO", "123271B9AD60469BAE8A924841456B63", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "135", Utility.getDefault(this, vars, "DocAction", "CO", "123271B9AD60469BAE8A924841456B63", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "135", Utility.getDefault(this, vars, "DocAction", "CO", "123271B9AD60469BAE8A924841456B63", "N", dataField))), Utility.getDefault(this, vars, "CreateFrom", "", "123271B9AD60469BAE8A924841456B63", "N", dataField), Utility.getDefault(this, vars, "GenerateTo", "", "123271B9AD60469BAE8A924841456B63", "N", dataField), Utility.getDefault(this, vars, "C_Invoice_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "Posted", "", "123271B9AD60469BAE8A924841456B63", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "", "123271B9AD60469BAE8A924841456B63", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "", "123271B9AD60469BAE8A924841456B63", "N", dataField))), Utility.getDefault(this, vars, "UpdateLines", "N", "123271B9AD60469BAE8A924841456B63", "N", dataField), Utility.getDefault(this, vars, "Islogistic", "@ISLOGISTICAUX@", "123271B9AD60469BAE8A924841456B63", "N", dataField), Utility.getDefault(this, vars, "GenerateLines", "N", "123271B9AD60469BAE8A924841456B63", "N", dataField), Utility.getDefault(this, vars, "Delivery_Location_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "M_FreightCategory_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "Calculate_Freight", "", "123271B9AD60469BAE8A924841456B63", "N", dataField), Utility.getDefault(this, vars, "SalesRep_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "PickDate", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "TrackingNo", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "NoPackages", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "ShipDate", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "C_Campaign_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), HeaderData.selectDef9585_4(this, Utility.getDefault(this, vars, "C_Project_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField)), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "123271B9AD60469BAE8A924841456B63", "", dataField), Utility.getDefault(this, vars, "RM_Receipt_PickEdit", "", "123271B9AD60469BAE8A924841456B63", "N", dataField), Utility.getDefault(this, vars, "RM_Shipment_Pickedit", "", "123271B9AD60469BAE8A924841456B63", "N", dataField));
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/ReturnMaterialReceipt/Header_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/ReturnMaterialReceipt/Header_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmInoutId", "", "../shipments/print.html", "N".equals("Y"), "ReturnMaterialReceipt", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_InOut_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
	  ...
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "ReturnMaterialReceipt", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Header_Relation.html", strReplaceWith);
      ...
      throw new ServletException(ex);
        ...
        xmlDocument.setParameter("ReturnLocator", strReturnLocator);
...
xmlDocument.setParameter("RM_Receipt_PickEdit_BTNname", Utility.getButtonName(this, vars, "B0D399236DB4B482E040007F0100519C", "RM_Receipt_PickEdit_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalRM_Receipt_PickEdit = org.openbravo.erpCommon.utility.Utility.isModalProcess(""); 
xmlDocument.setParameter("RM_Receipt_PickEdit_Modal", modalRM_Receipt_PickEdit?"true":"false");
String userOrgList = "";
if (editableTab) 
...
comboTableData = null;
comboTableData = new ComboTableData(vars, this, "19", "M_Condition_Goods_ID", "", "", Utility.getReferenceableOrg(vars, (dataField!=null?dataField.getField("adOrgId"):data[0].getField("adOrgId").equals("")?vars.getOrg():data[0].getField("adOrgId"))), Utility.getContext(this, vars, "#User_Client", windowId), 0);
Utility.fillSQLParameters(this, vars, (dataField==null?data[0]:dataField), comboTableData, windowId, (dataField==null?data[0].getField("mConditionGoodsId"):dataField.getField("mConditionGoodsId")));
xmlDocument.setData("reportM_Condition_Goods_ID","liststructure", comboTableData.select(!strCommand.equals("NEW")));
comboTableData = null;
...
xmlDocument.setParameter("DocAction_BTNname", Utility.getButtonName(this, vars, "135", (dataField==null?data[0].getField("docaction"):dataField.getField("docaction")), "DocAction_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalDocAction = org.openbravo.erpCommon.utility.Utility.isModalProcess("109"); 
...
xmlDocument.setParameter("array", dact.toString());
    ...
    private String getReadOnlyLogicContext(VariablesSecureApp vars) throws IOException, ServletException {
      ...
      String result = "var strHAS_M_INOUTLINES=\"" + Utility.getContext(this, vars, "HAS_M_INOUTLINES", windowId) + "\";\n";
      return result;
    }
