  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if(saveRequest != null && saveRequest){
      ...
      boolean editableTab = (!org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)
        ...
        String strmMovementId = request.getParameter("inpmMovementId");
        
        if (editableTab) {
          int total = 0;
          
          if(commandType.equalsIgnoreCase("EDIT") && !strmMovementId.equals(""))
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      if (strView.equals("")) {
        ...
        if (strView.equals("EDIT")) {
          if (strM_Movement_ID.equals("")) strM_Movement_ID = firstElement(vars, tableSQL);
          if (strM_Movement_ID.equals("")) strView = "RELATION";
        }
      }
      if (strView.equals("EDIT")) 

        printPageEdit(response, request, vars, false, strM_Movement_ID, tableSQL);

      else printPageDataSheet(response, vars, strM_Movement_ID, tableSQL);
    } else if (vars.commandIn("DIRECT")) {
      String strM_Movement_ID = vars.getStringParameter("inpDirectKey");
      
        
      if (strM_Movement_ID.equals("")) strM_Movement_ID = vars.getRequiredGlobalVariable("inpmMovementId", windowId + "|M_Movement_ID");
      else vars.setSessionValue(windowId + "|M_Movement_ID", strM_Movement_ID);
      ...
      String strView = vars.getSessionValue(tabId + "|Header.view");
      String strM_Movement_ID = "";
      if (strView.equals("")) {
        strView = defaultTabView;
        if (strView.equals("EDIT")) {
          strM_Movement_ID = firstElement(vars, tableSQL);
          if (strM_Movement_ID.equals("")) strView = "RELATION";
        }
      }
      if (strView.equals("EDIT")) {
...
vars.getRequestGlobalVariable("inpParamMovementDate_f", tabId + "|paramMovementDate_f");
      ...
      vars.removeSessionValue(windowId + "|M_Movement_ID");
      String strM_Movement_ID="";
      ...
      printPageDataSheet(response, vars, strM_Movement_ID, tableSQL);
      ...
      String strM_Movement_ID = vars.getRequiredStringParameter("inpmMovementId");
      
      String strNext = nextElement(vars, strM_Movement_ID, tableSQL);
      ...
      String strPrevious = previousElement(vars, strM_Movement_ID, tableSQL);
      ...
      String strM_Movement_ID = vars.getRequiredGlobalVariable("inpmMovementId", windowId + "|M_Movement_ID");
      OBError myError = new OBError();
      ...
      if (!myError.isEmpty()) {
        ...
        if (vars.commandIn("SAVE_EDIT_NEW")) response.sendRedirect(strDireccion + request.getServletPath() + "?Command=NEW");
          ...
          String strNext = nextElement(vars, strM_Movement_ID, tableSQL);
          vars.setSessionValue(windowId + "|M_Movement_ID", strNext);
          response.sendRedirect(strDireccion + request.getServletPath() + "?Command=EDIT");
        } else response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
      }
      ...
      if (org.openbravo.erpCommon.utility.WindowAccessData.hasNotDeleteAccess(this, vars.getRole(), tabId)) {
        ...
        try {
          total = HeaderData.delete(this, strM_Movement_ID, Utility.getContext(this, vars, "#User_Client", windowId, accesslevel), Utility.getContext(this, vars, "#User_Org", windowId, accesslevel));
        ...
        vars.removeSessionValue(windowId + "|mMovementId");
        vars.setSessionValue(tabId + "|Header.view", "RELATION");
      }
      if (myError==null) {
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "20", "M_LocatorTo", strmLocatorto, vars.getClient(), vars.getOrg(), vars.getUser());
  ...
  private HeaderData getEditVariables(Connection con, VariablesSecureApp vars) throws IOException,ServletException {
    ...
    data.adOrgId = vars.getRequiredGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID");     data.adOrgIdr = vars.getStringParameter("inpadOrgId_R");     data.name = vars.getRequiredStringParameter("inpname");     data.movementdate = vars.getRequiredStringParameter("inpmovementdate");     data.description = vars.getStringParameter("inpdescription");     data.moveFromtoLocator = vars.getRequiredStringParameter("inpmoveFromtoLocator");     data.processing = vars.getStringParameter("inpprocessing");     data.posted = vars.getRequiredStringParameter("inpposted");     data.isactive = vars.getStringParameter("inpisactive", "N");     data.adOrgtrxId = vars.getStringParameter("inpadOrgtrxId");     data.cProjectId = vars.getStringParameter("inpcProjectId");     data.cProjectIdr = vars.getStringParameter("inpcProjectId_R");     data.cCostcenterId = vars.getStringParameter("inpcCostcenterId");     data.aAssetId = vars.getStringParameter("inpaAssetId");     data.cActivityId = vars.getStringParameter("inpcActivityId");     data.cActivityIdr = vars.getStringParameter("inpcActivityId_R");     data.cCampaignId = vars.getStringParameter("inpcCampaignId");     data.cCampaignIdr = vars.getStringParameter("inpcCampaignId_R");     data.user1Id = vars.getStringParameter("inpuser1Id");     data.user2Id = vars.getStringParameter("inpuser2Id");     data.adClientId = vars.getRequiredGlobalVariable("inpadClientId", windowId + "|AD_Client_ID");     data.mMovementId = vars.getRequestGlobalVariable("inpmMovementId", windowId + "|M_Movement_ID");     data.documentno = vars.getRequiredStringParameter("inpdocumentno");     data.processed = vars.getStringParameter("inpprocessed", "N"); 
      ...
      data.updatedTimeStamp = vars.getStringParameter("updatedTimestamp");
         ...
         if (data.documentno.startsWith("<")) data.documentno = Utility.getDocumentNo(con, this, vars, windowId, "M_Movement", "", "", false, true);
    ...
    private void refreshSessionEdit(VariablesSecureApp vars, FieldProvider[] data) {
      if (data==null || data.length==0) return;
          vars.setSessionValue(windowId + "|AD_Org_ID", data[0].getField("adOrgId"));    vars.setSessionValue(windowId + "|M_Movement_ID", data[0].getField("mMovementId"));    vars.setSessionValue(windowId + "|AD_Client_ID", data[0].getField("adClientId"));
    }

    private void refreshSessionNew(VariablesSecureApp vars) throws IOException,ServletException {
      HeaderData[] data = HeaderData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), vars.getStringParameter("inpmMovementId", ""), Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
      if (data==null || data.length==0) return;
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars, String strM_Movement_ID, TableSQLData tableSQL)
...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    hasSearchCondition = (tableSQL.hasInternalFilter() && ("").equals(strParamAD_Org_ID) && ("").equals(strParamDocumentNo) && ("").equals(strParamMovementDate) && ("").equals(strParamName) && ("").equals(strParamMovementDate_f)) || !(("").equals(strParamAD_Org_ID) || ("%").equals(strParamAD_Org_ID))  || !(("").equals(strParamDocumentNo) || ("%").equals(strParamDocumentNo))  || !(("").equals(strParamMovementDate) || ("%").equals(strParamMovementDate))  || !(("").equals(strParamName) || ("%").equals(strParamName))  || !(("").equals(strParamMovementDate_f) || ("%").equals(strParamMovementDate_f)) ;
    String strOffset = vars.getSessionValue(tabId + "|offset");
    String selectedRow = "0";
    if (!strM_Movement_ID.equals("")) {
      selectedRow = Integer.toString(getKeyPosition(vars, strM_Movement_ID, tableSQL));
    }

    String[] discard={"isNotFiltered","isNotTest"};
    if (hasSearchCondition) discard[0] = new String("isFiltered");
    if (vars.getSessionValue("#ShowTest", "N").equals("Y")) discard[1] = new String("isTest");
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/GoodsMovements/Header_Relation", discard).createXmlDocument();

    boolean hasReadOnlyAccess = org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId);
    ToolBar toolbar = new ToolBar(this, true, vars.getLanguage(), "Header", false, "document.frmMain.inpmMovementId", "grid", "..", "".equals("Y"), "GoodsMovements", strReplaceWith, false, false, false, false, !hasReadOnlyAccess);
...
//    }
    ...
    xmlDocument.setParameter("KeyName", "mMovementId");
    ...
    try {
      ...
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "GoodsMovements", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"));
...
xmlDocument.setParameter("grid_Default", selectedRow);
  ...
  private void printPageEdit(HttpServletResponse response, HttpServletRequest request, VariablesSecureApp vars,boolean _boolNew, String _M_Movement_ID, TableSQLData tableSQL)
    throws IOException, ServletException {
    if (log4j.isDebugEnabled()) log4j.debug("Output: edit");

    // copy params to variables as they will be modified later
    boolean boolNew = _boolNew;
    String strM_Movement_ID = _M_Movement_ID;
    ...
    String orderClause = " M_Movement.Name, M_Movement.DocumentNo DESC";
...
String strParamMovementDate_f = vars.getSessionValue(tabId + "|paramMovementDate_f");
    ...
    if (dataField==null) {
      if (!boolNew) {
        ...
        data = HeaderData.selectEdit(this, vars.getSessionValue("#AD_SqlDateTimeFormat"), vars.getLanguage(), strM_Movement_ID, Utility.getContext(this, vars, "#User_Client", windowId), Utility.getContext(this, vars, "#AccessibleOrgTree", windowId, accesslevel));
  
        if (!strM_Movement_ID.equals("") && (data == null || data.length==0)) {
          response.sendRedirect(strDireccion + request.getServletPath() + "?Command=RELATION");
          return;
        }
        refreshSessionEdit(vars, data);
      ...
      if (dataField.getField("mMovementId") == null || dataField.getField("mMovementId").equals("")) {
        discard[0] = new String ("editDiscard");
        strCommand = "NEW";
        boolNew = true;
      } else {
    ...
    if (dataField==null) {
      if (boolNew || data==null || data.length==0) {
        ...
        data = HeaderData.set("", Utility.getDefault(this, vars, "AD_Client_ID", "@AD_CLIENT_ID@", "170", "", dataField), Utility.getDefault(this, vars, "AD_Org_ID", "@AD_Org_ID@", "170", "", dataField), "Y", Utility.getDefault(this, vars, "CreatedBy", "", "170", "", dataField), HeaderData.selectDef3574_0(this, Utility.getDefault(this, vars, "CreatedBy", "", "170", "", dataField)), Utility.getDefault(this, vars, "UpdatedBy", "", "170", "", dataField), HeaderData.selectDef3575_1(this, Utility.getDefault(this, vars, "UpdatedBy", "", "170", "", dataField)), Utility.getDefault(this, vars, "Name", "@#Date@", "170", "", dataField), Utility.getDefault(this, vars, "Description", "", "170", "", dataField), Utility.getDefault(this, vars, "MovementDate", "@#Date@", "170", "", dataField), Utility.getDefault(this, vars, "Processed", "", "170", "N", dataField), Utility.getDefault(this, vars, "Processing", "", "170", "N", dataField), Utility.getDefault(this, vars, "A_Asset_ID", "", "170", "", dataField), Utility.getDefault(this, vars, "Posted", "", "170", "N", dataField), (vars.getLanguage().equals("en_US")?ListData.selectName(this, "234", Utility.getDefault(this, vars, "Posted", "", "170", "N", dataField)):ListData.selectNameTrl(this, vars.getLanguage(), "234", Utility.getDefault(this, vars, "Posted", "", "170", "N", dataField))), Utility.getDefault(this, vars, "Move_FromTo_Locator", "N", "170", "N", dataField), Utility.getDefault(this, vars, "DocumentNo", "", "170", "", dataField), Utility.getDefault(this, vars, "C_Activity_ID", "", "170", "", dataField), Utility.getDefault(this, vars, "User2_ID", "", "170", "", dataField), Utility.getDefault(this, vars, "User1_ID", "", "170", "", dataField), Utility.getDefault(this, vars, "C_Project_ID", "", "170", "", dataField), HeaderData.selectDef9548_2(this, Utility.getDefault(this, vars, "C_Project_ID", "", "170", "", dataField)), Utility.getDefault(this, vars, "C_Campaign_ID", "", "170", "", dataField), Utility.getDefault(this, vars, "AD_OrgTrx_ID", "", "170", "", dataField), Utility.getDefault(this, vars, "C_Costcenter_ID", "", "170", "", dataField));
             data[0].documentno = "<" + Utility.getDocumentNo( this, vars, windowId, "M_Movement", "", "", false, false) + ">";
      }
     }
    ...
    if (editableTab)
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/GoodsMovements/Header_Edition",discard).createXmlDocument();
    else
      xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpWindows/GoodsMovements/Header_NonEditable",discard).createXmlDocument();

    xmlDocument.setParameter("tabId", tabId);
    ToolBar toolbar = new ToolBar(this, editableTab, vars.getLanguage(), "Header", (strCommand.equals("NEW") || boolNew || (dataField==null && (data==null || data.length==0))), "document.frmMain.inpmMovementId", "", "..", "".equals("Y"), "GoodsMovements", strReplaceWith, true, false, false, Utility.hasTabAttachments(this, vars, tabId, strM_Movement_ID), !hasReadOnlyAccess);
    toolbar.setTabId(tabId);
    ...
    try {
      ...
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      // if (!strM_Movement_ID.equals("")) xmlDocument.setParameter("childTabContainer", tabs.childTabs(false));
	  // else xmlDocument.setParameter("childTabContainer", tabs.childTabs(true));
	  xmlDocument.setParameter("childTabContainer", tabs.childTabs(false));
	  String hideBackButton = vars.getGlobalVariable("hideMenu", "#Hide_BackButton", "");
      NavigationBar nav = new NavigationBar(this, vars.getLanguage(), "Header_Relation.html", "GoodsMovements", "W", strReplaceWith, tabs.breadcrumb(), hideBackButton.equals("true"), !concurrentSave);
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(this, vars.getLanguage(), "Header_Relation.html", strReplaceWith);
...
xmlDocument.setParameter("Move_FromTo_Locator_BTNname", Utility.getButtonName(this, vars, "800749", "Move_FromTo_Locator_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalMove_FromTo_Locator = org.openbravo.erpCommon.utility.Utility.isModalProcess("800048"); 
xmlDocument.setParameter("Move_FromTo_Locator_Modal", modalMove_FromTo_Locator?"true":"false");
xmlDocument.setParameter("Processing_BTNname", Utility.getButtonName(this, vars, "2728", "Processing_linkBTN", usedButtonShortCuts, reservedButtonShortCuts));boolean modalProcessing = org.openbravo.erpCommon.utility.Utility.isModalProcess("122"); 
  ...
  private int saveRecord(VariablesSecureApp vars, OBError myError, char type) throws IOException, ServletException {
    ...
    if (org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) {
        ...
        strSequence = SequenceIdData.getUUID();
            ...
            if (Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),data.adClientId)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),data.adOrgId)){
		     if(type == 'I') {
		       ...
		       if (HeaderData.getCurrentDBTimestamp(this, data.mMovementId).equals(
        ...
        if(!myError.isEmpty()){
            ...
            vars.setSessionValue(windowId + "|M_Movement_ID", data.mMovementId);
        }
    }
    return total;
  }
